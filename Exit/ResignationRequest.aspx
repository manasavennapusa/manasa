<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ResignationRequest.aspx.cs" Inherits="Exit_ResignationRequest" %>
    ...
    <script type="text/javascript">
        function Validate() {
            ...
            if (Comments.value.trim() == "") {
                Comments.focus();
                alert("Please enter reasons for resigation.");
                return false;
            }
                                ...
                                <div class="widget">
                                    <div class="widget-body">
                                        <div class="form-actions no-margin" style="text-align: right">
                                            <asp:Button ID="btnsave" runat="server" CssClass="btn btn-primary" Text="Submit" OnClick="btnsave_Click" OnClientClick="return Validate();" />
                                        </div>
                                    </div>
                                </div>
                            </div>
