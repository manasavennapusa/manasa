<%@ Page Language="C#" AutoEventWireup="true" CodeFile="WorkFlowType.aspx.cs" Inherits="Exit_WorkFlowType" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function Validate() {
            var WorkFlowTypeName = document.getElementById('<%=txtWorkFlowTypeName.ClientID%>');

            if (WorkFlowTypeName.value == "") {
                                ...
                                <fieldset>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            ...
                                            <asp:TextBox ID="txtWorkFlowTypeName" runat="server" CssClass="span4" MaxLength="100"></asp:TextBox>
                            ...
                            <div class="widget-body">
                                <div id="dt_example" class="example_alt_pagination">
                                    <asp:GridView ID="Grid" runat="server" AutoGenerateColumns="False" CssClass="table table-condensed table-striped table-hover table-bordered pull-left"
                                        EmptyDataText="No Data Found" DataKeyNames="WorkFlowTypeId" OnRowEditing="Grid_RowEditing" OnRowDeleting="Grid_RowDeleting">
                                        <Columns>
