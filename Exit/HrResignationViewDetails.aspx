<%@ Page Language="C#" AutoEventWireup="true" CodeFile="HrResignationViewDetails.aspx.cs" Inherits="Exit_HrResignationViewDetails" %>
                                ...
                                <fieldset>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            ...
                                            <asp:ImageButton ID="imgbtn" runat="server" ImageUrl="~/Exit/image/edit.png" Visible="true" OnClick="imgbtn_Click" />
                                        </div>
                                    </div>
                        ...
                        <div class="widget">
                            <div class="widget-body">
                                <div class="form-actions no-margin" style="text-align: right">
                                    <asp:Button ID="btnInitiateExit" runat="server" CssClass="btn btn-primary" Text="Approve" OnClick="btnInitiateExit_Click" ValidationGroup="g" OnClientClick="return closewindow()" />
                                    <asp:Button ID="btnreject" runat="server" CssClass="btn btn-primary" Text="Reject" ValidationGroup="g" OnClick="btnreject_Click" />
                                </div>
                            </div>
                        </div>
                    </div>
