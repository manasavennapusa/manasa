<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InitiatePromotion.aspx.cs" Inherits="Appraisal_InitiatePromotion" %>
                        ...
                        <div class="span12">
                            <div class="widget no-margin">
                                <div class="widget-header">
                                    <div class="title">
                                        <span class="fs1" aria-hidden="true" data-icon="&#xe14a;"></span>Promotion Initiation
                 
                                    </div>

                                    <%--<asp:Button ID="btnInitiate" runat="server" Text="Initiate Promotion" CssClass="btn btn-small btn-mini btn-primary hidden-tablet hidden-phone pull-right" OnClick="btnInitiate_Click" />--%>
                                        ...
                                        <asp:GridView ID="grid" runat="server" AutoGenerateColumns="false" OnPreRender="grid_PreRender" CssClass="table table-striped table-bordered table-hover table-checkable table-responsive datatable" DataKeyNames="assessment_id">
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Employee Status" Visible="false">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblempstatus" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"emp_status") %>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                ...
                                                <asp:TemplateField HeaderText="Designation">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lbldesignation" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"designationname") %>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <%--<asp:BoundField HeaderText="Appraisal Status" DataField="freeze" />--%>
                                                <asp:TemplateField HeaderText="Appraisal Status" Visible="false">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblaprstatus" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"freeze") %>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>

                                                <asp:HyperLinkField DataNavigateUrlFields="assessment_id" DataNavigateUrlFormatString="ViewAllGoalStatus.aspx?id_4={0}" Text="View" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center" ControlStyle-CssClass="btn btn-small btn-mini btn-primary hidden-tablet hidden-phone" />
                                            </Columns>
                                        </asp:GridView>
                                        <div class="clearfix"></div>
                                    </div>
                                ...
                                <div class="form-actions no-margin" style="text-align:right">
                                  <%--<asp:Button ID="btnInitiate" runat="server" Text="Initiate Promotion" CssClass="btn btn-info" OnClick="btnInitiate_Click" />--%>
                                    <asp:Button ID="btn_initiate_promotion" runat="server" Text="Initiate Promotion" CssClass="btn btn-info" OnClick="btn_initiate_promotion_Click" />
                                </div>
                            </div>
                        </div>
                    </div>
