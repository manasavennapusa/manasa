...
public partial class appraisal_SalaryIncreamentProcessByMD : System.Web.UI.Page
{
    decimal grdTotal = 0;
    ...
    private void bindgrid()
    {
        ...
        try
        {
            ...
            DataSet ds = SQLServer.ExecuteDataset(ConfigurationManager.ConnectionStrings["intranetConnectionString"].ConnectionString.ToString(), CommandType.StoredProcedure, "[sp_appraisal_listofIncreatement_approver_md]", sqlparam);
    ...
    {
        Response.Redirect("SalaryIncreamentProcessByMD.aspx");
    }
    ...
    protected void btnreject_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect("SalaryIncreamentProcessByMD.aspx?reject=true");
    }
}