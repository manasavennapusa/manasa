<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ManagerRating.aspx.cs" Inherits="appraisal_ManagerRating" %>
    ...
    <form id="myForm" runat="server" class="form-horizontal no-margin">
        ...
        <div class="dashboard-wrapper" style="margin-left: 0px;">
                        ...
                        <div class="widget">
                            <div class="widget-header" style="border-bottom: none;">
                                <div class="title">
                                    ...
                                    <asp:Label ID="lblhead" runat="server" Text="Manager Rating & Comments"></asp:Label>
                                </div>
                            </div>
                            <div class="widget-body">
                                        ...
                                        <tr>
                                            ...
                                            <td class="frm-rght-clr123">&nbsp;<asp:DropDownList ID="ddl_dept" runat="server" CssClass="span10" DataSourceID="SqlDataSourc4"
                                                ...
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="ddl_dept" InitialValue="0"
                                                    Display="Dynamic" SetFocusOnError="True" ToolTip="Select Department" ValidationGroup="d"
                                                    Width="6px"><img  src="../img/error1.gif" alt="" /></asp:RequiredFieldValidator>
                                            </td>
                                ...
                                <div runat="server" id="empdetails" visible="false">
                                    ...
                                    <%--  <table style="width: 100%;" runat="server" visible="false">
                                        ...
                                        <tr>
                                            <td>
                                                <asp:GridView ID="gvGoals" runat="server" AllowSorting="True" AutoGenerateColumns="False" OnRowDataBound="gvGoals_RowDataBound1"
                                                    CaptionAlign="Left" CssClass="table table-condensed table-striped  table-bordered pull-left"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="KRA">
                                                         ...
                                                         <%-- <asp:TemplateField HeaderText="Parameter" Visible="false">
                                                            <ItemTemplate>
                                                                <asp:Label ID="Labelspe3" runat="Server" Text='<%# Eval("parameter") %>'></asp:Label>
                                                            </ItemTemplate>
                                                            <HeaderStyle Width="20%" />
                                                        </asp:TemplateField>--%>
                                    ...
                                    <%-- <asp:TemplateField HeaderText="KPI" Visible="false">
                                                        ...
                                                        <asp:TemplateField HeaderText="Employee Comments" runat="server" Visible="false">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblcomm" runat="Server" Text='<%# Eval("appcomments") %>'></asp:Label>
                                                            </ItemTemplate>

                                                            <HeaderStyle Width="10%" />
                                                        </asp:TemplateField>--%>
                                    <%--<asp:TemplateField HeaderText="Manager Comments" runat="server" Visible="false">
                                                            <ItemTemplate>
                                    ...
                                    <%--<asp:TemplateField HeaderText="Employee Ratings">
                                                        ...
                                                        <asp:TemplateField HeaderText="Employee Comments">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblempcomments" runat="Server" Text='<%# Eval("appcomments") %>'></asp:Label>
                                                            </ItemTemplate>
                                                            <HeaderStyle Width="10%" />
                                                        </asp:TemplateField>--%>
                                    ...
                                    <%--<asp:TemplateField HeaderText="Manager Rating" runat="server" Visible="false">
                                                            ...
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblrating" runat="Server" Text='<%#Eval("mgrrating")%>' Visible='<%#Eval("mgrrating").ToString()==""?false:true%>'></asp:Label>
                                                                <asp:DropDownList ID="txtrating" runat="Server" Width="75px" CssClass="blue1">
                                                                </asp:DropDownList>
                                    ...
                                    <%--    <ItemTemplate>
                                                                <asp:Label ID="lblcomments" runat="Server" Text='<%#Eval("mgrcomments")%>' Visible='<%#Eval("mgrrating").ToString()==""?false:true%>'></asp:Label>
                                                                <asp:TextBox ID="txtcomments" TextMode="MultiLine" CssClass="span11" runat="Server" Width="150px" Text='<%#Eval("mgrcomments")%>' Visible='<%#Eval("mgrrating").ToString()==""?true:false%>' MaxLength="8000"></asp:TextBox>
                                    ...
                                    <%--<EditItemTemplate>
                                                                <asp:TextBox ID="txteditcomments" CssClass="span11" TextMode="MultiLine" runat="server" Width="150px" Text='<%# Eval("mgrcomments") %>' MaxLength="8000" placeholder="Max 8000 chars."></asp:TextBox>
                                                                <asp:RegularExpressionValidator ID="RegularExpressionValidator20" runat="server" Display="Dynamic" ToolTip="only enter alphabets, numbers,space and (.:\/-# % ,)"
                                                        ...
                                                        <asp:TemplateField HeaderStyle-Width="5%" runat="server" Visible="false">
                                                            <EditItemTemplate>
                                            ...
                                            <table style="width: 100%;" class="table table-condensed table-striped  table-bordered pull-left">
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="frm-rght-clr123" style="width: 15%">
                                                            <asp:DropDownList ID="drp_skils" runat="Server" Width="115px" CssClass="blue1" Enabled="false">
                                                        ...
                                                        <td class="frm-rght-clr123" style="width: 15%">
                                                            <asp:DropDownList ID="drp_skils_app" runat="Server" Width="115px" CssClass="blue1" AutoPostBack="true">
                                                              ...
                                                              <%-- <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="drp_skils_app"
                                                InitialValue="0" Display="Dynamic" SetFocusOnError="True" ToolTip="Funtional Skills"
                                                ValidationGroup="v" Width="6px"><img src="../img/error1.gif" alt="" /></asp:RequiredFieldValidator>--%>
                                                        ...
                                                        <td class="frm-rght-clr123" style="width: 15%">
                                                           ...
                                                           <%--  <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="txt_skils_app"
                                                InitialValue="0" Display="Dynamic" SetFocusOnError="True" ToolTip="Funtional Skills Comments"
                                                ValidationGroup="v" Width="6px"><img src="../img/error1.gif" alt="" /></asp:RequiredFieldValidator>--%>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td class="frm-rght-clr123" style="width: 15%">
                                                            <asp:DropDownList ID="drp_quality" runat="Server" Width="115px" CssClass="blue1" Enabled="false">
                                                                 <asp:ListItem Value="-1">--Select--</asp:ListItem>
                                                                 <asp:ListItem Value="0">NA</asp:ListItem>
                                                                <asp:ListItem Value="4">4</asp:ListItem>
                                                                <asp:ListItem Value="3">3</asp:ListItem>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="frm-rght-clr123" style="width: 15%">
                                                            <asp:DropDownList ID="drp_comm" runat="Server" Width="115px" CssClass="blue1" Enabled="false">
                                                                 <asp:ListItem Value="-1">--Select--</asp:ListItem>
                                                                 <asp:ListItem Value="0">NA</asp:ListItem>
                                                                <asp:ListItem Value="4">4</asp:ListItem>
                                                                <asp:ListItem Value="3">3</asp:ListItem>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="frm-rght-clr123" style="width: 15%">
                                                            <asp:DropDownList ID="drp_self" runat="Server" Width="115px" CssClass="blue1" Enabled="false">
                                                                 <asp:ListItem Value="-1">--Select--</asp:ListItem>
                                                                 <asp:ListItem Value="0">NA</asp:ListItem>
                                                                <asp:ListItem Value="4">4</asp:ListItem>
                                                                <asp:ListItem Value="3">3</asp:ListItem>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="frm-rght-clr123" style="width: 15%">
                                                            <asp:DropDownList ID="drp_pro" runat="Server" Width="115px" CssClass="blue1" Enabled="false">
                                                               <asp:ListItem Value="-1">--Select--</asp:ListItem>
                                                                 <asp:ListItem Value="0">NA</asp:ListItem>
                                                                <asp:ListItem Value="4">4</asp:ListItem>
                                                                <asp:ListItem Value="3">3</asp:ListItem>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="frm-rght-clr123" style="width: 15%">
                                                            <asp:DropDownList ID="drp_team" runat="Server" Width="115px" CssClass="blue1" Enabled="false">
                                                                 <asp:ListItem Value="-1">--Select--</asp:ListItem>
                                                                 <asp:ListItem Value="0">NA</asp:ListItem>
                                                                <asp:ListItem Value="4">4</asp:ListItem>
                                                                <asp:ListItem Value="3">3</asp:ListItem>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="frm-rght-clr123" style="width: 15%">
                                                            <asp:DropDownList ID="drp_commit" runat="Server" Width="115px" CssClass="blue1" Enabled="false">
                                                               <asp:ListItem Value="-1">--Select--</asp:ListItem>
                                                                 <asp:ListItem Value="0">NA</asp:ListItem>
                                                                <asp:ListItem Value="4">4</asp:ListItem>
                                                                <asp:ListItem Value="3">3</asp:ListItem>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="frm-rght-clr123" style="width: 15%">
                                                            <asp:DropDownList ID="drp_client" runat="Server" Width="115px" CssClass="blue1" Enabled="false">
                                                                  <asp:ListItem Value="-1">--Select--</asp:ListItem>
                                                                 <asp:ListItem Value="0">NA</asp:ListItem>
                                                                <asp:ListItem Value="4">4</asp:ListItem>
                                                                <asp:ListItem Value="3">3</asp:ListItem>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="frm-rght-clr123" style="width: 15%">
                                                            <asp:DropDownList ID="drp_plan" runat="Server" Width="115px" CssClass="blue1" Enabled="false">
                                                                 <asp:ListItem Value="-1">--Select--</asp:ListItem>
                                                                 <asp:ListItem Value="0">NA</asp:ListItem>
                                                                <asp:ListItem Value="4">4</asp:ListItem>
                                                                <asp:ListItem Value="3">3</asp:ListItem>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="frm-rght-clr123" style="width: 15%">
                                                            <asp:DropDownList ID="drp_mentor" runat="Server" Width="115px" CssClass="blue1" Enabled="false">
                                                               <asp:ListItem Value="-1">--Select--</asp:ListItem>
                                                                 <asp:ListItem Value="0">NA</asp:ListItem>
                                                                <asp:ListItem Value="4">4</asp:ListItem>
                                                                <asp:ListItem Value="3">3</asp:ListItem>
                                        ...
                                        <tr>
                                            <td>
                                                <asp:GridView ID="grdcolor" runat="server" Width="100%" AutoGenerateColumns="False"
                                                    ...
                                                    CssClass="table table-condensed table-striped  table-bordered pull-left">
                                                    <Columns>
                                                        <asp:TemplateField HeaderText="Performance Objectives" HeaderStyle-Width="20%">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblObjcetives" runat="server" Text='<%# Eval("performance_objectivies") %>'></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="Unacceptable" HeaderStyle-Width="16%">
                                                            <ItemTemplate>
                                    ...
                                    <table style="width: 100%;">
                                        ...
                                        <tr runat="server" visible="false">
                                            <td>
                                                <br />
                                                <table style="width: 100%;" class="table table-condensed table-striped  table-bordered ">
                                                    <tbody>
                                                        <tr style="display: none;">
                                                            <td class="frm-lft-clr123" style="width: 20%;">Average Rating of Smart Goals
                                                            </td>
                                                            <td class="frm-rght-clr123" style="width: 15%;">
                                                                <asp:Label ID="lblAvgRatingGoals" runat="server"></asp:Label>
                                                            </td>

                                                            <td class="frm-lft-clr123" style="width: 20%;">Average Rating of Competencies
                                                            </td>
                                                            <td class="frm-rght-clr123 " style="width: 15%;">
                                                        ...
                                                        <tr id="troverall" runat="server">
                                                            <td class="frm-lft-clr123" style="width: 15%">Employee Overall Rating
                                                            </td>
                                                            <td class="frm-rght-clr123 " style="width: 15%">
                                                                <asp:Label ID="lblOverallRating" runat="server"></asp:Label>
                                                            </td>
                                                            <td class="frm-lft-clr123" style="width: 20%" runat="server" visible="false">Employee Overall Comments
                                                            </td>
                                                            <td class="frm-rght-clr123" style="width: 40%" runat="server" visible="false">
                                                        ...
                                                        <tr id="troverall2" runat="server">
                                                            ...
                                                            <td class="frm-lft-clr123 " style="width: 20%;" runat="server" visible="false">Manager Overall Comments
                                                            </td>
                                                            <td class="frm-rght-clr123" style="width: 40%;" runat="server" visible="false">
                                                                <%-- <asp:Label ID="txtMgrOverallComments" runat="server"></asp:Label>--%>
                                                                <asp:TextBox ID="txtMgroverallcomments" runat="server" TextMode="MultiLine" Width="450PX" MaxLength="8000" placeholder="Max 8000 chars."></asp:TextBox>
                                                            ...
                                                            <td class="frm-rght-clr123" style="width: 10%" runat="server" visible="false">
                                        ...
                                        <tbody>
                                            ...
                                            <tr runat="server" id="Tr1" visible="true">
                                                <td style="background-color: white">
                                                    <asp:TextBox runat="server" ID="txt_add_cmnt" TextMode="MultiLine" Width="600px" Height="50px" placeholder="Max 8000 chars." ReadOnly="true"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    <asp:Label runat="server"><b>Line Manager Comments<span class="star"></span></b></asp:Label>
                                                </td>
                                            </tr>
                                            <tr runat="server" id="appr_div" visible="true">
                                                <td style="background-color: white">
                                                    <asp:TextBox runat="server" ID="txtcmnt_appr" TextMode="MultiLine" Width="600px" Height="50px" placeholder="Max 8000 chars."></asp:TextBox>
                                                     <asp:RequiredFieldValidator ID="txtCommentsRequired" runat="server" ControlToValidate="txtcmnt_appr" ErrorMessage='<img src="../images/error1.gif" alt="" />' ToolTip="Enter Comments" ValidationGroup="v" SetFocusOnError="true" />
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
                                    ...
                                    <div class="form-actions no-margin" style="text-align: right">
                                        <asp:Button ID="btnSave" runat="server" CssClass="btn btn-success" ValidationGroup="v" Text="Save" Visible="false" />
                                        <asp:Button ID="btnSubmit" runat="server" CssClass="btn btn-info" ValidationGroup="v" Text="Submit" OnClick="btnSubmit_Click" />
                                        &nbsp;&nbsp;
                                        <asp:Button ID="btnsubmittoemp" runat="server" CssClass="btn btn-success" ValidationGroup="v" Text="Submit To Employee" OnClick="btnsubmittoemp_Click" Visible="false" />
                                        <asp:Button ID="btnCancel" runat="server" CssClass="btn btn-primary" CausesValidation="false" Text="Back" OnClick="btnCancel_Click" Visible="false" />
                                ...
                                <div id="dt_example" class="example_alt_pagination">
                                    <asp:GridView ID="gveligible" runat="server" CellSpacing="0"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:HyperLinkField HeaderText="View" DataNavigateUrlFields="empcode" DataNavigateUrlFormatString="~/appraisal/ManagerRating.aspx?empcode={0}"
            ...
            <div id="myModal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                        ...
                        <div>
                            <iframe src="view_KRA_approver.aspx?empcode=<%=lblempcode.Text.ToString()%>" width="100%" frameborder="0" height="500px"></iframe>
                        </div>
                    </div>
        </div>
