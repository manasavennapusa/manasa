<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SalaryIncreamentProcessByMD.aspx.cs" Inherits="appraisal_SalaryIncreamentProcessByMD" %>
                                    ...
                                    <div id="dt_example" class="example_alt_pagination">
                                        <asp:GridView ID="gveligible" runat="server" AutoGenerateColumns="false" CellSpacing="0" OnPreRender="gveligible_PreRender" DataKeyNames="empcode"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:HyperLinkField HeaderText="View" DataNavigateUrlFields="empcode" DataNavigateUrlFormatString="~/appraisal/SalaryIncreamentProcessByMD.aspx?empcode={0}"
                                                    Text="View">
