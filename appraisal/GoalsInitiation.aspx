<%@ Page Language="C#" AutoEventWireup="true" CodeFile="GoalsInitiation.aspx.cs" Inherits="appraisal_GoalsInitiation" %>
                ...
                <ContentTemplate>
                    ...
                    <div class="main-container">
                        ...
                        <div class="page-header">
                            <div class="pull-left">
                                <h2>Goals Cycle 1 </h2><%--Initiation--%>
                            </div>
                            ...
                            <div class="span12">
                                <div class="widget no-margin">
                                    ...
                                    <div class="form-actions no-margin" id="divbutton" runat="server">
                                        <asp:Button ID="btnInitiateAprasial" runat="server" CssClass="btn btn-primary" Text="Initiate Goals" OnClick="btnInitiateAprasial_Click" Style="float: right" />
                                    </div>
                                </div>
                            </div>
                        </div>
