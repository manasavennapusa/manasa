<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LineMangerRatingView.aspx.cs" Inherits="appraisal_LineMangerRatingView" %>
    ...
    <form id="myForm" runat="server" class="form-horizontal no-margin">
        ...
        <div class="dashboard-wrapper" style="margin-left: 0px;">
            ...
            <div class="main-container">
                        ...
                        <div class="widget">
                            ...
                            <div class="widget-body">
                                ...
                                <div runat="server" id="empsearch">
                                    ...
                                    <table width="100%" class="table table-condensed table-striped  table-bordered " visible="false" runat="server">
                                ...
                                <div runat="server" id="empdetails" visible="false">
                                        ...
                                        <tr>
                                            ...
                                            <td style="width: 50%; vertical-align: top">
                                                <table width="100%" class="table table-condensed table-striped  table-bordered ">
                                                    ...
                                                    <tr id="Tr1" style="height: 36px" runat="server" visible="false">
                                    ...
                                    <table style="width: 100%;" visible="false" runat="server">
                                        <tr>
                                    ...
                                    <table style="width: 100%;" class="table table-condensed table-striped  table-bordered pull-left">
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="frm-rght-clr123" style="width: 15%">
                                                    <asp:DropDownList ID="drp_skils_app" runat="Server" Width="115px" CssClass="blue1" Enabled="false">
                                                        <asp:ListItem Value="0">--Select--</asp:ListItem>
                                                        <asp:ListItem Value="4">4</asp:ListItem>
                                                        <asp:ListItem Value="3">3</asp:ListItem>
                                                        <asp:ListItem Value="2">2</asp:ListItem>
                                                ...
                                                <td class="frm-rght-clr123" style="width: 15%">
                                                    <asp:TextBox runat="server" ID="txt_skils_app" placeholder="Max 8000 Chars." Enabled="false" TextMode="MultiLine" Width="200px"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td class="frm-rght-clr123" style="width: 15%">
                                                    <asp:DropDownList ID="drp_quality_app" runat="Server" Width="115px" CssClass="blue1" Enabled="false">
                                                        <asp:ListItem Value="0">--Select--</asp:ListItem>
                                                        <asp:ListItem Value="4">4</asp:ListItem>
                                                        <asp:ListItem Value="3">3</asp:ListItem>
                                                        <asp:ListItem Value="2">2</asp:ListItem>
                                                ...
                                                <td class="frm-rght-clr123" style="width: 15%">
                                                    <asp:TextBox runat="server" ID="txt_quality_app" placeholder="Max 8000 Chars." Enabled="false" TextMode="MultiLine" Width="200px"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td class="frm-rght-clr123" style="width: 15%">
                                                    <asp:DropDownList ID="drp_comm_app" runat="Server" Width="115px" CssClass="blue1" Enabled="false">
                                                        <asp:ListItem Value="0">--Select--</asp:ListItem>
                                                        <asp:ListItem Value="4">4</asp:ListItem>
                                                        <asp:ListItem Value="3">3</asp:ListItem>
                                                        <asp:ListItem Value="2">2</asp:ListItem>
                                                ...
                                                <td class="frm-rght-clr123" style="width: 15%">
                                                    <asp:TextBox runat="server" ID="txt_comm_app" placeholder="Max 8000 Chars." Enabled="false" TextMode="MultiLine" Width="200px"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td class="frm-rght-clr123" style="width: 15%">
                                                    <asp:DropDownList ID="drp_self_app" runat="Server" Width="115px" CssClass="blue1" Enabled="false">
                                                        <asp:ListItem Value="0">--Select--</asp:ListItem>
                                                        <asp:ListItem Value="4">4</asp:ListItem>
                                                        <asp:ListItem Value="3">3</asp:ListItem>
                                                        <asp:ListItem Value="2">2</asp:ListItem>
                                                ...
                                                <td class="frm-rght-clr123" style="width: 15%">
                                                    <asp:TextBox runat="server" ID="txt_self_app" placeholder="Max 8000 Chars." Enabled="false" TextMode="MultiLine" Width="200px"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td class="frm-rght-clr123" style="width: 15%">
                                                    <asp:DropDownList ID="drp_pro_app" runat="Server" Width="115px" CssClass="blue1" Enabled="false">
                                                        <asp:ListItem Value="0">--Select--</asp:ListItem>
                                                        <asp:ListItem Value="4">4</asp:ListItem>
                                                        <asp:ListItem Value="3">3</asp:ListItem>
                                                        <asp:ListItem Value="2">2</asp:ListItem>
                                                ...
                                                <td class="frm-rght-clr123" style="width: 15%">
                                                    <asp:TextBox runat="server" ID="txt_pro_app" placeholder="Max 8000 Chars."  Enabled="false" TextMode="MultiLine" Width="200px"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td class="frm-rght-clr123" style="width: 15%">
                                                    <asp:DropDownList ID="drp_team_app" runat="Server" Width="115px" CssClass="blue1" Enabled="false">
                                                        <asp:ListItem Value="0">--Select--</asp:ListItem>
                                                        <asp:ListItem Value="4">4</asp:ListItem>
                                                        <asp:ListItem Value="3">3</asp:ListItem>
                                                        <asp:ListItem Value="2">2</asp:ListItem>
                                                ...
                                                <td class="frm-rght-clr123" style="width: 15%">
                                                    <asp:TextBox runat="server" ID="txt_team_app" placeholder="Max 8000 Chars." Enabled="false" TextMode="MultiLine" Width="200px"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td class="frm-rght-clr123" style="width: 15%">
                                                    <asp:DropDownList ID="drp_commit_app" runat="Server" Width="115px" CssClass="blue1" Enabled="false">
                                                        <asp:ListItem Value="0">--Select--</asp:ListItem>
                                                        <asp:ListItem Value="4">4</asp:ListItem>
                                                        <asp:ListItem Value="3">3</asp:ListItem>
                                                        <asp:ListItem Value="2">2</asp:ListItem>
                                                ...
                                                <td class="frm-rght-clr123" style="width: 15%">
                                                    <asp:TextBox runat="server" ID="txt_commit_app" placeholder="Max 8000 Chars." Enabled="false" TextMode="MultiLine" Width="200px"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td class="frm-rght-clr123" style="width: 15%">
                                                    <asp:DropDownList ID="drp_client_app" runat="Server" Width="115px" CssClass="blue1" Enabled="false">
                                                        <asp:ListItem Value="0">--Select--</asp:ListItem>
                                                        <asp:ListItem Value="4">4</asp:ListItem>
                                                        <asp:ListItem Value="3">3</asp:ListItem>
                                                        <asp:ListItem Value="2">2</asp:ListItem>
                                                ...
                                                <td class="frm-rght-clr123" style="width: 15%">
                                                    <asp:TextBox runat="server" ID="txt_client_app" placeholder="Max 8000 Chars." Enabled="false" TextMode="MultiLine" Width="200px"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td class="frm-rght-clr123" style="width: 15%">
                                                    <asp:DropDownList ID="drp_plan_app" runat="Server" Width="115px" CssClass="blue1" Enabled="false">
                                                        <asp:ListItem Value="0">--Select--</asp:ListItem>
                                                        <asp:ListItem Value="4">4</asp:ListItem>
                                                        <asp:ListItem Value="3">3</asp:ListItem>
                                                        <asp:ListItem Value="2">2</asp:ListItem>
                                                ...
                                                <td class="frm-rght-clr123" style="width: 15%">
                                                    <asp:TextBox runat="server" ID="txt_plan_app" placeholder="Max 8000 Chars." Enabled="false" TextMode="MultiLine" Width="200px"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td class="frm-rght-clr123" style="width: 15%">
                                                    <asp:DropDownList ID="drp_mentor_app" runat="Server" Width="115px" CssClass="blue1" Enabled="false">
                                                        <asp:ListItem Value="0">--Select--</asp:ListItem>
                                                        <asp:ListItem Value="4">4</asp:ListItem>
                                                        <asp:ListItem Value="3">3</asp:ListItem>
                                                        <asp:ListItem Value="2">2</asp:ListItem>
                                                ...
                                                <td class="frm-rght-clr123" style="width: 15%">
                                                    <asp:TextBox runat="server" ID="txt_mentor_app" placeholder="Max 8000 Chars."  Enabled="false" TextMode="MultiLine" Width="200px"></asp:TextBox>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
                                            ...
                                            <td>
                                                ...
                                                <table style="width: 100%;" class="table table-condensed table-striped  table-bordered pull-left">
                                                    ...
                                                    <tr id="troverall" runat="server">
                                                        ...
                                                        <td id="Td1" class="frm-rght-clr123" style="width: 10%" runat="server" visible="false">Performance and Behavior
                                                        </td>
                                                    </tr>
                                    ...
                                    <table style="width: 100%;" class="table table-condensed table-striped  table-bordered pull-left" visible="false" runat="server">
                                        <%--<tbody>--%>
                                            <tr>
                                    ...
                                    <div class="form-actions no-margin" style="text-align: right">
                                        <asp:Button ID="btnSubmit" runat="server" CssClass="btn btn-primary" Text="Submit" OnClick="btnSubmit_Click" ValidationGroup="v" Visible="false" />&nbsp;&nbsp;
                                        ...
                                        <asp:Button ID="btn_back" runat="server" CssClass="btn btn-primary pull-right"  Text="Back" title="Go Back" OnClick="btn_back_Click" />
                ...
                <div class="row-fluid" id="emplist" runat="server" visible="false">
                    <div class="span12">
