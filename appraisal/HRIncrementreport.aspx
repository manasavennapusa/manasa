<%@ Page Language="C#" AutoEventWireup="true" CodeFile="HRIncrementreport.aspx.cs" Inherits="appraisal_HRIncrementreport" %>
                            ...
                            <div class="widget-body">
                                        ...
                                        <tr id="trgoal1">
                                            <td colspan="2">
                                                <table width="100%" class="table table-condensed table-striped  table-bordered " id="Table1" runat="server">
                                                    <tr>
                                                        <td class="frm-lft-clr123 " style="border-right: 1px solid #e0e0e0"><b>Cycle 1 : Goal Setting</b>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                ...
                                <div class="clearfix">
                                    <div class="form-actions no-margin" id="div_btn" runat="server">
                                        <asp:Button ID="btnBack" runat="server" CssClass="btn btn-primary" CausesValidation="false" Text="Back" OnClick="btnBack_Click1" />
                                    </div>
                                </div>
                                <div class="clearfix"></div>
                            </div>
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Rating Status">
                                                    <ItemTemplate>
                                                        ...
                                                        <asp:Label ID="Labels3" runat="server" Text='<%# Bind("RatingStatus") %>' class="label label-success" Visible='<%#Eval("RatingStatus").ToString()=="Completed"?true:false%>'></asp:Label>
                                                ...
                                                <asp:HyperLinkField HeaderText="View" DataNavigateUrlFields="empcode" DataNavigateUrlFormatString="~/appraisal/HRIncrementreport.aspx?empcode={0}"
                                                    Text="View">
