<%@ Page Language="C#" AutoEventWireup="true" CodeFile="HRIniateIncrementDetails.aspx.cs" Inherits="appraisal_HRIniateIncrementDetails" %>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="frm-rght-clr123  " width="14%">
                                                        <asp:TextBox ID="txt_employee" runat="server" CssClass="span11" onkeypress="return isAlphaNumeric()"></asp:TextBox>
                                                          <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="txt_employee"
                                        ...
                                        <div runat="server" id="empdetails" visible="false">
                                                    ...
                                                    <td style="width: 50%; vertical-align: top">
                                                        <table width="100%" class="">
                                                            ...
                                                            <tr style="height: 36px">
                                                                ...
                                                                <td class="frm-rght-clr123">
                                                                    <asp:DropDownList ID="drpdegination" runat="server" CssClass="span11">
                                                                    </asp:DropDownList>
                                                                </td>
                                                            </tr>
                                                            <tr style="height: 36px" runat="server" visible="false">
                                                                ...
                                                                <td class="frm-rght-clr123">
                                                                    <asp:DropDownList ID="drpgrade" runat="server" CssClass="span11" DataSourceID="sql_data_grade"
                                                                        DataTextField="gradename" DataValueField="id">
                                                                    </asp:DropDownList>
                                                    ...
                                                    <td style="width: 50%; vertical-align: top">
                                                        <table width="100%" class="">
                                                            ...
                                                            <tr style="height: 36px">
                                                                ...
                                                                <td class="frm-rght-clr123" width="60%">
                                                                    <asp:TextBox ID="txtcurhike" runat="server" onkeypress="return IsNumericDot(event);" ondrop="return false;" onpaste="return false;" MaxLength="5"></asp:TextBox>
                                                                    <asp:RequiredFieldValidator
                                                                        ID="RequiredFieldValidator4" runat="server" ControlToValidate="txtcurhike" ErrorMessage="Hike(%)"
                                                            ...
                                                            <tr style="height: 36px">
                                                                ...
                                                                <td class="frm-rght-clr123">
                                                                    <asp:TextBox ID="txtincramount" runat="server" onkeypress="return IsNumericDot(event);" ondrop="return false;" onpaste="return false;"></asp:TextBox>
                                                                    <asp:RequiredFieldValidator
                                                                        ID="RequiredFieldValidator3" runat="server" ControlToValidate="txtincramount" ErrorMessage="Increased Amount"
                                                                        Display="Dynamic" ValidationGroup="r"><img src="../images/error1.gif" alt="*" /></asp:RequiredFieldValidator>
                                                                </td>
                                                            </tr>
                                                            <tr style="height: 36px">
                                                                ...
                                                                <td class="frm-rght-clr123">
                                                                    <asp:TextBox ID="txtcurctc" runat="server" onkeypress="return IsNumericDot(event);" ondrop="return false;" onpaste="return false;"></asp:TextBox>
                                                                    <asp:RequiredFieldValidator
                                                                        ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtcurctc" ErrorMessage="Current CTC/PA"
                                                                        Display="Dynamic" ValidationGroup="r"><img src="../images/error1.gif" alt="*" /></asp:RequiredFieldValidator>
                                                                </td>
                                                            </tr>
                                                            <tr style="height: 36px">
                                                                ...
                                                                <td class="frm-rght-clr123">
                                                                    <asp:TextBox ID="txtcurbonus" runat="server" onkeypress="return IsNumericDot(event);" ondrop="return false;" onpaste="return false;"></asp:TextBox>
                                                                    <asp:RequiredFieldValidator
                                                                        ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtcurbonus" ErrorMessage="Current Bonus"
                                                                        Display="Dynamic" ValidationGroup="r"><img src="../images/error1.gif" alt="*" /></asp:RequiredFieldValidator>
                                                                </td>
                                                            </tr>
                                                            <tr style="height: 36px">
                                                                ...
                                                                <td class="frm-rght-clr123">
                                                                    <asp:TextBox ID="txtrevdate" runat="server" onkeypress="return isKey(event);" ondrop="return false;" onpaste="return false;"></asp:TextBox>
                                                                    <asp:Image ID="Image4" runat="server" ImageUrl="~/img/clndr.gif" placeholder="Select Date" />
                                                                    <cc1:CalendarExtender Format="dd-MMM-yyyy"
                                                                        ID="CalendarExtender4" runat="server" PopupButtonID="Image4" TargetControlID="txtrevdate"
                                                                        Enabled="True">
                                                                    </cc1:CalendarExtender>
                                                                    <asp:RequiredFieldValidator
                                                                        ID="RequiredFieldValidator15" runat="server" ControlToValidate="txtrevdate" ErrorMessage="Revised W.E.F"
                                                                        Display="Dynamic" ValidationGroup="r"><img src="../images/error1.gif" alt="*" /></asp:RequiredFieldValidator>
                                                                </td>
                                                            </tr>
                                            ...
                                            <div class="clearfix">
                                                <div class="form-actions no-margin" id="div_btn" runat="server">
                                                    <asp:Button ID="btnsave" runat="server" CssClass="btn btn-primary" Text="Submit to Approval" OnClick="btnsave_Click" ValidationGroup="r" />
                                                ...
                                                <asp:GridView ID="gveligible" runat="server" AutoGenerateColumns="false" CellSpacing="0" OnPreRender="gveligible_PreRender" DataKeyNames="empcode"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="Rating Status">
                                                            <ItemTemplate>
                                                                <asp:Label ID="Label1" runat="server" Text='<%# Bind("RatingStatus") %>' class="label label-important" Visible='<%#Eval("RatingStatus").ToString()=="Not Initiated"?true:false%>'></asp:Label>
                                                                <asp:Label ID="Label6" runat="server" Text='<%# Bind("RatingStatus") %>' class="label label-info" Visible='<%#Eval("RatingStatus").ToString()=="Initiated"?true:false%>'></asp:Label>
                                                                <asp:Label ID="Label3" runat="server" Text='<%# Bind("RatingStatus") %>' class="label label-success" Visible='<%#Eval("RatingStatus").ToString()=="Completed"?true:false%>'></asp:Label>
                                                        ...
                                                        <asp:HyperLinkField HeaderText="View" DataNavigateUrlFields="empcode" DataNavigateUrlFormatString="~/appraisal/HRIniateIncrementDetails.aspx?empcode={0}"
                                                            Text="View">
