...
public partial class appraisal_ViewratingEMP : System.Web.UI.Page

{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        UserCode = Request.QueryString["empcode"].ToString();
        if (!IsPostBack)
        {
            bindrating();
            getActiveCycle();
    ...
    protected void bindrating()
    {
        ...
        try
        {
            ...
            string query = @"select top 1 * from tbl_appraisal_rating_details_1 where empcode='" + UserCode + "' and updated_by is null order by id desc";
    ...
    {
        Response.Redirect("VIEWREAING.aspx");
    }
...
apt.appcycle_id= '" + Convert.ToInt32(Session["appcycle"]) + "' and  apt.empcode='" + Session["empcode"].ToString() + "'";
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            string query = @"select assessment_id,empcode from dbo.tbl_appraisal_assessment where empcode='" + empcode + "'";
            DataSet ds = SQLServer.ExecuteDataset(Connection, CommandType.Text, query);
            ...
            string query_1 = @"select * from tbl_appraisal_rating_details_1 where empcode='" + empcode + "'";
            DataSet ds_1 = SQLServer.ExecuteDataset(Connection, CommandType.Text, query_1);
            if (ds_1.Tables[0].Rows.Count < 1)
            {
                string str = @"Insert Into tbl_appraisal_rating_details_1(assessment_id,empcode,fun_skill_rating,fun_skill_cmnt,quality_rating,quality_cmnt,comm_skill_rating,comm_skill_cmnt,self_devlop_rating,self_devlop_cmnt,procs_knowldge_rating,procs_knowldge_cmnt,team_participation_rating,team_participation_cmnt,commitment_rating,commitment_cmnt,clnt_cust_orntion_rating,clnt_cust_orntion_cmnt,team_planing_rating,team_planing_cmnt,mentoring_leadrsip_rating,mentoring_leadrsip_cmnt,achievment_of_past_year,training_benefits_to_develop,additional_cmnt,additional_cmnt_1,created_by,created_date,status) values('" + ass_id + "','" + UserCode + "','" + drp_skils.SelectedItem.Text + "','" + txt_skill_cmnt.Text + "','" + drp_quality.SelectedItem.Text + "','" + txt_quality_cmnt.Text + "','" + drp_comm.SelectedItem.Text + "','" + txt_comm.Text + "','" + drp_self.SelectedItem.Text + "','" + txt_self.Text + "','" + drp_pro.SelectedItem.Text + "','" + txt_pro.Text + "','" + drp_team.SelectedItem.Text + "','" + txt_team.Text + "','" + drp_commit.SelectedItem.Text + "','" + txt_commit.Text + "','" + drp_client.SelectedItem.Text + "','" + txt_client.Text + "','" + drp_plan.SelectedItem.Text + "','" + txt_plan.Text + "','" + drp_mentor.SelectedItem.Text + "','" + txt_mentor.Text + "','" + txtappr.Text + "','" + txt_training.Text + "','" + txtcmnt_aap.Text + "','" + txtcmnt_appr.Text + "','" + UserCode + "','" + DateTime.Today.ToString("yyyy-MM-dd") + "','1')";
                SQLServer.ExecuteDataset(Connection, CommandType.Text, str);

                string str4 = @"update tbl_appraisal_assessment set behavior_color='EmpRating_G1' where appcycle_id= " + Convert.ToInt32(Session["appcycle"]) + " and  empcode='" + UserCode + "'";
                SQLServer.ExecuteDataset(Connection, CommandType.Text, str4);
            }
            else
            {
                string str = @"Insert Into tbl_appraisal_rating_details_1_for_cycle_2(assessment_id,empcode,fun_skill_rating,fun_skill_cmnt,quality_rating,quality_cmnt,comm_skill_rating,comm_skill_cmnt,self_devlop_rating,self_devlop_cmnt,procs_knowldge_rating,procs_knowldge_cmnt,team_participation_rating,team_participation_cmnt,commitment_rating,commitment_cmnt,clnt_cust_orntion_rating,clnt_cust_orntion_cmnt,team_planing_rating,team_planing_cmnt,mentoring_leadrsip_rating,mentoring_leadrsip_cmnt,achievment_of_past_year,training_benefits_to_develop,additional_cmnt,additional_cmnt_1,created_by,created_date,status) values('" + ass_id + "','" + UserCode + "','" + drp_skils.SelectedItem.Text + "','" + txt_skill_cmnt.Text + "','" + drp_quality.SelectedItem.Text + "','" + txt_quality_cmnt.Text + "','" + drp_comm.SelectedItem.Text + "','" + txt_comm.Text + "','" + drp_self.SelectedItem.Text + "','" + txt_self.Text + "','" + drp_pro.SelectedItem.Text + "','" + txt_pro.Text + "','" + drp_team.SelectedItem.Text + "','" + txt_team.Text + "','" + drp_commit.SelectedItem.Text + "','" + txt_commit.Text + "','" + drp_client.SelectedItem.Text + "','" + txt_client.Text + "','" + drp_plan.SelectedItem.Text + "','" + txt_plan.Text + "','" + drp_mentor.SelectedItem.Text + "','" + txt_mentor.Text + "','" + txtappr.Text + "','" + txt_training.Text + "','" + txtcmnt_aap.Text + "','" + txtcmnt_appr.Text + "','" + UserCode + "','" + DateTime.Today.ToString("yyyy-MM-dd") + "','1')";
                SQLServer.ExecuteDataset(Connection, CommandType.Text, str);
                ...
                string str5 = @"update tbl_appraisal_assessment set behavior_color='EmpRating_G2' where appcycle_id= " + Convert.ToInt32(Session["appcycle"]) + " and  empcode='" + UserCode + "'";
            ...
            string str1 = @"update tbl_appraisal_assessment set  trainingdetails='" + txt_training.Text + "',emp_overall_cmt ='" + txtcmnt_aap.Text + "',emp_overall_rating='" + lblOverallRating.Text + "' where appcycle_id= " + Convert.ToInt32(Session["appcycle"]) + " and  empcode='" + UserCode + "'";
    ...
    private void reset()
    {
        drp_skils.SelectedValue = "0";
        drp_quality.SelectedValue = "0";
        drp_comm.SelectedValue = "0";
        drp_self.SelectedValue = "0";
        drp_pro.SelectedValue = "0";
        drp_team.SelectedValue = "0";
        drp_commit.SelectedValue = "0";
        drp_client.SelectedValue = "0";
        drp_plan.SelectedValue = "0";
        drp_mentor.SelectedValue = "0";
        txt_skill_cmnt.Text = "";
    ...
    public void calculaterating()
    {
        ...
        if (drp_skils.SelectedValue != "0")
        {
            x = Convert.ToInt32(drp_skils.SelectedItem.Text);
            i = 1;

        }
        if (drp_quality.SelectedValue != "0")
        {
            y = Convert.ToInt32(drp_quality.SelectedItem.Text);
            x = x + y;
            i = i + 1;

        }
        if (drp_comm.SelectedValue != "0")
        {
            z = Convert.ToInt32(drp_comm.SelectedItem.Text);
            x = x + z;
            i = i + 1;

        }
        if (drp_self.SelectedValue != "0")
        {
            s = Convert.ToInt32(drp_self.SelectedItem.Text);
            x = x + s;
            i = i + 1;

        }
        if (drp_pro.SelectedValue != "0")
        {
            a = Convert.ToInt32(drp_pro.SelectedItem.Text);
            x = x + a;
            i = i + 1;

        }
        if (drp_team.SelectedValue != "0")
        {
            b = Convert.ToInt32(drp_team.SelectedItem.Text);
            x = x + b;
            i = i + 1;

        }
        if (drp_commit.SelectedValue != "0")
        {
            c = Convert.ToInt32(drp_commit.SelectedItem.Text);
            x = x + c;
            i = i + 1;

        }
        if (drp_client.SelectedValue != "0")
        {
            d = Convert.ToInt32(drp_client.SelectedItem.Text);
            x = x + d;
            i = i + 1;

        }
        if (drp_plan.SelectedValue != "0")
        {
            e = Convert.ToInt32(drp_plan.SelectedItem.Text);
            x = x + e;
            i = i + 1;

        }
        if (drp_mentor.SelectedValue != "0")
        {
            f = Convert.ToInt32(drp_mentor.SelectedItem.Text);
            x = x + f;
            i = i + 1;
