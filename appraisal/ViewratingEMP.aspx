<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ViewratingEMP.aspx.cs" Inherits="appraisal_ViewratingEMP" %>
                                            ...
                                            <tr>
                                                <td>
                                                    <table style="width: 100%; border: 0">
                                                        ...
                                                        <tr>
                                                            <td id="Td1" class="txt01" style="height: 40px" runat="server" visible="false"><strong>Training Requirement</strong>
                                                            </td>
                                                        </tr>
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class="frm-rght-clr123" style="width: 15%">
                                                                            <asp:DropDownList ID="drp_skils" runat="Server" Width="115px" Enabled="false">
                                                                                <asp:ListItem Value="0">--Select--</asp:ListItem>
                                                                        ...
                                                                        <td class="frm-rght-clr123" style="width: 15%">
                                                                            <asp:TextBox runat="server" ID="txt_skill_cmnt" placeholder="Max 8000 Chars." Enabled="false" TextMode="MultiLine" Width="200px"></asp:TextBox>
                                                                        </td>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class="frm-rght-clr123" style="width: 15%">
                                                                            <asp:DropDownList ID="drp_quality" runat="Server" Width="115px" Enabled="false">
                                                                                <asp:ListItem Value="0">--Select--</asp:ListItem>
                                                                                <asp:ListItem Value="4">4</asp:ListItem>
                                                                                <asp:ListItem Value="3">3</asp:ListItem>
                                                                                <asp:ListItem Value="2">2</asp:ListItem>
                                                                        ...
                                                                        <td class="frm-rght-clr123" style="width: 15%">
                                                                            <asp:TextBox runat="server" ID="txt_quality_cmnt" placeholder="Max 8000 Chars." Enabled="false" TextMode="MultiLine" Width="200px"></asp:TextBox>
                                                                        </td>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class="frm-rght-clr123" style="width: 15%">
                                                                            <asp:DropDownList ID="drp_comm" runat="Server" Width="115px" Enabled="false">
                                                                                <asp:ListItem Value="0">--Select--</asp:ListItem>
                                                                                <asp:ListItem Value="4">4</asp:ListItem>
                                                                                <asp:ListItem Value="3">3</asp:ListItem>
                                                                                <asp:ListItem Value="2">2</asp:ListItem>
                                                                        ...
                                                                        <td class="frm-rght-clr123" style="width: 15%">
                                                                            <asp:TextBox runat="server" ID="txt_comm" placeholder="Max 8000 Chars." Enabled="false" TextMode="MultiLine" Width="200px"></asp:TextBox>
                                                                        </td>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class="frm-rght-clr123" style="width: 15%">
                                                                            <asp:DropDownList ID="drp_self" runat="Server" Width="115px" Enabled="false">
                                                                                <asp:ListItem Value="0">--Select--</asp:ListItem>
                                                                                <asp:ListItem Value="4">4</asp:ListItem>
                                                                                <asp:ListItem Value="3">3</asp:ListItem>
                                                                                <asp:ListItem Value="2">2</asp:ListItem>
                                                                        ...
                                                                        <td class="frm-rght-clr123" style="width: 15%">
                                                                            <asp:TextBox runat="server" ID="txt_self" placeholder="Max 8000 Chars." Enabled="false" TextMode="MultiLine" Width="200px"></asp:TextBox>
                                                                        </td>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class="frm-rght-clr123" style="width: 15%">
                                                                            <asp:DropDownList ID="drp_pro" runat="Server" Width="115px" Enabled="false">
                                                                                <asp:ListItem Value="0">--Select--</asp:ListItem>
                                                                                <asp:ListItem Value="4">4</asp:ListItem>
                                                                                <asp:ListItem Value="3">3</asp:ListItem>
                                                                                <asp:ListItem Value="2">2</asp:ListItem>
                                                                        ...
                                                                        <td class="frm-rght-clr123" style="width: 15%">
                                                                            <asp:TextBox runat="server" ID="txt_pro" placeholder="Max 8000 Chars." Enabled="false" TextMode="MultiLine" Width="200px"></asp:TextBox>
                                                                        </td>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class="frm-rght-clr123" style="width: 15%">
                                                                            <asp:DropDownList ID="drp_team" runat="Server" Width="115px" Enabled="false">
                                                                                <asp:ListItem Value="0">--Select--</asp:ListItem>
                                                                                <asp:ListItem Value="4">4</asp:ListItem>
                                                                                <asp:ListItem Value="3">3</asp:ListItem>
                                                                                <asp:ListItem Value="2">2</asp:ListItem>
                                                                        ...
                                                                        <td class="frm-rght-clr123" style="width: 15%">
                                                                            <asp:TextBox runat="server" ID="txt_team" placeholder="Max 8000 Chars." Enabled="false" TextMode="MultiLine" Width="200px"></asp:TextBox>
                                                                        </td>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class="frm-rght-clr123" style="width: 15%">
                                                                            <asp:DropDownList ID="drp_commit" runat="Server" Width="115px" Enabled="false">
                                                                                <asp:ListItem Value="0">--Select--</asp:ListItem>
                                                                                <asp:ListItem Value="4">4</asp:ListItem>
                                                                                <asp:ListItem Value="3">3</asp:ListItem>
                                                                                <asp:ListItem Value="2">2</asp:ListItem>
                                                                        ...
                                                                        <td class="frm-rght-clr123" style="width: 15%"> 
                                                                            <asp:TextBox runat="server" ID="txt_commit" placeholder="Max 8000 Chars." Enabled="false" TextMode="MultiLine" Width="200px"></asp:TextBox>
                                                                        </td>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class="frm-rght-clr123" style="width: 15%">
                                                                            <asp:DropDownList ID="drp_client" runat="Server" Width="115px" Enabled="false">
                                                                                <asp:ListItem Value="0">--Select--</asp:ListItem>
                                                                                <asp:ListItem Value="4">4</asp:ListItem>
                                                                                <asp:ListItem Value="3">3</asp:ListItem>
                                                                                <asp:ListItem Value="2">2</asp:ListItem>
                                                                        ...
                                                                        <td class="frm-rght-clr123" style="width: 15%">
                                                                            <asp:TextBox runat="server" ID="txt_client" placeholder="Max 8000 Chars." Enabled="false" TextMode="MultiLine" Width="200px"></asp:TextBox>
                                                                        </td>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class="frm-rght-clr123" style="width: 15%">
                                                                            <asp:DropDownList ID="drp_plan" runat="Server" Width="115px" Enabled="false">
                                                                                <asp:ListItem Value="0">--Select--</asp:ListItem>
                                                                                <asp:ListItem Value="4">4</asp:ListItem>
                                                                                <asp:ListItem Value="3">3</asp:ListItem>
                                                                                <asp:ListItem Value="2">2</asp:ListItem>
                                                                        ...
                                                                        <td class="frm-rght-clr123" style="width: 15%">
                                                                            <asp:TextBox runat="server" ID="txt_plan" placeholder="Max 8000 Chars."  Enabled="false" TextMode="MultiLine" Width="200px"></asp:TextBox>
                                                                        </td>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class="frm-rght-clr123" style="width: 15%">
                                                                            <asp:DropDownList ID="drp_mentor" runat="Server" Width="115px" Enabled="false">
                                                                                <asp:ListItem Value="0">--Select--</asp:ListItem>
                                                                                <asp:ListItem Value="4">4</asp:ListItem>
                                                                                <asp:ListItem Value="3">3</asp:ListItem>
                                                                                <asp:ListItem Value="2">2</asp:ListItem>
                                                                        ...
                                                                        <td class="frm-rght-clr123" style="width: 15%">
                                                                            <asp:TextBox runat="server" ID="txt_mentor" placeholder="Max 8000 Chars." Enabled="false" TextMode="MultiLine" Width="200px"></asp:TextBox>
                                                                        </td>
                                                    ...
                                                    <table style="width: 100%;" class="table table-condensed table-striped  table-bordered pull-left">
                                                        <tbody>
                                                            <tr id="Tr2" visible="false" runat="server">
                                                                <td id="Td2" class="frm-lft-clr123" style="width: 15%" visible="false" runat="server">Overall Rating
                                                                </td>
                                                                <td class="frm-rght-clr123" style="width: 15%">
                                                                ...
                                                                <td id="Td3" class="frm-lft-clr123" visible="false" runat="server">Overall Comments
                                                                </td>
                                                                <td id="Td4" class="frm-rght-clr123" visible="false" runat="server">
                                                ...
                                                <td>
                                                    <table style="width: 100%;" class="table table-condensed table-striped  table-bordered pull-left">
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <td>
                                                                   <asp:TextBox ID="txtappr" runat="server" TextMode="MultiLine" Width="600px" placeholder="Max 8000 chars." Enabled="false"></asp:TextBox>
                                                ...
                                                <td>
                                                    <table style="width: 100%;" class="table table-condensed table-striped  table-bordered pull-left">
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <td>
                                                                   <asp:TextBox ID="txt_training" runat="server" TextMode="MultiLine" Width="600px" placeholder="Max 8000 chars." Enabled="false"></asp:TextBox>
                                                    ...
                                                    <table style="width: 100%;" class="table table-condensed table-striped  table-bordered pull-left">
                                                        <tbody>
                                                            ...
                                                            <tr runat="server" id="appr_div1" visible="true" >
                                                                <td>
                                                                    <asp:TextBox runat="server" ID="txtcmnt_aap" TextMode="MultiLine" Width="600px" Height="50px"  placeholder="Max 8000 chars." Enabled="false"></asp:TextBox>
                                                            ...
                                                            <tr runat="server" id="appr_div" visible="true" >
                                                                <td style="background-color:white">
                                                                    <asp:TextBox runat="server" ID="txtcmnt_appr" TextMode="MultiLine" Width="600px" Height="50px"   placeholder="Max 8000 chars." Enabled="false"></asp:TextBox>
