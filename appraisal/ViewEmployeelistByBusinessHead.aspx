<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ViewEmployeelistByBusinessHead.aspx.cs" Inherits="appraisal_ViewEmployeelistByBusinessHead" %>
                                    ...
                                    <table width="100%" class="table table-condensed table-striped  table-bordered pull-left">
                                        ...
                                        <tr>
                                          ...
                                          <%--  <td class="frm-lft-clr123  " style="width: 11%">Grade</td>
                                            ...
                                            <td class="frm-rght-clr123  " width="12%">&nbsp;<asp:DropDownList ID="ddl_dept" runat="server" CssClass="span11" DataSourceID="SqlDataSourc4"
                                                    ...
                                                    <tr>
                                                     ...
                                                     <tr>
                                                        ...
                                                        <td class="frm-rght-clr123 " style="width: 80%;">
                                                            <asp:Label ID="lblgolfrzdatecycle1" runat="server"></asp:Label>
                                        ...
                                        <tr runat="server" visible="false">
                                            <td colspan="2">
                                                <table width="100%" class="table table-condensed table-striped  table-bordered " id="tblComments" runat="server">
                                                    <tr>
                                                        <td class="frm-lft-clr123 " style="width: 20%;"><b>Cycle 2 :</b>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="frm-rght-clr123 " style="width: 80%;">
                                                            <asp:Label ID="lbempcmtscycle2" runat="server"></asp:Label>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td class="frm-lft-clr123 " style="width: 20%;">
                                ...
                                <div id="Div2" class="example_alt_pagination">
                                    <asp:GridView ID="GridView1" runat="server" CellSpacing="0"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:HyperLinkField HeaderText="View" DataNavigateUrlFields="empcode,appcycle_id" DataNavigateUrlFormatString="~/appraisal/LineMangerRatingView.aspx?empcode={0}&back=1&appcycle_id={1}"
                                    ...
                                    <table id="tblTraining1" runat="server" style="width: 100%;display:none" class="table table-condensed table-striped  table-bordered pull-left">

                                        <tr >
                                            <td class="txt01" style="height: 40px" id="trTraining1" runat="server"><b>Training Requirement</b>
                                            </td>
                                    ...
                                    <table class="table table-condensed table-striped  table-bordered pull-left" runat="server" style="display:none">
                                            ...
                                            <td>
                                                ...
                                                <table style="width: 100%;" class="table table-condensed table-striped  table-bordered pull-left">
                                                    ...
                                                    <tr id="troverall1" runat="server">
                                                        <td class="frm-lft-clr123 border-bottom" style="width: 15%; border-top: none;border-bottom: 1px #ddd solid;">Employee Overall Rating
                                                        </td>
                                                        <td class="frm-rght-clr123 border-bottom" style="width: 15%; border-top: none;border-bottom: 1px #ddd solid;">
                                                            <asp:Label ID="lblOverallRating" runat="server"></asp:Label>
                                                        </td>
                                                        <td class="frm-lft-clr123 border-bottom" style="width: 20%; border-top: 1px #ddd solid; border-bottom: 1px #ddd solid;">Employee Overall Comments
                                                        </td>
                                                        <td class="frm-rght-clr123 border-bottom" style="width: 40%;  border-top: 1px #ddd solid; border-bottom: 1px #ddd solid;">
                                                            <asp:Label ID="txtOverallComments" runat="server"></asp:Label>
                                                        </td>
                                                        <td class="frm-rght-clr123" style="width: 10%;  border-top: 1px #ddd solid; border-bottom: 1px #ddd solid;" id="tdcolor1" runat="server">Performance and Behavior
                                                        </td>
                                                    </tr>
                                                    <tr id="troverall2" runat="server">
                                                        <td class="frm-lft-clr123 border-bottom" style="width: 15%;border-bottom: 1px #ddd solid;">Manager  Overall Rating
                                                        </td>
                                ...
                                <div id="dt_example" class="example_alt_pagination">
                                    <asp:GridView ID="gveligible" runat="server" CellSpacing="0"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:HyperLinkField HeaderText="View" DataNavigateUrlFields="empcode" DataNavigateUrlFormatString="~/appraisal/ViewEmployeelistByBusinessHead.aspx?empcode={0}"
                                                Text="&lt;img src='../images/view.png' /&gt;">
