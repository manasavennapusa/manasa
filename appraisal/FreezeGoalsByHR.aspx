<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FreezeGoalsByHR.aspx.cs" Inherits="appraisal_FreezeGoalsByHR" %>
                        ...
                        <div class="widget">
                            ...
                            <div class="widget-body">
                                ...
                                <div runat="server" id="empdetails" visible="false">
                                    ...
                                    <table width="100%" runat="server" visible="false" border="0" cellspacing="0" cellpadding="0">
                                                    ...
                                                    <div id="dt_example" class="example_alt_pagination">
                                                        <asp:GridView ID="gveligible" runat="server" DataKeyNames="empcode" AutoGenerateColumns="false" OnPreRender="gveligible_PreRender"
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <asp:HyperLinkField HeaderText="View" DataNavigateUrlFields="empcode" DataNavigateUrlFormatString="~/appraisal/FreezeGoalsByHR.aspx?empcode={0}"
