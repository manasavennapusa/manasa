<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ReviewGoalsByManager.aspx.cs" Inherits="appraisal_ReviewGoalsByManager" %>
    ...
    <form id="myForm" runat="server" class="form-horizontal no-margin">
        ...
        <div class="dashboard-wrapper" style="margin-left: 0px;">
            ...
            <div class="main-container">
                ...
                <div class="row-fluid" id="cycle11" runat="server">
                    <div class="span12">
                        <div class="widget">
                                                ...
                                                <table width="100%" class="table table-condensed table-striped  table-bordered" id="tbl_overallcomments" runat="server">
                                                    <tr>
                                                        <td class="frm-lft-clr123 border-bottom">
                                                            <%--<asp:Label ID="lblcmtsText" runat="server" Text="Overall Manager's Comment">--%>Line Manager Comment<span class="star"></span><%--</asp:Label>--%>
                                                        </td>
                                                        <td class="frm-rght-clr123 border-bottom" style="width: 80%;">
                                                           ...
                                                           <%-- <asp:RequiredFieldValidator ID="txtCommentsRequired" runat="server" ControlToValidate="txtmgrComments" ErrorMessage='<img src="../images/error1.gif" alt="" /> <b style="color:red;">Please Enter the Comments</b>' ValidationGroup="v" SetFocusOnError="true" />--%>
                            ...
                            <div class="form-actions no-margin" id="btns" runat="server" visible="false" style="text-align: right">
                                <asp:Button ID="btnSubmit" runat="server" Text="Submit To BH" OnClick="btnSubmit_Click" CssClass="btn btn-success" ValidationGroup="v" Visible="false" />
                                <asp:Button ID="btnSubmitToEmp" runat="server" Text="Send TO EMP" OnClick="btnSubmitToEmp_Click" CssClass="btn btn-primary" ValidationGroup="v" Visible="false" />
                                <asp:Button ID="btnBack" runat="server" Text="Back" OnClick="btnBack_Click" CssClass="btn btn-info" CausesValidation="false" />
                                &nbsp;&nbsp;
                                <asp:Button ID="btn_submit_LM_review" runat="server" Text="Submit" CssClass="btn btn-info" OnClick="btn_submit_LM_review_Click" ValidationGroup="v"  Visible="false" />
                                &nbsp;&nbsp;
                            </div>
                        </div>
                    </div>
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Employee Name">
                                               ...
                                               <asp:TemplateField HeaderText="Designation">
                                                <ItemTemplate>
                                                    <asp:Label ID="lbldesg" runat="server" Text='<%# Eval ("designationname") %>'></asp:Label></a>
                                                </ItemTemplate>
                                            </asp:TemplateField>

                                            <asp:HyperLinkField HeaderText="View" DataNavigateUrlFields="empcode" DataNavigateUrlFormatString="~/appraisal/ReviewGoalsByManager.aspx?empcode={0}"
                                                Text="&lt;img src='../images/view.png' /&gt;">
                                            </asp:HyperLinkField>

                                            <asp:HyperLinkField DataNavigateUrlFields="empcode" DataNavigateUrlFormatString="editgoalsbyLM.aspx?empcode={0}"
                                                NavigateUrl="editgoalsbyLM.aspx" Text="&lt;img src='../images/edit.png'/&gt;" Visible="false">
                                            </asp:HyperLinkField>

                                             <asp:HyperLinkField HeaderText="Goal Cycle 2" DataNavigateUrlFields="empcode" DataNavigateUrlFormatString="~/appraisal/ReviewGoalsByManager_1.aspx?empcode={0}"
                                                Text="&lt;img src='../images/view.png' /&gt;" Visible="false">
                                            </asp:HyperLinkField>
