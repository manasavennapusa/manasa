...
public partial class appraisal_ViewEmployeelistByManager : System.Web.UI.Page
{
    decimal grdTotal = 0;
    ...
    protected void btn_search_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            DataSet ds = SQLServer.ExecuteDataset(ConfigurationManager.ConnectionStrings["intranetConnectionString"].ConnectionString.ToString(), CommandType.StoredProcedure, "sp_appraisal_listof_EmpforManager", sqlparam);
    ...
    protected void bindEmpDetails(string empcode)
    {
        ...
        try
        {
            ...
            if (dse.Tables[0].Rows.Count < 0)
            {
                ...
                //{
                  //  lbempcmtscyle2.Text = dse.Tables[0].Rows[0]["additional_cmnt_cycle2"].ToString();
...
where app.appcycle_id='" + Dropappcycle_id.SelectedValue.ToString() + "' and app.empcode='" + usercode.Trim() + "' and app.status in (1,3) and empjob.emp_status in (1,3) and lm_rtng.quater='" + quater + "' and lm_rtng.APP_year= '" + APP_year + "'";

           // and appapp.app_reportingmanager='" + empcode.Trim() + "'
