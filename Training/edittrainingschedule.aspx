<%@ Page Language="C#" AutoEventWireup="true" CodeFile="edittrainingschedule.aspx.cs" Inherits="Training_edittrainingschedule" %>
            ...
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                <ContentTemplate>
                                    ...
                                    <fieldset>
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                ...
                                                <asp:CompareValidator ID="CompareValidator1" runat="server" ControlToValidate="ddltrainingcode" ErrorMessage="CompareValidator" Operator="NotEqual" ToolTip="Training Code Required" ValidationGroup="c" ValueToCompare="0"><img src="../img/error1.gif" alt="" /></asp:CompareValidator>
                                            </div>
                                        </div>
                                        <div class="control-group">
                                            <label class="control-label">
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                ...
                                                <asp:CompareValidator ID="CompareValidator2" runat="server" ControlToValidate="ddl_branch_id" ErrorMessage="CompareValidator" Operator="NotEqual" ToolTip="Branch Required" ValidationGroup="c" ValueToCompare="0"><img src="../img/error1.gif" alt="" /></asp:CompareValidator>
                                            </div>
                                        </div>
                                        <div class="control-group">
                                            <label class="control-label">
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <asp:DropDownList ID="ddl_month" runat="server" CssClass="span10" OnSelectedIndexChanged="ddl_month_SelectedIndexChanged" AutoPostBack="true">
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                ...
                                                <cc1:CalendarExtender ID="CalendarExtender1" runat="server" Enabled="True" Format="dd-mm-yyyy" PopupButtonID="Image1" TargetControlID="txt_fromdate">
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                ...
                                                <cc1:CalendarExtender ID="CalendarExtender2" runat="server" Enabled="True" Format="dd-mm-yyyy" PopupButtonID="Image2" TargetControlID="txt_todate">
                                                </cc1:CalendarExtender>
                                ...
                                <div class="widget">
                                    ...
                                    <fieldset>
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <asp:TextBox ID="txt_faculty" runat="server" Enabled="false" CssClass="span10"></asp:TextBox>
                                            <%--    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txt_faculty"
                                                    Display="Dynamic" SetFocusOnError="True" ToolTip="Faculty Name Required" ValidationGroup="c"
                                                    Width="6px"><img src="../img/error1.gif" alt="" /></asp:RequiredFieldValidator>--%>
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <asp:TextBox ID="txt_noofhours" runat="server" placeholder="hh:mm:ss" CssClass="span10"></asp:TextBox>
                                            </div>
                                        </div>
                                        <%--<div class="control-group">
                                            <label class="control-label">
                    ...
                    <div class="form-actions no-margin" style="text-align: right">
                        <asp:Button ID="btnsv" OnClick="btnsv_Click" runat="server" Text="Update" ValidationGroup="c" CssClass="btn btn-info"></asp:Button>
