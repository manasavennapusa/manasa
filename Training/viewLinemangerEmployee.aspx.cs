...
public partial class Training_viewLinemangerEmployee : System.Web.UI.Page
{
...
convert(varchar(20),emp.todate,103) as todate,convert(varchar(20),mark.Newdatepresent,103)as Newdatepresent,
 ...
 emp.Faculty,
      emp.modulename, app.app_reportingmanager ,
...
where emp.fromdate='" + fromdate + "' AND emp.todate='" + todate + "' and emp.training_code=" + trainingcode + "  and emp.modulename='" + modulenamess + "' and deb.departmentid='" + departmentid + "' and app.app_reportingmanager='" + _userCode + "'";
    ...
    protected void btn_export_Click(object sender, EventArgs e)
    {
        if (gridmark.Rows.Count > 0)
        {
            ...
            Response.Charset = "";
            string FileName = "ViewLinemngerEmployeeReport" + DateTime.Now + ".xls";
