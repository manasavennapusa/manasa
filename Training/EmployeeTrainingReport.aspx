<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EmployeeTrainingReport.aspx.cs" Inherits="Training_EmployeeTrainingReport" %>
                                                        ...
                                                        <asp:Label ID="lblemfac" runat="server" Text='<%# Eval ("Faculty") %>'></asp:Label></a>
                                                                            ...
                                                                            <%--<asp:HyperLinkField HeaderText="View" DataNavigateUrlFields="dept_name,id" DataNavigateUrlFormatString="viewby_addparticipants.aspx?dept_name={0}&id={1}"
                                                                                ...
                                                                                <ControlStyle CssClass="btn btn-primary" />
                                                                                 ...
                                                                                 <asp:HyperLinkField DataNavigateUrlFields="dept_name,FromDate,ToDate,module_name,id,Faculty" HeaderText="View" DataNavigateUrlFormatString="viewemployeTrainigDeatils.aspx?dept_name={0}&FromDate={1}&ToDate={2}&module_name={3}&id={4}&Faculty={5}"
                                                NavigateUrl="viewemployeTrainigDeatils.aspx" Text="&lt;img src='../images/view.png'/&gt;">
