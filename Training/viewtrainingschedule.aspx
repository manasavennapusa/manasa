<%@ Page Language="C#" AutoEventWireup="true" CodeFile="viewtrainingschedule.aspx.cs" Inherits="Training_viewtrainingschedule" %>
                        ...
                        <div class="widget no-margin">
                            ...
                            <div class="widget-body">
                                <div id="dt_example" class="example_alt_pagination">
                                    <asp:GridView ID="trigrid"  runat="server" DataKeyNames="FromDate" AutoGenerateColumns="False" OnPreRender="trigrid_PreRender"
                                     ...
                                     AllowSorting="true">
                                        <Columns>
                                            ...
                                            <asp:HyperLinkField DataNavigateUrlFields="trainingcode,FromDate,ToDate,modulename" DataNavigateUrlFormatString="viewtrainingscheduleby_HR.aspx?trainingcode={0}&FromDate={1}&ToDate={2}&modulename={3}"
                                                NavigateUrl="viewtrainingscheduleby_HR.aspx" Text="&lt;img src='../images/view.png' /&gt;">
                                            </asp:HyperLinkField>
