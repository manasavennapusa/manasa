<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ViewParticipantsScheduled.aspx.cs" Inherits="Training_ViewParticipantsScheduled" %>
                                                                    ...
                                                                    <asp:GridView ID="gridtrainingrequest"
                                                                        ...
                                                                        <Columns>
                                                                            ...
                                                                            <asp:TemplateField HeaderText="Department Name">
                                                                               ...
                                                                               <asp:TemplateField HeaderText="Faculty" Visible="false">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblemfac" runat="server" Text='<%# Eval ("Faculty") %>'></asp:Label></a>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                                            <%--<asp:HyperLinkField HeaderText="View" DataNavigateUrlFields="dept_name,id" DataNavigateUrlFormatString="viewby_addparticipants.aspx?dept_name={0}&id={1}"
                                                                                Text="View">
                                                                                <ControlStyle CssClass="btn btn-primary" />
                                                                            </asp:HyperLinkField>--%>
                                                                                 <asp:HyperLinkField DataNavigateUrlFields="dept_name,FromDate,ToDate,module_name,id,Faculty" HeaderText="View" DataNavigateUrlFormatString="participantfeedbackform.aspx?dept_name={0}&FromDate={1}&ToDate={2}&module_name={3}&id={4}&Faculty={5}"
                                                NavigateUrl="participantfeedbackform.aspx" Text="&lt;img src='../images/view.png'/&gt;">

                                                <HeaderStyle CssClass="" />
                                                <ControlStyle CssClass="link05" Width="50%" />
                                          </asp:HyperLinkField>
                                                                          <%--    <asp:HyperLinkField HeaderText="View" DataNavigateUrlFields="dept_name,FromDate,ToDate,module_name" DataNavigateUrlFormatString="viewby_addparticipants.aspx?dept_name={0}&FromDate={1}&ToDate={2}&module_name={3}"
                                                                                Text="View">
                                                                                <ControlStyle CssClass="btn btn-primary" />
                                                                            </asp:HyperLinkField>--%>
                                                                        </Columns>
