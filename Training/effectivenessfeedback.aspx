<%@ Page Title="" Language="C#" AutoEventWireup="true" CodeFile="effectivenessfeedback.aspx.cs" Inherits="training_effectivenessfeedback" %>
                                            ...
                                            <asp:GridView ID="Grid_feedback" runat="server" DataKeyNames="id" AutoGenerateColumns="False"
                                                ...
                                                <Columns>
                                                   ...
                                                   <%-- <asp:TemplateField HeaderText="Module Name">
                                                    ...
                                                    <asp:HyperLinkField DataNavigateUrlFields="empcode" DataNavigateUrlFormatString="vieweffectivenessfeedbackform.aspx?empcode={0}"
                                                        NavigateUrl="vieweffectivenessfeedbackform.aspx" Text="&lt;img src='../images/view.png' /&gt;" ></asp:HyperLinkField>
                                                </Columns>
                                            </asp:GridView>
