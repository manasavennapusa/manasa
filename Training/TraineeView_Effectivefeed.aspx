<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TraineeView_Effectivefeed.aspx.cs" Inherits="Training_TraineeView_Effectivefeed" %>
                                            ...
                                            <asp:GridView ID="Grid_feedback" runat="server" DataKeyNames="id" AutoGenerateColumns="False"
                                                ...
                                                <Columns>
                                                   ...
                                                   <%-- <asp:TemplateField HeaderText="Module Name">
                                                    ...
                                                    <asp:HyperLinkField DataNavigateUrlFields="empcode" DataNavigateUrlFormatString="viewEffectiveLinemagerfeed.aspx?empcode={0}&back=1"
                                                        NavigateUrl="viewEffectiveLinemagerfeed.aspx"  Text="&lt;img src='../images/view.png' /&gt;" ></asp:HyperLinkField>
                                                </Columns>
                                            </asp:GridView>
