...
public partial class Training_TraineeView_Effectivefeed : System.Web.UI.Page
{
    string Usercode;
    ...
    protected void bindfeedbackgrid()
    {
        ...
        string str = @"select distinct imp.empcode ,fee.id ,imp.emp_fname,imp.department_name,imp.training_name,
...
and fee.todate=emp.todate                                           
 where fee.created_by='" + Usercode + "' and fee.approverstatus=1";
