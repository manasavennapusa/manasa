<%@ Page Language="C#" AutoEventWireup="true" CodeFile="viewtrainingscheduleby_user.aspx.cs" Inherits="Training_viewtrainingscheduleby_user" %>
            ...
            <div class="main-container">
                ...
                <div class="row-fluid">
                      ...
                      <table class="table table-condensed table-striped  table-bordered pull-left">
                                <tr>
                                    <td width="50%">Select Training Effectiveness To Be Conducted:nducted:</td>
                                    <td width="50%">                                      
                ...
                <div class="row-fluid">
                    ...
                    <div align="right">
                        <asp:Button ID="btnsv" OnClick="btnsv_Click" runat="server" Text="Nominee" CssClass="btn btn-primary"
