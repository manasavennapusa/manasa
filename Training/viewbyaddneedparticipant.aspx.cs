...
public partial class Training_viewbyaddneedparticipant : System.Web.UI.Page
{
    DataSet ds = new DataSet();
    string _userCode, _companyId, RoleId, empcode, fromdate, todate, modulename, backbuton, trainingname, departmentid;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (Session["empcode"] != null && Session["companyid"] != null)
        {
            ...
            //tid = Request.QueryString["trining_id"].ToString();
...
//CONVERT (varchar(40),fromdate,106) as Fromdate,
//CONVERT (varchar(40),todate,106) as Todate,
...
//where id = '" + tid + "'";
            ...
            string sqlstr = @"select distinct el_emp.empcode,ts.training_code,ts.training_name,
bd.branch_name,dep.department_name,dt.dept_type_name,
...
inner join tbl_internate_department_type dt on ts.dept_type=dt.dept_type_id
inner join tbl_internate_departmentdetails dep on ts.dept_name=dep.departmentid
inner join tbl_training_elegible_emp el_emp on el_emp.training_code=ts.training_code
where el_emp.empcode='" + empcode.Trim() + "' and (CONVERT (varchar(40),ts.Fromdate,106)='" + fromdate + "' and CONVERT (varchar(40),ts.Todate,106)='" + todate + "' )  and ts.training_name='" + trainingname + "' and dep.departmentid='" + departmentid + "'";
    ...
    {
        Response.Redirect("~/Training/needshchduledEmployee.aspx");
    }
    protected void btn_back_Click(object sender, EventArgs e)
    {
        //Response.Redirect("viewbyHR_addparticipent.aspx");
        Response.Redirect("~/Training/scheduledEmployeeDetails.aspx");
    }
}