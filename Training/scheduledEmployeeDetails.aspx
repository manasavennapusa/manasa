<%@ Page Language="C#" AutoEventWireup="true" CodeFile="scheduledEmployeeDetails.aspx.cs" Inherits="Training_scheduledEmployeeDetails" %>
                                                                ...
                                                                <div id="dt_example" class="example_alt_pagination">
                                                                    ...
                                                                    <asp:GridView ID="gridtrainingrequest"
                                                                        ...
                                                                        <Columns>
                                                                            ...
                                                                            <asp:HyperLinkField DataNavigateUrlFields="dept_name,FromDate,ToDate,module_name,id,Faculty" HeaderText="View" DataNavigateUrlFormatString="viewbyHR_addparticipent.aspx?dept_name={0}&FromDate={1}&ToDate={2}&module_name={3}&id={4}&Faculty={5}"
                                                                                NavigateUrl="viewbyHR_addparticipent.aspx" Text="&lt;img src='../images/view.png'/&gt;">
