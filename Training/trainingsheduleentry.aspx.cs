...
public partial class Training_TrainingSheduleEntry : System.Web.UI.Page
{
            ...
            if (lst_deptname.SelectedIndex != -1)
            {
                ...
                foreach (ListItem item in lst_deptname.Items)
                {
                    if (item.Selected)
                    {
                        ...
                        Output.AssignParameter(parm, 0, "@training_code", "String", 10, ddltrainingcode.SelectedValue);
                        ...
                        Output.AssignParameter(parm, 5, "@module_name", "String", 50, txt_module_name.Text);
                        Output.AssignParameter(parm, 6, "@descriptions", "String", 1000, txt_description.Text);
                        Output.AssignParameter(parm, 7, "@month", "String", 20, ddl_month.SelectedItem.Text);
                        Output.AssignParameter(parm, 8, "@fromdate", "DateTime", 0, Convert.ToDateTime(txt_fromdate.Text).ToString());
                        Output.AssignParameter(parm, 9, "@bachcode", "String", 10, txt_bachcode.Text);
                        Output.AssignParameter(parm, 10, "@training_type", "String", 50, ddl_trainingtype.SelectedItem.Text);
                        Output.AssignParameter(parm, 11, "@training_shortname", "String", 50, txt_training_short_name.Text);
                        Output.AssignParameter(parm, 12, "@year", "String", 20, ddlyear.SelectedItem.Text);
                        Output.AssignParameter(parm, 13, "@todate", "DateTime", 0, Convert.ToDateTime(txt_todate.Text).ToString());
                        Output.AssignParameter(parm, 14, "@trainer", "String", 50, txt_time_of_training.Text);
                        Output.AssignParameter(parm, 15, "@faculty", "String", 50, txt_faculty.Text);
                        Output.AssignParameter(parm, 16, "@noofhours", "Int", 0, txt_noofhours.Text);
                        ...
                        //if (rd_external.Checked == true)
                        //{
                        //    Output.AssignParameter(parm, 18, "@source_external", "Int", 1, "1");
                        //}
                        //else
                        //{
                        //    Output.AssignParameter(parm, 18, "@source_external", "Int", 1, "0");
                        //}
                        ...
                        Output.AssignParameter(parm, 24, "@createdby", "String", 20, _userCode);
...
//            string str6 = @"Insert Into tbl_training_schedul(training_code,training_name,branch,dept_type ,dept_name ,module_name ,
//descriptions ,month ,fromdate ,bachcode ,training_type ,training_shortname ,year,todate ,trainer,faculty ,noofhours ,source_internal ,
//effectiveness_to_be_cond,feedback_to_be_cond ,action_plan_to_be_cond ,program ,faculty_description ,any_other,createdby,createddate,status,approverstatus,tds)
//Values('" + ddltrainingcode.SelectedValue + "','" + txttrainingname.Text + "','"+ddl_branch_id.SelectedValue+"','"+ddl_department.SelectedValue+"','"+ddl_department.SelectedItem.Text+"','"+txt_module_name.Text+"',
//'"+txt_description.Text+"','"+ddl_month.SelectedItem.Text+"','"+txt_fromdate.Text+"','"+txt_bachcode.Text+"','"+ddl_trainingtype.SelectedItem.Text+"','"+txt_training_short_name.Text+"',
//'"+ddlyear.SelectedItem.Text+"','"+txt_todate.Text+"','"+txt_time_of_training.Text+"','"+txt_faculty.Text+"','"+ txt_noofhours.Text+"',
//'"++"','"++"','"++"','"++"','"++"','"++"','"++"','"++"','"++"','"++"','"++"','"++"','"++"','"++"','"++"','"++"','"++"','"++"')";
