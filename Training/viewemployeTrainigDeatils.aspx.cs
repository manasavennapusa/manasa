...
public partial class Training_viewemployeTrainigDeatils : System.Web.UI.Page
{
    string sqlstr, _userCode, _companyId, RoleId, trainingcode, fromdate, todate, modulename, dept_name, modulenamess;
    int flag;
...
where emp.fromdate='" + fromdate + "' AND emp.todate='" + todate + "'  and emp.modulename='" + modulenamess + "' and deb.departmentid='" + dept_name + "' and emp.empcode='" + _userCode + "'";
    ...
    protected void btn_export_Click(object sender, EventArgs e)
    {
        if (gridmark.Rows.Count > 0)
        {
            ...
            Response.Charset = "";
            string FileName = "ViewEmployeeWiseReport" + DateTime.Now + ".xls";
