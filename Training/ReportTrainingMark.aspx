<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ReportTrainingMark.aspx.cs" Inherits="Training_ReportTrainingMark" %>
                                     ...
                                     AllowSorting="true">
                                        <Columns>
                                         ...
                                         <%--    <asp:HyperLinkField DataNavigateUrlFields="trainingcode,FromDate,ToDate,modulename,dept_id" DataNavigateUrlFormatString="edittrainingschedule.aspx?trainingcode={0}&FromDate={1}&ToDate={2}&modulename={3}&dept_id={4}"
                                            ...
                                            <asp:HyperLinkField DataNavigateUrlFields="trainingcode,FromDate,ToDate,modulename,dept_id,id" DataNavigateUrlFormatString="ViewParticipantsEmployee.aspx?trainingcode={0}&FromDate={1}&ToDate={2}&modulename={3}&dept_id={4}&id={5}"
                                                NavigateUrl="ViewParticipantsEmployee.aspx" Text="&lt;img src='../images/view.png' /&gt;">
                                            </asp:HyperLinkField>
