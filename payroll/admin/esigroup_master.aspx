                ...
                <tr>
                    <td valign="top">
                        <asp:GridView ID="griddetail" runat="server" Font-Size="11px" Font-Names="Arial"
                            ...
                            <Columns>
                                <asp:TemplateField HeaderText="Group Name">
                                    ...
                                    <EditItemTemplate>
                                        <asp:TextBox ID="txt1" CssClass="blue1" runat="server" Width="30%" Text='<%# Bind ("esigrp_name") %>'></asp:TextBox>
                                ...
                                <asp:TemplateField HeaderText="Group Description">
                                    ...
                                    <EditItemTemplate>
                                        <asp:TextBox ID="txt2" runat="server" CssClass="blue1" Width="90%" Text='<%# Bind ("esigrp_desc") %>'></asp:TextBox>
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConflictDetection="CompareAllValues"
                            ConnectionString="<%$ ConnectionStrings:intranetConnectionString %>" DeleteCommand="DELETE FROM [tbl_payroll_esigroup_details] WHERE [id] = @original_id AND [esigrp_name] = @original_esigrp_name AND [esigrp_desc] = @original_esigrp_desc"
