...
public partial class payroll_admin_startstopPerquisiteamount : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        txtperquistename.Text = _userCode;
        bind_fyear();
    ...
    protected void btnsbmit_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            string sqlstr = @"update tbl_payroll_employee_perquisite set flag = 1 where empcode ='" + txtperquistename.Text + "' and fyear='" + lbl_fyear.Text + "'";
    ...
    protected void btn_start_Click(object sender, EventArgs e)
    {
        ...
        {
            connection = activity.OpenConnection();
            string sqlstr = @"update tbl_payroll_employee_perquisite set flag = 0 where empcode ='" + txtperquistename.Text + "' and fyear='" + lbl_fyear.Text + "'";
            SQLServer.ExecuteScalar(connection, CommandType.Text, sqlstr);
            //if (ds.Tables[0].Rows.Count < 1)
            //    return;
