...
public partial class payroll_admin_mypayslip : System.Web.UI.Page
{
    ...
    protected void btnsbmit_Click(object sender, EventArgs e)
    {
        ...
        if (Convert.ToInt16(ds.Tables[0].Rows[0][0]) > 0)
        {
            ...
            message.InnerHtml = "Salary has not been process";
    }
    ...
    {
        sqlstr = "select distinct month,fromdate from tbl_payroll_employee_salary where year='" + dd_year.SelectedValue + "' and flag= 0 order by fromdate";
        ds = DBTask.ExecuteDataset(ConfigurationManager.ConnectionStrings["intranetConnectionString"].ToString(), CommandType.Text, sqlstr);
