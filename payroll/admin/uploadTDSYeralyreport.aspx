<%@ Page Language="C#" AutoEventWireup="true" CodeFile="uploadTDSYeralyreport.aspx.cs" Inherits="payroll_admin_uploadTDSYeralyreport" %>
                                                ...
                                                <td valign="top">
                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                            ...
                                                            <td colspan="2" valign="top" class="blue-brdr-1">
                                                                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                                                    <tr>
                                                                        ...
                                                                        <td class="txt01">Upload Employee TDS</td>
                                                                        <td><a style="float:right;" href="doc/TDS.xlsx">Download</a></td>
                                                                    </tr>
                                                                </table>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                         ...
                                                         <tr>
                                                            <td valign="left" class="frm-lft-clr123" style="width: 149px">Financial Year<span class="star"></span></td>
                                                        ...
                                                        <tr>
                                                            <td valign="left" class="frm-lft-clr123" style="width: 149px">Upload Employee TDS<span class="star"></span></td>
                                                            <td valign="top" class="frm-rght-clr123" style="width: 471px">&nbsp;
