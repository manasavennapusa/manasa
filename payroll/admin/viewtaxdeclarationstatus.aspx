<%@ Page Language="C#" AutoEventWireup="true" CodeFile="viewtaxdeclarationstatus.aspx.cs" Inherits="payroll_admin_viewtaxdeclarationstatus" %>
                                                                        ...
                                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                            <tr>
                                                                                <td height="20" valign="top" class="txt02">
                                                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                        <tr>
                                                                                            <td width="27%" class="txt02">Tax Calculation Status
                                                                                            </td>
                                                                                                ...
                                                                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                                    <tr>
                                                                                                        <td valign="top" style="width: 100%">
                                                                                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                                                <tr>
                                                                                                                    <td valign="top" class="txt02" style="height: 20px"></td>
                                                                                                                </tr>
                                                                                                                <tr>
                                                                                                                    <td class="frm-rght-clr123 border-bottom" colspan="2">
                                                                                                                        ...
                                                                                                                        <div class="widget-content">
                                                                                                                            <asp:GridView ID="griddetail" runat="server"
                                                                                                                                ...
                                                                                                                                PageSize="80" EmptyDataText="No such declaration found !"
                                                                                                                                    ...
                                                                                                                                    <asp:TemplateField HeaderText="Status">
                                                                                                                                        <ItemTemplate>
                                                                                                                                           <%-- <asp:Label ID="l6" runat="server" Text='<%# Bind ("dstatus") %>'></asp:Label>--%>
                                                                                                                                            <asp:Label ID="l4" runat="server" Text='<%# Bind("dstatus") %>' class="label label-info" Visible='<%#Eval("dstatus").ToString()=="Not Approved"?true:false%>'></asp:Label>
                                                                                                                                            <asp:Label ID="Label2" runat="server" Text='<%# Bind("dstatus") %>' class="label label-success" Visible='<%#Eval("dstatus").ToString()=="Approved"?true:false%>'></asp:Label>
                                                                                                                                        </ItemTemplate>
                                                                                                                                    </asp:TemplateField>
                                                                                                                                     <asp:TemplateField>
