<%@ Page Language="C#" AutoEventWireup="true" CodeFile="view_bonus_master.aspx.cs" Inherits="payroll_admin_view_bonus_master" %>
                            ...
                            <td valign="top" class="blue-brdr-1">
                                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                    <tr>
                                        ...
                                        <td class="txt01">Bonus Master</td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td valign="top" style="height: 123px">
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    ...
                                    <tr>
                                        <td width="25%" class="frm-lft-clr123">Name</td>
                                    ...
                                    <tr>
                                        <td width="25%" class="frm-lft-clr123">Alias Name</td>
                                        <td width="75%" class="frm-rght-clr123">
                                    ...
                                    <tr>
                                        <td width="25%" class="frm-lft-clr123">Pay Head Type</td>
                                        <td width="75%" class="frm-rght-clr123">
                                    ...
                                    <tr>
                                        <td width="25%" class="frm-lft-clr123">Name in Pay Slip</td>
                                        <td width="75%" class="frm-rght-clr123">
