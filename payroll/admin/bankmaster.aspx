                                                    ...
                                                    <img src="../../images/employee-icon.jpg" width="16" height="16" />
                                                            ...
                                                            <tr>
                                                                <td height="20" valign="top">
                                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                        <tr>
                                                                            <td width="27%" class="txt01">Create Bank
                                                                            </td>
                                                            ...
                                                            <tr>
                                                                <td valign="top" style="height: 123px">
                                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                        <tr>
                                                                            <td width="25%" class="frm-lft-clr123">Bank Name <span class="star"></span>
                                                                            </td>
                                                                        ...
                                                                        <tr>
                                                                            <td width="25%" class="frm-lft-clr123">Bank Code <span class="star"></span>
                                                                            </td>
                                                                            <td width="75%" class="frm-rght-clr123">
                                                                        ...
                                                                        <tr>
                                                                            <td width="25%" class="frm-lft-clr123">Account Number <span class="star"></span>
                                                                            </td>
                                                                            <td width="75%" class="frm-rght-clr123">
                                                                                ...
                                                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="txt_accno"
                                                                                    ErrorMessage='<img src="../../images/error1.gif" alt="" />' ValidationGroup="v"
                                                                                    SetFocusOnError="True" ToolTip="Enter Display Name"><img src="../../images/error1.gif" alt="" /></asp:RequiredFieldValidator>
