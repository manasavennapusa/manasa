                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tr>
                            <td height="20" valign="top">
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                        <td width="27%" class="txt02">View Allowance Details
                                        </td>
                        ...
                        <tr>
                            <td valign="top" style="height: 123px">
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    ...
                                    <tr>
                                        <td width="25%" class="frm-lft-clr123">Tax Rebate
                                        </td>
                                        <td width="75%" class="frm-rght-clr123">Rs.
                                        <asp:Label ID="lbl_taxrebate" runat="server"></asp:Label>
                                        </td>
                                    </tr>

                                    <tr>
                                        <td width="25%" class="frm-lft-clr123 border-bottom">Grade Applicable
                                        </td>
