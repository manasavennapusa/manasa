                                                    ...
                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                            ...
                                                            <td valign="top" class="blue-brdr-1">
                                                                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                                                    <tr>
                                                                        ...
                                                                        <td class="txt01">Employee Master View</td>
                                                                    </tr>
                                                                </table>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td valign="middle" class="txt02" height="23">&nbsp;Search Employee</td>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            <td valign="top">
                                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                    <tr>
                                                                        <td class="frm-lft-clr123 border-bottom" width="11%">Name/Code</td>
                                                                        <td class="frm-rght-clr123 border-bottom" width="11%">
                                                                            <asp:TextBox ID="txt_employee" runat="server" CssClass="span10" ></asp:TextBox></td>
                                                                        <td class="frm-lft-clr123 border-bottom" width="11%">Designation</td>
                                                                        ...
                                                                        <td class="frm-lft-clr123 border-bottom" width="11%">Department</td>
                                                                        <td class="frm-rght-clr123 border-bottom" width="19%">
                                                                            ...
                                                                            <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>"
                                                                                ProviderName="System.Data.SqlClient" SelectCommand="SELECT distinct  [departmentid], branch_name + '-' + department_name department_name 
...
order by department_name"></asp:SqlDataSource>
                                                                        </td>
