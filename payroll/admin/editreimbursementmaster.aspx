                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                ...
                                <tr>
                                    <td height="20" valign="top">
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                            <tr>
                                                <td width="33%" class="txt02">Update Reimbursement Details
                                                </td>
                                        ...
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                            <tr>
                                                ...
                                                <td width="75%" class="frm-rght-clr123">
                                                    <asp:TextBox ID="txt_name" size="40" CssClass="span4" runat="server" ToolTip="Reimbursement Name" onkeypress="return isCharOrSpace()"></asp:TextBox>
...
<img src="../../images/error1.gif" alt="" /></asp:RegularExpressionValidator>
              ...
              <td width="25%" class="frm-lft-clr123">
                  Payhead type</td>
              <td width="75%" class="frm-rght-clr123">
                  <asp:DropDownList ID="dd_payheadtype" runat="server" CssClass="blue1" ValidationGroup="v" Width="100px">
                   <asp:ListItem Value="0" Selected="True">Earnings</asp:ListItem>
                      ...
                      <asp:ListItem Value="2">N/A</asp:ListItem>
                                            ...
                                            <tr>
                                                ...
                                                <td width="75%" class="frm-rght-clr123">
                                                    <asp:TextBox ID="txt_payslip" runat="server" CssClass="span4"  ToolTip="Name to display in payslip" onkeypress="return isCharOrSpace()"></asp:TextBox>
                                                    ...
                                                    <asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server" Display="Dynamic" ToolTip="enter  only alphabets"
