...
public partial class payroll_admin_edit_bonus_master : System.Web.UI.Page
{
    ...
    protected void submit()
    {
        ...
        DBTask.ExecuteNonQuery(ConfigurationManager.ConnectionStrings["intranetConnectionString"].ToString(), CommandType.StoredProcedure, "sp_payroll_update_bonus_master", sqlparam);
