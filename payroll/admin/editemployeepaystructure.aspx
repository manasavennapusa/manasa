                                        ...
                                        <fieldset>
                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                ...
                                                <img src="../../images/employee-icon.jpg" width="16" height="16" />
                                                                            ...
                                                                            <td class="txt01">Employee Edit Pay Structure Master
                                                                            </td>
                                                                            <td align="right">
                                                                ...
                                                                <td colspan="4">
                                                                    <div id="Updatedconfirmationdiv" runat="server" visible="false">
                                                                        <table id="table3" border="0" cellpadding="0" cellspacing="4" width="100%px">
                                                                            <tr>
                                                                                <td align="right" valign="middle" style="font-weight: bolder; color: #cc6633">Records Updated Sucessfully for employee
                                                    <asp:Label ID="lblconfempcode" runat="server" Font-Bold="True"></asp:Label>
                                                                                    &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                                                                                </td>
                                                                                <td align="center">
                                                                                    <asp:Button ID="btnviewok" runat="server" Text="ok" CssClass="button" OnClick="btnviewok_Click" />
                                                                                </td>
                                                                            </tr>
                                                                            <tr>
                                                            ...
                                                            <tr>
                                                                <td valign="top" style="height: 123px">
                                                                    <div id="Divallhide" runat="server">
                                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                            <tr>
                                                                                <td class="frm-lft-clr123" style="width: 11%">Employee Code
                                                                                </td>
                                                                            ...
                                                                            <tr>
                                                                                <td class="frm-lft-clr123">Applied From
                                                                                </td>
                                                                             ...
                                                                             <tr>
                                                                             <td class="frm-lft-clr123 border-bottom">PF/ESI
                                                                            </td>
                                                                            <td class="frm-rght-clr123">&nbsp;
                                                                           ...
                                                                           <%-- <tr>
                                                                                ...
                                                                                <td class="frm-rght-clr123 border-bottom">&nbsp;
                                                                                    <asp:CheckBox ID="chk_pf" runat="server" Text="PF" AutoPostBack="true" OnCheckedChanged="chk_pf_CheckedChanged" />
                                                                                    <asp:CheckBox ID="chk_esi" runat="server" Text="ESI" />
                                                                                </td>
                                                                            </tr>--%>
                                                                            <tr>
                                                                            ...
                                                                            <tr>
                                                                                <td colspan="4" height="25" valign="middle" class="txt02">Edit Pay Structure
                                                                                </td>
                                                                            </tr>
                                                                            <tr>
                                                                            ...
                                                                            <tr>
                                                                                <div class="widget-content">
                                                                                    <asp:GridView ID="employeePayStructure" runat="server" AutoGenerateColumns="false"
                                                                                        DataKeyNames="PayheadID" CellPadding="4" CellSpacing="0"
                                                                                        Width="100%" AllowPaging="true" EmptyDataText="Sorry No Records Found"
                                                                                        OnRowDeleting="employeePayStructure_RowDeleting" CssClass="table table-hover table-striped table-bordered table-highlight-head">
                                                                                        <Columns>
