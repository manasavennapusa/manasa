...
public partial class payroll_admin_edit_employee_arrear_salary : System.Web.UI.Page
{
    ...
    protected void submit()
    {
        ...
        else
        {
            ...
            else
            {
                ...
                DBTask.ExecuteScalar(ConfigurationManager.ConnectionStrings["intranetConnectionString"].ToString(), CommandType.StoredProcedure, "sp_payroll_editarrear", sqlparam);
    ...
    protected void insert_disperse_amount()
    {
        try
        {
            ...
            DBTask.ExecuteDataset(ConfigurationManager.ConnectionStrings["intranetConnectionString"].ConnectionString.ToString(), CommandType.Text, strsql1);
