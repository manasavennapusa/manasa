<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Perquisites_report.aspx.cs" Inherits="payroll_admin_Perquisites_report" %>
                                                    ...
                                                    <img src="../../images/employee-icon.jpg" width="16" height="16" />
                                                            ...
                                                            <tr>
                                                                <td height="20" valign="top" style="width: 100%">
                                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                        <tr>
                                                                            <td class="txt02" style="height: 13px">View Perquisite Details
                                                                            </td>
                                                                ...
                                                                <td valign="top" style="height: 123px; width: 100%;">
                                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                         ...
                                                                         <tr style="display:none">
                                                                            <td class="frm-lft-clr123" style="width: 11%">Branch
                                                                            </td>
                                                         ...
                                                         <%--   <asp:CompareValidator ID="CompareValidator1" runat="server"  ToolTip="Select Branch"
