...
public partial class payroll_admin_tax_payer_detail_view : System.Web.UI.Page
{
    ...
    {
        //sqlstr = "SELECT * FROM tbl_payroll_tax_payer_detail where branch=" + dd_branch.SelectedValue;
        ...
        {
            message.InnerHtml = "";
            message.InnerHtml = "No Tax Payer details corresponds to Cost Center";
            txtempname.Text = "";
            txtempadd1.Text = "";
            txtempadd2.Text = "";
            txtempadd3.Text = "";
    ...
    protected void btnsbmit_Click(object sender, EventArgs e)
    {
        ...
        sqlstr = @"UPDATE tbl_payroll_tax_payer_detail SET
                    ...
                    remailid=@remailid,
                    rstd=@rstd,
                    rtelephone=@rtelephone,epf_no=@epf_no,esi_no=@esi_no,esi_local_no=@esi_local_no WHERE branch=" + dd_branch.SelectedValue;
