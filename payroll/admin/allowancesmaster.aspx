                                                    ...
                                                    <img src="../../images/employee-icon.jpg" width="16" height="16" />
                                                            ...
                                                            <tr>
                                                                <td height="20" valign="top">
                                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                        <tr>
                                                                            <td width="27%" class="txt02">Create Allowance
                                                                            </td>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td width="75%" class="frm-rght-clr123">
                                                                                <asp:TextBox ID="txt_name" size="40" CssClass="span4" runat="server" ToolTip="Allowance Name" 
                                                                                    onkeypress="return isCharOrSpace()"
...
<img src="../../images/error1.gif" alt="" /></asp:RegularExpressionValidator>--%>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td width="75%" class="frm-rght-clr123">
                                                                                <asp:TextBox ID="txt_taxrebate" runat="server" CssClass="span4" ToolTip="Enter Tax Rebate"
                                                                                    onkeypress="return isNumber_dot()"></asp:TextBox>
                                                                                <asp:RequiredFieldValidator ID="rfvtaxrebate" runat="server" ControlToValidate="txt_taxrebate"
                                                                                    Display="Dynamic" ErrorMessage='<img src="../../images/error1.gif" alt="" />'
                                                                                    ToolTip="Enter name to display in payslip" ValidationGroup="v"><img src="../../images/error1.gif" alt="" /></asp:RequiredFieldValidator>

                                                                                <asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server" Display="Dynamic" ToolTip="only enter numbers"
                                                                                    ValidationExpression="^[0-9\.]+$" ControlToValidate="txt_taxrebate"
                                                                                    ErrorMessage='<img src="../../images/error1.gif" alt="" />' ValidationGroup="v">
<img src="../../images/error1.gif" alt="" /></asp:RegularExpressionValidator>
                                                ...
                                                <asp:Button ID="btn_reset" runat="server" CssClass="button" Text="Reset" OnClick="btn_reset_Click"
                                                    ToolTip="Click to reset the entered details" />
                                                                            </td>
                                                                        </tr>
                                                                        <%--       <tr>
