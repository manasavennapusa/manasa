                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                    <td class="frm-lft-clr123" width="14%">
                                        Financial Year  <span class="star"></span>
                                    </td>
                                ...
                                <tr>
                                    <td class="frm-lft-clr123 border-bottom " width="14%">
                                        Allowance  <span class="star"></span>
                                    </td>
                                    ...
                                    <td class="frm-lft-clr123 border-bottom" width="14%%"> <asp:Button ID="btn_view" runat="server" CssClass="button" OnClick="btn_view_Click"
