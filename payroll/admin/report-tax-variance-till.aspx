                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            ...
                            <td class="frm-rght-clr123" width="14%">
                                <asp:TextBox ID="txt_employee" runat="server" CssClass="blue1" Width="120"></asp:TextBox>
...
<img src="../../images/error1.gif" alt="" /></asp:RegularExpressionValidator>
                            ...
                            <td class="frm-rght-clr123 border-bottom" width="12%">&nbsp;<asp:DropDownList ID="dd_branch" runat="server" CssClass="blue1" DataSourceID="SqlDataSource2"
                                                                ...
                                                                <td class="frm-lft-clr123 border-bottom" width="15%">Cost Center Group</td>
                                                                     <td class="frm-rght-clr123 border-bottom" width="15%">
                                                                                <asp:DropDownList ID="ddl_cc_groupid" runat="server" CssClass="blue1" Height=""
                                                                                    AutoPostBack="true"  Width="120" OnSelectedIndexChanged="ddl_cc_groupid_SelectedIndexChanged">
                                                                                </asp:DropDownList>
                                                                     </td>
                                                                    ...
                                                                    <td class="frm-rght-clr123 border-bottom" width="15%">
                                                                        <asp:DropDownList ID="ddl_cc_code" runat="server" CssClass="blue1" Height=""
                                                                            AutoPostBack="true"   Width="120" OnSelectedIndexChanged="ddl_cc_code_SelectedIndexChanged">
                        ...
                        <tr>
                            ...
                            <td class="frm-lft-clr123 border-bottom" style="width: 0%"></td>
                            <td class="frm-rght-clr123  border-bottom" style="width: 0%">&nbsp;<asp:DropDownList ID="dd_month" runat="server" Width="129px" Visible="false"
                                ToolTip="Month" CssClass="blue1">
