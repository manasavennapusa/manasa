                                                ...
                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                    <tr>
                                                        ...
                                                        <img src="../../images/employee-icon.jpg" width="16" height="16" />
                                                                                ...
                                                                                <%-- <td class="txt01">Application for Loan/Advances
                                                    </td>--%>
                                                                            </tr>
                                                                        </table>
                                                                    </td>
                                                                ...
                                                                <tr>
                                                                    <td height="20" valign="top">
                                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                            <tr>
                                                                                <td width="29%" class="txt02">Loan/Advances Details
                                                                                </td>
                                                                ...
                                                                <tr>
                                                                    <td valign="top" style="height: 123px">
                                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                            <tr>
                                                                                <td width="30%" class="frm-lft-clr123">Employee Code <span class="star"></span>
                                                                                </td>
                                                                            ...
                                                                            <tr>
                                                                                <td width="30%" class="frm-lft-clr123">Loan/Advances Type <span class="star"></span>
                                                                                </td>
                                                                            ...
                                                                            <tr>
                                                                                <td colspan="2">
                                                                                    <div id="divloanac" runat="server">
                                                                                        <table width="100%" cellpadding="0" cellspacing="0">
                                                                                            <tr>
                                                                                                <td width="30%" class="frm-lft-clr123">Loan/Advances A/c No. <span class="star"></span>
                                                                                                </td>
                                                                                                <td width="70%" class="frm-rght-clr123">
                                                                            ...
                                                                            <tr>
                                                                                <td width="30%" class="frm-lft-clr123">Loan/Advances Reference No. <span class="star"></span>
                                                                                </td>
                                                                                <td width="70%" class="frm-rght-clr123">
                                                                            ...
                                                                            <tr>
                                                                                <td width="30%" class="frm-lft-clr123">Loan/Advances Amount <span class="star"></span>
                                                                                </td>
                                                                                <td width="70%" class="frm-rght-clr123">
                                                                            ...
                                                                            <tr>
                                                                                <td width="30%" class="frm-lft-clr123">Sanction Date <span class="star"></span>
                                                                                </td>
                                                                                <td width="70%" class="frm-rght-clr123">
                                                                                    <asp:TextBox ID="txt_sdate" runat="server" CssClass="span4"
                                                                                        onkeypress="return enterdate(event);" onkeydown="return enterdate(event);"></asp:TextBox>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td width="70%" class="frm-rght-clr123">
                                                                                    <asp:DropDownList ID="dd_month" runat="server" CssClass="span4" Width="110px">
                                                                                    </asp:DropDownList>
                                                                                    <asp:DropDownList ID="dd_year" runat="server" CssClass="span4" Width="110px">
                                                                                    </asp:DropDownList>
                                                                            ...
                                                                            <tr>
                                                                                <td width="30%" class="frm-lft-clr123">No. of Installments <span class="star"></span>
                                                                                </td>
                                                                                <td class="frm-rght-clr123">
                                                                                    <table width="100%" cellpadding="0" cellspacing="0">
                                                                                        <tr>
                                                                                            <td width="30%">
                                                                                                ...
                                                                                                <asp:RangeValidator ID="RangeValidator1" runat="server" ControlToValidate="txt_instal_no"
                                                                                            ...
                                                                                            <td width="40%">
                                                                                                <asp:Button ID="LinkButton1" runat="server" OnClick="LinkButton1_Click" CssClass="button"
                                                                                                    Text="Calculate" Width="82px"></asp:Button>
                                                                                            </td>
                                                                                        </tr>
                                                                                    </table>
                                                                                </td>
                                                    ...
                                                    <td align="left" colspan="2">Mandatory Fields (<img src="../../images/error1.gif" alt="" />)
                                                                ...
                                                                <tr>
                                                                    <td valign="top">&nbsp;<asp:HiddenField ID="sbi" runat="server" />
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                        </td>
