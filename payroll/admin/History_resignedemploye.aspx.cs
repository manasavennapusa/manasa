...
public partial class payroll_admin_History_resignedemploye : System.Web.UI.Page
{
    ...
    protected void btnsbmit_Click(object sender, EventArgs e)
    {
        ...
        {
            message.InnerHtml = "please select correct month or year";
        }
    ...
    protected string encodepayslip(string empcode, string month, string year)
    {
        ...
        else
        {
            ...
            string encoded;
            encoded = q.EncodePairs(pairs);
            return "<script language='javascript'>window.open('payslip-for-contract.aspx?q=" + encoded + "')</script>";
        }
    }
