                                                    ...
                                                    <img height="16" src="../../images/employee-icon.jpg" width="16" />
                                                            ...
                                                            <tr>
                                                                <td valign="top" height="20">
                                                                    <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                                                        <tr>
                                                                            <td class="txt02" width="27%">Entry Gratuity detail
                                                                            </td>
                                                                ...
                                                                <td style="height: 123px" valign="top">
                                                                    <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td class="frm-rght-clr123">&nbsp;<asp:DropDownList ID="dd_month" runat="server" CssClass="span4" DataTextField="month "
