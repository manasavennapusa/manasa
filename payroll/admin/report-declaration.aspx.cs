...
public partial class payroll_admin_report_declaration : System.Web.UI.Page
{
    ...
    protected void bindempdetail()
    {
        ...
        //sqlparam[5] = new SqlParameter("@costcentergroup", SqlDbType.VarChar, 100);
        //sqlparam[5].Value = ddl_cc_groupid.SelectedValue;

        //sqlparam[6] = new SqlParameter("@costcentercode", SqlDbType.Int);
        //sqlparam[6].Value = ddl_cc_code.SelectedValue;

        ds = DBTask.ExecuteDataset(ConfigurationManager.ConnectionStrings["intranetConnectionString"].ConnectionString.ToString(), CommandType.StoredProcedure, "sp_payroll_declaration_report", sqlparam);
