                                                    ...
                                                    <img src="../../images/employee-icon.jpg" width="16" height="16" />
                                                            ...
                                                            <tr>
                                                                <td height="20" valign="top">
                                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                        <tr>
                                                                            <td width="32%" class="txt02">Update Loan/Advances Details
                                                                            </td>
                                                                    ...
                                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                        <tr>
                                                                            ...
                                                                            <td width="75%" class="frm-rght-clr123">
                                                                                <asp:TextBox ID="txt_name" size="40" CssClass="span4" runat="server" ToolTip="Loan/Advances Name" onkeypress="return isCharOrSpace()"></asp:TextBox>
...
<img src="../../images/error1.gif" alt="" /></asp:RegularExpressionValidator>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td width="75%" class="frm-rght-clr123">
                                                                                <asp:TextBox ID="txt_interest" size="40" CssClass="span4" runat="server" ToolTip="Enter Interest applicable on Loan">0.0</asp:TextBox>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td width="75%" class="frm-rght-clr123">
                                                                                <asp:TextBox ID="txt_loan_acno" size="40" CssClass="span4" runat="server" ToolTip="Loan/Advances A/c No."></asp:TextBox>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td width="75%" class="frm-rght-clr123 border-bottom">
                                                                                ...
                                                                                <asp:Button ID="btncncl" runat="server" CssClass="button" Text="Cancel" OnClick="btncncl_Click"
                                                                                    ToolTip="Click to cancel the updation" ValidationGroup="none" />
                                                                            </td>
                                                                        </tr>
                                                                        <%--<tr>
