<%@ Page Language="C#" AutoEventWireup="true" CodeFile="uploadpaystructure.aspx.cs" Inherits="payroll_admin_uploadpaystructure" %>
                                            ...
                                            <tr>
                                                <td valign="top">
                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                            ...
                                                            <td colspan="2" valign="top" class="blue-brdr-1">
                                                                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                                                    <tr>
                                                                        ...
                                                                        <td class="txt01">Upload Employee Pay Structure</td>
                                                                        <td><a style="float:right;" href="doc/Payroll.xlsx">Download</a></td>
                                                                    </tr>
                                                                </table>
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            <td valign="left" class="frm-lft-clr123" style="width: 149px">Upload Employee Pay Structure&nbsp;<span class="star"></span></td>
