                        ...
                        <tr>
                            <td valign="top">
                                <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                    ...
                                    <tr>
                                        <td width="40%" height="22" valign="top" class="frm-rght-clr123"><b>   Cost Center</b>
                                          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                            &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                            <asp:DropDownList ID="dd_branch" runat="server" CssClass="span6" DataSourceID="SqlDataSource3"
                                                DataTextField="cost_center_name" DataValueField="cost_center" OnDataBound="dd_branch_DataBound"
                                                 AutoPostBack="True" OnSelectedIndexChanged="dd_branch_SelectedIndexChanged">
                                            </asp:DropDownList>
