                            ...
                            <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                    ...
                                    <td class="blue-brdr-1" valign="top">
                                        <table cellspacing="0" cellpadding="0" width="100%" align="center" border="0">
                                            <tr>
                                               ...
                                               <%-- <td class="txt01">Leave Encashment Exemption
                                                </td>--%>
                                            </tr>
                                        </table>
                                    </td>
                                ...
                                <tr>
                                    <td valign="top" height="20">
                                        <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                            <tr>
                                                <td class="txt02" width="27%">Entry Leave Encashment Detail
                                                </td>
                                ...
                                <tr>
                                    <td valign="top" height="20">
                                        <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                            <tr>
                                                <td class="txt02" width="27%">Employee Leave Encashment Detail
                                                </td>
                                                <td class="txt-red" align="right" width="73%">
