...
public partial class payroll_admin_reports_report_pfform5 : System.Web.UI.Page
{
    ...
    protected void btnsbmit_Click(object sender, EventArgs e)
    {
        ...
        strPop = "<script language='javascript'>window.open('pfform5.aspx?year=" + dd_year.SelectedItem.Text.ToString() + "&month=" + dd_month.SelectedItem.Text.ToString().Substring(0, 3) + "&monthvalue=" + dd_month.SelectedItem.Value + "')</script>";
