                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                            ...
                                            <td class="frm-rght-clr123" style="width: 27%">
                                                <asp:DropDownList ID="dd_branch" runat="server" CssClass="span4" DataSourceID="SqlDataSource3"
                                                    DataTextField="branch_name" DataValueField="branch_id" OnDataBound="dd_branch_DataBound"
                                                    Width="">
                                                </asp:DropDownList>
                                                <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:intranetConnectionString %>"
