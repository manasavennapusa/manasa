...
public partial class payroll_admin_reports_CostEmployee : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        DataSet ds1 = DBTask.ExecuteDataset(ConfigurationManager.ConnectionStrings["intranetConnectionString"].ConnectionString.ToString(), CommandType.StoredProcedure, "sp_payroll_generate_employee_salary_sheet_monthly_summary", sqlparm);
        ds1.Tables[0].TableName = "table";


        DataSet ds2 = DBTask.ExecuteDataset(ConfigurationManager.ConnectionStrings["intranetConnectionString"].ConnectionString.ToString(), CommandType.StoredProcedure, "sp_payroll_generate_employee_salary_sheet_summary", sqlparm);
