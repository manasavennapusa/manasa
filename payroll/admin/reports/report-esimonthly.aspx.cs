...
public partial class payroll_admin_view_payslip : System.Web.UI.Page
{
    ...
    {
        strPop = "<script language='javascript'>window.open('FormESImonthly.aspx?month=" + dd_month.SelectedItem.Text.ToString() + "&year=" + dd_year.SelectedItem.Text.ToString() + "')</script>";
