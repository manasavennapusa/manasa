<%@ Page Language="C#" AutoEventWireup="true" CodeFile="History_resignedemploye.aspx.cs" Inherits="payroll_admin_History_resignedemploye" %>
                                                    ...
                                                    <img src="../../images/employee-icon.jpg" width="16" height="16" />
                                                            ...
                                                            <tr>
                                                                <td height="20" valign="top" style="width: 100%">
                                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                        <tr>
                                                                            <td class="txt02" style="height: 13px">View Resigned Employee Pay Slip
                                                                            </td>
                                                                ...
                                                                <td valign="top" style="height: 123px; width: 100%;">
                                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td class="frm-rght-clr123" style="width: 27%">
                                                                                <asp:TextBox ID="txt_employee" size="40" CssClass="span4" runat="server" ToolTip="Employee Code" onkeypress="return enterdate(event);" Enabled="false" onkeydown="return enterdate(event);" AutoPostBack="true"></asp:TextBox>
