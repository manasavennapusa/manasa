...
public partial class Reimbursement_ClosedReiumbursementHR : System.Web.UI.Page
{
    ...
    {
        if (Session["empcode"].ToString() != null)
        {
    ...
    private void BindPendingDetailsAll()
    {
        ...
        try
        {
            ...
            Output.AssignParameter(parm, 4, "@level", "Int", 0, "1");

            Connection = DA.OpenConnection();
            ds = SQLServer.ExecuteDataset(Connection, CommandType.StoredProcedure, "sp_Rb_get_Closedreimbursementdetails", parm);
