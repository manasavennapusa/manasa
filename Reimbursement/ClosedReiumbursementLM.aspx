<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ClosedReiumbursementLM.aspx.cs" Inherits="Reimbursement_ClosedReiumbursementLM" %>
                ...
                <ContentTemplate>
                    <div class="main-container">
                        ...
                        <div class="page-header">
                            <div class="pull-left">
                                <h2>Closed Reimbursement Details</h2>
                            </div>
                                ...
                                <div class="widget">
                                    <div class="widget-header">
                                        <div class="title">
                                            ...
                                            <asp:Label ID="Label1" runat="server" Text="Closed Reimbursement Details"></asp:Label>
                                        </div>
                                    </div>
