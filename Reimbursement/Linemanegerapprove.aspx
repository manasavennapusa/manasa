<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Linemanegerapprove.aspx.cs" Inherits="Reimbursement_Linemanegerapprove" %>
                            ...
                            <div class="widget-body">
                                <fieldset>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            ...
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="drp_leavestatus"
                                                                                    Display="Dynamic" SetFocusOnError="True" ToolTip="Select Title" ValidationGroup="K" InitialValue="0"
                                    ...
                                    <div class="form-actions no-margin">
                                        <asp:Button ID="btn_search" runat="server" CssClass="btn btn-info" OnClick="btn_search_Click" Text="Search" ValidationGroup="K"  />
