<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BusinessHeadReimbursment.aspx.cs" Inherits="Reimbursement_BusinessHeadReimbursment" %>
                                            ...
                                            <asp:GridView ID="grdreim" runat="server" AutoGenerateColumns="False" CssClass="table table-striped table-bordered table-hover table-checkable table-responsive datatable"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="View" HeaderStyle-Width="10%" Visible="false">
                                                      ...
                                                      <asp:HyperLinkField DataNavigateUrlFields="RID" HeaderText="View" DataNavigateUrlFormatString="BHviewReimbusstatus.aspx?RID={0}"
                                                NavigateUrl="BHviewReimbusstatus.aspx" Text="&lt;img src='images/view.png'/&gt;">
