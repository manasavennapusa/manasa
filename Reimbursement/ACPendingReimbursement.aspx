<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ACPendingReimbursement.aspx.cs" Inherits="Reimbursement_ACPendingReimbursement" %>
                                            ...
                                            <asp:GridView ID="grdreim" runat="server" AutoGenerateColumns="False" CssClass="table table-striped table-bordered table-hover table-checkable table-responsive datatable"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="View" HeaderStyle-Width="10%" Visible="false">
                                                       ...
                                                       <asp:HyperLinkField DataNavigateUrlFields="RID" HeaderText="View" DataNavigateUrlFormatString="ACViewReimDetails.aspx?RID={0}"
                                                NavigateUrl="ACViewReimDetails.aspx" Text="&lt;img src='images/view.png'/&gt;">
