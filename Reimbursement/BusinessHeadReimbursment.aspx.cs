...
public partial class Reimbursement_BusinessHeadReimbursment : System.Web.UI.Page
{
    ...
    private void BindDetailsAll()
    {
        ...
        try
        {
            ...
            ds = SQLServer.ExecuteDataset(Connection, CommandType.StoredProcedure, "[sp_Rb_get_reimbursementdetails_Business_Head]", parm);
    ...
    protected void btnview_Command(object sender, CommandEventArgs e)
    {
        ...
        ScriptManager.RegisterStartupScript(this, typeof(string), "OPEN_WINDOW", "var Mleft = (screen.width/2)-(760/2);var Mtop = (screen.height/2)-(700/2);window.open( 'ViewReimDetails.aspx?rid=" + rid + "', null, 'height=600,width=1000,status=yes,toolbar=no,scrollbars=yes,menubar=no,location=no,top=\'+Mtop+\', left=\'+Mleft+\'' );", true);
