<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LMPendingReimbursement.aspx.cs" Inherits="Reimbursement_LMPendingReimbursement" %>
                                            ...
                                            <asp:GridView ID="grdreim" runat="server" AutoGenerateColumns="False" CssClass="table table-striped table-bordered table-hover table-checkable table-responsive datatable"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="View" HeaderStyle-Width="10%" Visible="false">
                                                      ...
                                                      <asp:HyperLinkField DataNavigateUrlFields="RID" HeaderText="View" DataNavigateUrlFormatString="ViewReimDetails.aspx?RID={0}"
                                                NavigateUrl="ViewReimDetails.aspx" Text="&lt;img src='images/view.png'/&gt;">
