...
public partial class Reimbursement_HRPendingReimbuesement : System.Web.UI.Page
{
    ...
    protected void btnview_Command(object sender, CommandEventArgs e)
    {
        ...
        ScriptManager.RegisterStartupScript(this, typeof(string), "OPEN_WINDOW", "var Mleft = (screen.width/2)-(760/2);var Mtop = (screen.height/2)-(700/2);window.open( 'HRViewReimDetails.aspx?rid=" + rid + "', null, 'height=600,width=660,status=yes,toolbar=no,scrollbars=yes,menubar=no,location=no,top=\'+Mtop+\', left=\'+Mleft+\'' );", true);
