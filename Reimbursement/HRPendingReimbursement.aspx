<%@ Page Language="C#" AutoEventWireup="true" CodeFile="HRPendingReimbursement.aspx.cs" Inherits="Reimbursement_HRPendingReimbursement" %>
                                    ...
                                    <div class="widget-body">
                                        <fieldset>
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    <asp:TextBox ID="txtfromdate" runat="server" CssClass="span4" onkeypress="return isKey(event);" ondrop="return false;" onpaste="return false;" MaxLength="50" Width=""></asp:TextBox>
                                            ...
                                            <asp:GridView ID="grdreim" runat="server" AutoGenerateColumns="False" CssClass="table table-striped table-bordered table-hover table-checkable table-responsive datatable"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="View" HeaderStyle-Width="10%" Visible="false">
                                                        ...
                                                        <asp:HyperLinkField DataNavigateUrlFields="RID" HeaderText="View" DataNavigateUrlFormatString="HRViewReimDetails.aspx?RID={0}"
                                                NavigateUrl="HRViewReimDetails.aspx" Text="&lt;img src='images/view.png'/&gt;">
