<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AdminReismbursment.aspx.cs" Inherits="Reimbursement_AdminReismbursment" %>
                                    ...
                                    <div class="widget-body">
                                        <fieldset>
                                            ...
                                            <div class="form-actions no-margin">
                                                <asp:Button ID="btnsubmit" runat="server" CssClass="btn btn-primary" Text="Search" ValidationGroup="c" OnClick="btnsubmit_Click" />
                                            </div>
                                        </fieldset>
                                    </div>
                                </div>
                                        ...
                                        <div id="dt_example" class="example_alt_pagination">
                                            ...
                                            <asp:GridView ID="grdreim" runat="server" AutoGenerateColumns="False" CssClass="table table-striped table-bordered table-hover table-checkable table-responsive datatable"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Submit Date" HeaderStyle-Width="20%">
                                                        <ItemTemplate>
                                                    ...
                                                    <asp:TemplateField HeaderText="View" HeaderStyle-Width="10%" Visible="false">
                                                        <ItemTemplate>
                                                            <asp:Button ID="btnview" runat="server" CssClass="btn btn-primary pull-right" Text="&lt;img src='images/view.png'/&gt;" OnCommand="btnview_Command" CommandArgument='<%#Eval("RID")%>' />
                                                        </ItemTemplate>
                                                    </asp:TemplateField>

                                                      <asp:HyperLinkField DataNavigateUrlFields="RID" HeaderText="View" DataNavigateUrlFormatString="AdminviewReimburmentdetails.aspx?RID={0}"
                                                NavigateUrl="AdminviewReimburmentdetails.aspx" Text="&lt;img src='images/view.png'/&gt;">
