<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EmpReimRejectPending.aspx.cs" Inherits="Reimbursement_EmpReimRejectPending" %>
                ...
                <ContentTemplate>
                    <div class="main-container">
                        ...
                        <div class="page-header">
                            <div class="pull-left">
                                <h2>Employee Reimbursement Details</h2>
                            </div>
                                ...
                                <div class="widget">
                                    <div class="widget-header">
                                        <div class="title">
                                            ...
                                            <asp:Label ID="Label3" runat="server" Text="View Rejected Reimbursement Details"></asp:Label>
                                        </div>
                                    </div>
                                ...
                                <div class="widget">
                                    <div class="widget-header">
                                        <div class="title">
                                            ...
                                            <asp:Label ID="Label1" runat="server" Text="Pending Reimbursement Status"></asp:Label>
                                        </div>
                                    </div>
