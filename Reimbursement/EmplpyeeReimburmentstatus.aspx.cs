...
public partial class Reimbursement_EmplpyeeReimburmentstatus : System.Web.UI.Page
{
    ...
    protected void bind_grid()
    {
        var activity = new DataActivity();
            ...
            try
           {
               ...
               if (Convert.ToInt32(drp_leavestatus.SelectedValue) == 0)
               {
               ...
               else if (Convert.ToInt32(drp_leavestatus.SelectedValue) == 1)
               {
               ...
               else if (Convert.ToInt32(drp_leavestatus.SelectedValue) == 4)
               {
                   ...
                   Output.AssignParameter(parm, 0, "@empcode", "String", 50, _userCode);
                   Output.AssignParameter(parm, 1, "@flag", "Int", 0, "1");
                   Output.AssignParameter(parm, 2, "@level", "Int", 0, "5");
                   Output.AssignParameter(parm, 3, "@reject", "Int", 0, "0");
                   Connection = DA.OpenConnection();
