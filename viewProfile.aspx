                                        ...
                                        <p>
                                            ...
                                            <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                                ...
                                                <tr runat="server" visible="false">
                                                    <td>
                                                        <asp:ImageButton ID="MyImg" runat="server" Style="width: 168px; border: 1px solid #ddd; padding: 2px;" OnClick="MyImg_Click" />
                                                    </td>
                                                </tr>
                                                <tr style="height: 50px" runat="server" visible="false" id="trimg">
                                                    <td class="frm-lft-clr123 border-bottom" width="50%">Employee Photo
                                                    </td>
                                                    <td class="frm-rght-clr123 border-bottom" width="50%">
                                                        <asp:FileUpload ID="fileupload1" runat="server" />
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server"
                                                            ControlToValidate="fileupload1" ErrorMessage="File Required!" Display="Dynamic" ValidationGroup="v"> 
                                                        ...
                                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator7" Display="Dynamic"
                                                            ...
                                                            ErrorMessage="Only pg|.JPG|.jpeg|.JPEG|.bmp|.BMP|.gif|.GIF|.png|.PNG image formats are allowed." ForeColor="Red"
                                                        ...
                                                        <%--  <File_Uploader:File_Uploader ID="f_upload_rep1" runat="server" FileTypeRange="bmp,jpg"
                                                                                        Vgroup="v" />--%>
                                                        <asp:Button ID="btnimg" runat="server" OnClick="btnimg_Click" ValidationGroup="v" Text="Upload" CssClass="button" />
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td colspan="2">
                                                                ...
                                                                <td width="50%" valign="top">
                                                                    <table width="99%" border="0" align="right" cellpadding="0" cellspacing="0">
                                                                        ...
                                                                        <tr style="height: 50px">
                                                                            <td width="48%" class="frm-lft-clr123 border-bottom">Employee Photo.<span class=""></span>
                                                                            </td>
                                                                            <td width="52%" class="frm-rght-clr123 border-bottom">
                                                                                <asp:Image ID="empimg" runat="server" ImageUrl="Upload/photo/image.jpg" style="width:45%"></asp:Image>
                                                ...
                                                <asp:RegularExpressionValidator ID="regphoto" runat="server" ControlToValidate="empphoto"
                                                    CssClass="txt-red" Display="Dynamic" ErrorMessage="file not supported..." ValidationExpression="^.+(.png|.PNG|.bmp|.BMP|.jpg|.JPG|.gif|.GIF)$"></asp:RegularExpressionValidator><br />--%>
                                                                            </td>
                                                                        </tr>
                                                                    ...
                                                                    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                                                        <ContentTemplate>
                                                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                ...
                                                                                <tr style="height: 50px">
                                                                                    <td class="frm-lft-clr123" width="48%">Account Manager
                                                                                    </td>
                                                                                    <td class="frm-rght-clr123" width="52%">
                                    ...
                                    <div>
                                        <p>
                                            ...
                                            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                                ...
                                                <tr>
                                                    <td class="frm-lft-clr-main">Professional Qualification :
                                                    </td>
                                                </tr>
                                                <tr>
                                                        ...
                                                        <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                                            <tr>
                                                                <td valign="top" width="50%">
                                                                    <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                                                        <tr>
                                                                            <td class="frm-lft-clr123 border-bottom" width="45%">Father's Name
                                                                            </td>
                                                                            <td class="frm-rght-clr123 border-bottom" width="55%">
