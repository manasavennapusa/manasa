<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EmployementLetterDetails.aspx.cs" Inherits="Forms_EmployementLetterDetails" %>
            ...
            <div class="main-container" id="div_letter" runat="server">
                <div>
                    ...
                    <table style="width: 95%; text-align: justify; font: bold; font-size: 15px; font-weight: 500; margin: 10px 5px 10px 15px">
                        <tr>
                            <td style="font: bold; font-size: 14px; font-weight: 800;text-decoration:underline">Employement Letter
                            </td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <%--<tr>
                            <td>
                                <asp:Label ID="txt_employement_letter" runat="server" Style="border: none;padding: 0px 0px 4px 3px" placeholder="Enter offer letter"></asp:Label>
                            </td>
                        </tr>--%>
                        <tr>
                          <td><b>HR&nbsp;/&nbsp;<asp:Label ID="txt_hr_1" runat="server" Style="border: none;padding: 0px 0px 4px 3px"></asp:Label>&nbsp;/&nbsp;<asp:Label ID="txt_hr_2" runat="server" Style="border: none;padding: 0px 0px 4px 3px"></asp:Label></b>&nbsp;/&nbsp; <b><asp:Label ID="txt_employement_letter" runat="server" Style="border: none;padding: 0px 0px 4px 3px" placeholder="Enter offer letter"></asp:Label> </b>
                            </td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <tr>
                            <td style="font: bold; font-size: 13px; font-weight: 600">Date&nbsp;<asp:Label ID="txt_date" runat="server" Style="border: none;padding: 0px 0px 4px 3px; font-size: 15px; font-weight: 500" placeholder="Enter date"></asp:Label>
                            </td>
                        </tr>
                         <tr>
                            <td>
                        ...
                        <tr>
                            <td>
                              <b>Name:</b>&nbsp;<asp:Label ID="txt_emp_name" runat="server" Style="border: none;padding: 0px 0px 3px 3px"></asp:Label>                            
                            </td>
                        </tr>
                        <tr>
                            <td>
                              <b>Department:</b>&nbsp;<asp:Label ID="txt_department" runat="server" Style="border: none;padding: 0px 0px 3px 3px"></asp:Label>                            
                            </td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <tr>
                            <td>
                                This is to certify that Mr. /Ms&nbsp;<asp:Label ID="txt_emp_name_1" runat="server" Style="border: none;padding: 0px 0px 3px 3px"></asp:Label>&nbsp;with, EMP ID&nbsp;<asp:Label ID="txt_emp_id" runat="server" Style="border: none; padding: 0px 0px 3px 3px"></asp:Label>, and 
                                current address&nbsp;<asp:Label ID="txt_address" runat="server" Style="border: none;padding: 0px 0px 3px 3px"></asp:Label>, has been employed in our organization from&nbsp;<asp:Label ID="txt_from_date" runat="server" Style="border: none;padding: 0px 0px 3px 3px"></asp:Label>&nbsp; 
                                till date&nbsp;<asp:Label ID="txt_to_date" runat="server" Style="border: none;padding: 0px 0px 3px 3px"></asp:Label>, as &nbsp;<asp:Label ID="txt_designation" runat="server" Style="border: none;padding: 0px 0px 3px 3px"></asp:Label>. 
                            </td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <tr>
                         ...
                         <tr>
                          ...
                          <tr>
                            <td style="text-align: justify; font: bold; font-size: 14px; font-weight: 700;">
                               HR Manager 
                            </td>
                        </tr>
                         <tr>
