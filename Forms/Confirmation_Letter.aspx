<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Confirmation_Letter.aspx.cs" Inherits="Forms_Confirmation_Letter" %>
...
<body>
    ...
    <div runat="server" style="margin-left:13px">
    ...
    <p> <b> Confirmation Letter </b> 
            ____________________</p> <br />
        <p> HR/_____/____	</p><br />
        <p>  Date ___________</p><br />
        <p> Name:  _______________</p>
        <b> Department: _______________</b>
        <br />
        <br />
        <p> Dear ______________</p>

        <p>  Greetings!!  </p>
        <p>Consequent to the review of your performance during your probation, we have the pleasure in informing you that, your services are being confirmed as ________________with effect from ____________.</p>
