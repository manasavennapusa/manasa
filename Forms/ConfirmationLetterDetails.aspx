<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ConfirmationLetterDetails.aspx.cs" Inherits="recruitment_ConfirmationLetterDetails" %>
    ...
    <form id="myForm" runat="server" class="form-horizontal no-margin">
                    ...
                    <div class="span12">
                        <div class="widget">
                            <div class="widget-header">
                                <div class="title">
                                    <span class="fs1" aria-hidden="true" data-icon="&#xe023;">Confirmation Letter Details</span>
                                </div>
                            </div>
                                    ...
                                    <div>
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                            <tr>
                                                ...
                                                <td class="frm-rght-clr123 border-bottom" width="26%">
                                                    ...
                                                    <a href="JavaScript:newPopup1('PickCandidate_For_Confirmation.aspx?role=12&empcode=<%=tbemployee_id.Text.ToString() %>');" title="Pick Employee"><i class="icon-user"></i></a>
                                                   <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="tbemployee_id"
                                                    ...
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator14" runat="server" ControlToValidate="tbemployee_id"
                                                        Display="Dynamic" ErrorMessage='<img src="../images/error1.gif" alt="" />' ToolTip="Select Employee ID"
                                                            ...
                                                            <td width="50%" valign="top">
                                                                <asp:UpdatePanel ID="kk" runat="server">
                                                                    <ContentTemplate>
                                                                        ...
                                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                              <tr>
                                                                                <td class="frm-lft-clr123 border-bottom" width="48%">Confirmation Letter Number<span class="star"></span></td>
                                                                                <td class="frm-rght-clr123 border-bottom" width="52%">
                                                                                    <asp:TextBox ID="txt_confrm_ltr_numbr" runat="server" CssClass="span10" Width="" Height="35px" MaxLength="1000" placeholder="Enter Number.." Style="border: 1px solid #ddd; font-size: 14px"></asp:TextBox>
                                                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txt_confrm_ltr_numbr"
                                                                                        Display="Dynamic" ErrorMessage='<img src="../images/error1.gif" alt="" />' ToolTip="Enter Confirmation Letter Number"
                                                                                        ValidationGroup="v" Width="6px" SetFocusOnError="True"><img src="../images/error1.gif" alt="" /></asp:RequiredFieldValidator>
                                                                                </td>
                                                                            </tr>
                                                                            <tr>
                                                                                ...
                                                                                <td class="frm-rght-clr123 border-bottom" width="52%">
                                                                                    ...
                                                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txt_hr_1"
                                                                                        Display="Dynamic" ErrorMessage='<img src="../images/error1.gif" alt="" />' ToolTip="Enter Enter HR First Box Number"
                                                                                        ValidationGroup="v" Width="6px" SetFocusOnError="True"><img src="../images/error1.gif" alt="" /></asp:RequiredFieldValidator>
                                                                                    ...
                                                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="txt_hr_2"
                                                                                        Display="Dynamic" ErrorMessage='<img src="../images/error1.gif" alt="" />' ToolTip="Enter Enter HR Second Box Number"
                                                                                        ValidationGroup="v" Width="6px" SetFocusOnError="True"><img src="../images/error1.gif" alt="" /></asp:RequiredFieldValidator>
                                                                                </td>
                                                                            </tr>
                                                                            <tr>
                                                                                ...
                                                                                <td class="frm-rght-clr123 border-bottom" width="26%">
                                                                                    <asp:TextBox ID="TextBox1_name" runat="server" CssClass="span10" Width="" Height="31px" MaxLength="1000" placeholder="Max 100 Chars.." Style="border: 1px solid #ddd; font-size: 14px"></asp:TextBox>
                                                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator15" runat="server" ControlToValidate="TextBox1_name"
                                                                            ...
                                                                            <tr id="Tr6" style="" runat="server" visible="true">
                                                                                ...
                                                                                <td class="frm-rght-clr123 border-bottom" width="52%">
                                                                                    ...
                                                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ControlToValidate="tbeffectivedate"
                                                                                        Display="Dynamic" ErrorMessage='<img src="../images/error1.gif" alt="" />' ToolTip="Enter Effective Date"
                                                                                        ValidationGroup="v" Width="6px" SetFocusOnError="True"><img src="../images/error1.gif" alt="" /></asp:RequiredFieldValidator>
                                                                                </td>
                                                                            </tr>
                                                                            <%--<tr id="Tr1" style="" runat="server" visible="true">
                                                                                ...
                                                                                <td class="frm-rght-clr123" width="52%" style="border-bottom: 1px solid #d5d5d5">
                                                                                    ...
                                                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ControlToValidate="tbissueddate"
                                                                                        Display="Dynamic" ErrorMessage='<img src="../images/error1.gif" alt="" />' ToolTip="Enter Issued Date"
                                                                                        ValidationGroup="v" Width="6px" SetFocusOnError="True"><img src="../images/error1.gif" alt="" /></asp:RequiredFieldValidator>
                                                                                </td>
                                                                            </tr>--%>
                                                                        </table>
                                                                ...
                                                                <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                                                    <ContentTemplate>
                                                                        ...
                                                                        <table width="99%" border="0" align="right" cellpadding="0" cellspacing="0">
                                                                            ...
                                                                            <tr id="Tr5" style="height: 50px" runat="server" visible="true">
                                                                                ...
                                                                                <td class="frm-rght-clr123 border-bottom" width="52%">
                                                                                    ...
                                                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" ControlToValidate="drpdesignation" InitialValue="0"
                                                                            ...
                                                                            <%--<tr id="Tr4" style="height: 50px" runat="server" visible="true">
                                                                                ...
                                                                                <td class="frm-rght-clr123 border-bottom" width="52%">
                                                                                    <asp:TextBox ID="tblemployeeid" runat="server" CssClass="span10" AutoPostBack="true" placeholder="Enter Employee ID"></asp:TextBox>
                                                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator11" runat="server" ControlToValidate="tblemployeeid"
                                                                                        Display="Dynamic" ErrorMessage='<img src="../images/error1.gif" alt="" />' ToolTip="Enter Employee ID"
                                                                                        ValidationGroup="v" Width="6px" SetFocusOnError="True"><img src="../images/error1.gif" alt="" /></asp:RequiredFieldValidator>
                                                                                </td>
                                                                            </tr>--%>
                                                                            <tr id="Tr2" style="" runat="server" visible="true">
                                                                                ...
                                                                                <td class="frm-rght-clr123 border-bottom" width="52%">
                                                                                    ...
                                                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server" ControlToValidate="tbIssuedby"
                                                                                        Display="Dynamic" ErrorMessage='<img src="../images/error1.gif" alt="" />' ToolTip="Select Issued By"
                                                                                        ValidationGroup="v" Width="6px" SetFocusOnError="True"><img src="../images/error1.gif" alt="" /></asp:RequiredFieldValidator>
                                                                                </td>
                                                                            </tr>
                                                                            <tr id="Tr3" style="" runat="server" visible="true">
                                        ...
                                        <div class="form-actions no-margin">
                                            <div>
                                                ...
                                                <asp:Button ID="btnsubmit" runat="server" CssClass="btn btn-primary pull-right" Text="Submit" Style="margin-left: 10px" Visible="false" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
        ...
        <script type="text/javascript">
            function ValidateData() {
                var EmployeeName = document.getElementById('<%=tbemployee_id.ClientID %>');
                var confirmletternumber = document.getElementById('<%=txt_confrm_ltr_numbr.ClientID %>')
                ...
                var empid = document.getElementById('<%=TextBox1_name.ClientID %>');
                ...
                {
                    EmployeeName.focus();
                    alert("Please Select Employee Name from Confirmation Letter Details Tab");
                    return false;
                }
                if ((IsEmpty(confirmletternumber))) {
                    confirmletternumber.focus();
                    alert("Please Enter Confirmation Letter Number from Confirmation Letter Details Tab");
                    return false;
                }
                if ((IsEmpty(hr1)))
                {
                    hr1.focus();
                    alert("Please Enter HR First Box Number from Confirmation Letter Details Tab");
                    return false;
                }
                if ((IsEmpty(hr2))) {
                    hr2.focus();
                    alert("Please Enter HR Second Box Number from Confirmation Letter Details Tab");
                    return false;
                }
                if ((IsEmpty(effectivedate))) {
                    effectivedate.focus();
                    alert("Please Select Effective Date from Confirmation Letter Details Tab");
                    return false;
                }
                if ((IsEmpty(issueddate))) {
                    issueddate.focus();
                    alert("Please Select Issued Date from Confirmation Letter Details Tab");
                    return false;
                }
                if (department.value==0)
                {
                    department.focus();
                    alert("Please Select Department from Confirmation Letter Details Tab");
                    return false;
                }
                if (designation.value==0)
                {
                    designation.focus();
                    alert("Please Select Designation from Confirmation Letter Details Tab");
                    return false;
                }
                if ((IsEmpty(empid))) {
                    empid.focus();
                    alert("Please Enter Employee ID from Confirmation Letter Details Tab");
                    return false;
                }
                if ((IsEmpty(issuedby))) {
                    issuedby.focus();
                    alert("Please Select Issued By from Confirmation Letter Details Tab");
                    return false;
                }
                if ((IsEmpty(email))) {
                    email.focus();
            ...
            function ValidateCandidateName() {
                var candidatename = document.getElementById('<%=tbemployee_id.ClientID %>');
