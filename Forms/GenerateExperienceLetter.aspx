<%@ Page Language="C#" AutoEventWireup="true" CodeFile="GenerateExperienceLetter.aspx.cs" Inherits="Forms_GenerateExperienceLetter" %>
    ...
    <form id="myForm" runat="server" class="form-horizontal no-margin">
                    ...
                    <div class="span12">
                        <div class="widget">
                            <div class="widget-header">
                                <div class="title">
                                    <span class="fs1" aria-hidden="true" data-icon="&#xe023;">Experience Letter Details</span>
                                </div>
                            </div>
                                        ...
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                            <tr>
                                                ...
                                                <td class="frm-rght-clr123 border-bottom" width="26%">
                                                    ...
                                                    <%--<a href="JavaScript:newPopup1('PickEmployee.aspx?role=12&empcode=<%=tbemployeename.Text.ToString() %>');" title="Pick Employee"><i class="icon-user"></i></a>--%>
                                                    <a href="JavaScript:newPopup1('Pick_emp_for_relieving_letter.aspx?role=16&empcode=<%=tbemployee_id.Text.ToString() %>');" title="Pick Employee"><i class="icon-user"></i></a>
                                                            ...
                                                            <td width="50%" valign="top">
                                                                <asp:UpdatePanel ID="kk" runat="server">
                                                                    <ContentTemplate>
                                                                        ...
                                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                            <tr>
                                                                                <td class="frm-lft-clr123 border-bottom" width="48%">Experience Letter Number<span class="star"></span></td>
                                                                                <td class="frm-rght-clr123 border-bottom" width="52%">
                                                                                    <asp:TextBox ID="txt_experience_letter_number" runat="server" CssClass="span10" Width="" Height="35px" MaxLength="1000" placeholder="Enter Number.." Style="border: 1px solid #ddd; font-size: 14px"></asp:TextBox>
                                                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txt_experience_letter_number"
                                                                                        Display="Dynamic" ErrorMessage='<img src="../images/error1.gif" alt="" />' ToolTip="Enter Experience Letter Number"
                                                                                        ValidationGroup="v" Width="6px" SetFocusOnError="True"><img src="../images/error1.gif" alt="" /></asp:RequiredFieldValidator>
                                                                                </td>
                                                                            </tr>
                                                                            <tr>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td class="frm-rght-clr123" width="52%" style="border-bottom: 1px solid #d5d5d5">
                                                                                    <asp:TextBox ID="txtissueddate" runat="server" CssClass="span10" AutoPostBack="true" placeholder="dd-mmm-yyyy" onkeypress="return enterdate(event);" onkeydown="return enterdate(event);"></asp:TextBox>
                                                                            ...
                                                                            <%--<tr>
                                                                                ...
                                                                                <td class="frm-rght-clr123" width="52%" style="border-bottom: 1px solid #d5d5d5">
                                                                                    ...
                                                                                    <cc1:CalendarExtender Format="dd-MMM-yyyy" ID="CalendarExtender3" runat="server" PopupButtonID="Image2" TargetControlID="txt_doj" Enabled="True"></cc1:CalendarExtender>
                                                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ControlToValidate="txt_doj"
                                                                        ...
                                                                        <table width="99%" border="0" align="right" cellpadding="0" cellspacing="0">
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td class="frm-rght-clr123" width="52%" style="border-bottom: 1px solid #d5d5d5">
                                                                                    ...
                                                                                    <cc1:CalendarExtender Format="dd-MMM-yyyy" ID="CalendarExtender2" runat="server" PopupButtonID="Image1" TargetControlID="txt_to_date" Enabled="True"></cc1:CalendarExtender>
                                                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ControlToValidate="txt_to_date"
        ...
        <script type="text/javascript">
            function ValidateData() {
                ...
                var experienceletternumber = document.getElementById('<%=txt_experience_letter_number.ClientID %>')
                ...
                var date_of_join = document.getElementById('<%=txt_doj.ClientID %>');
                ...
                if ((IsEmpty(CandidateName))) {
                    CandidateName.focus();
                    alert("Please Select Employee Name from Experience Letter Details Tab");
                    return false;
                }
                if ((IsEmpty(experienceletternumber))) {
                    experienceletternumber.focus();
                    alert("Please Enter Experience Letter Number from Experience Letter Details Tab");
                    return false;
                }
                if ((IsEmpty(hr1))) {
                    hr1.focus();
                    alert("Please Enter HR First Box Number from Experience Letter Details Tab");
                    return false;
                }
                if ((IsEmpty(hr2))) {
                    hr2.focus();
                    alert("Please Enter HR Second Box Number from Experience Letter Details Tab");
                    return false;
                }
                if ((IsEmpty(issueddate))) {
                    issueddate.focus();
                    alert("Please Select Issued Date from Experience Letter Details Tab");
                    return false;
                }
                if ((IsEmpty(date_of_join))) {
                    date_of_join.focus();
                    alert("Please Select Date Of Join from Experience Letter Details Tab");
                    return false;
                }
                if ((IsEmpty(to_date))) {
                    to_date.focus();
                    alert("Please Select To Date  from Experience Letter Details Tab");
                    return false;
                }
                if (designation.value == 0) {
                    designation.focus();
                    alert("Please Select Designation from Experience Details Tab");
                    return false;
                }
                if ((IsEmpty(email))) {
                    email.focus();
                    alert("Please Enter Email Address from Experience Letter Details Tab");
                    return false;
                }
            ...
            function ValidateEmail() {
                ...
                if ((IsEmpty(candidatename))) {
                    candidatename.focus();
                    alert("Please Enter Email from Experience Letter Details Tab.");
                    return false;
                }
                function IsEmpty(aTextField) {
                    if ((aTextField.value.length == 0) || (aTextField.value == null) || aTextField.value.charAt(0) == ' ') {
