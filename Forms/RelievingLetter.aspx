<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RelievingLetter.aspx.cs" Inherits="Forms_RelievingLetter" %>
...
<body>
    <form id="form1" runat="server" class="form-horizontal no-margin">
       ...
       <p> <b> Relieving Letter </b><br />
        ...
        <br />
        <p>
           <b> Mr.  / Ms.</b>  ____________ was employed with <b> Escalon Business Services Pvt Ltd.</b> as ___________, <b> from</b>
            __________ onwards.
           
            <p> This is with reference to resignation request on _______________.</p>
           
            <p> The management has accepted your request and you are relieved from the services of our organization with 
                effect from the close of office hours on ___________________.</p>
         
            <p>You may please get in touch with HR/Service Desk for all your future correspondence on tax papers, final
                settlement and Experience certificate after successful Exit completion.  </p>
            <br />
            <br />
            <br />
