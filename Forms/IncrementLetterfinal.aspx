<%@ Page Language="C#" AutoEventWireup="true" CodeFile="IncrementLetterfinal.aspx.cs" Inherits="Forms_IncrementLetterfinal" %>
...
<body>
    ...
    <p> <b> Increment Letter </b> 
     ...
     <br />
        ...
        <p> <b> Name :</b> &nbsp;&nbsp; ____________<br />
            <b> Department:</b> &nbsp;_____________________
        </p>
        ...
        <p>
            ...
            <p> We are pleased to have you successful completion of FY _________performance review process with Escalon Business Services. Thank you for contributing. </p> 
            <br />
        </p>
   
         <table style="width:100%;text-align:center;border-bottom:none" border="1" cellspacing="0" cellpadding="0">
            <tr style="height:40px;">
               
                <td style="width:33.2%;border-right:0px solid black">
                    
                </td>
                <td style="font-size:13px;font-weight:900;border-right:1px solid black" class="auto-style1" >
        ...
        <table style="width:100%;text-align:center;" border="1" cellspacing="0" cellpadding="0">
            <%--<tr style="height:40px">
                ...
                <td style="width:60%;font-size:13px;font-weight:800;border-right:2px solid black" >
                    Annual compensation INR
                </td>
            </tr>--%>
            <tr style="height:35px">
                ...
                <td style="width:%;border-right:1px solid black">

                </td>
            </tr>
             <tr style="height:40px">
                <td style="width:33%;border-top:none">
                B)	Variable
                </td>
                <td style="width:33%;">

                </td>
                <td style="width:33%;border-right:0px solid black">
              ...
              <tr style="height:40px">
                <td style="width:33%;font-size:13px;font-weight:900">
           Total Earning  (A+B)
                </td>
                <td style="width:33%;">
        ...
        <br />
        <p>We wish you all the best and take this opportunity to welcome you to continue this journey of success with us.</p>
