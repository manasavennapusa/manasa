<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DesignationChangeLetterDetails.aspx.cs" Inherits="Forms_DesignationChangeLetterDetails" %>
            ...
            <div class="main-container" id="div_letter" runat="server">
                <div>
                    ...
                    <table style="width: 95%; text-align: justify; font: bold; font-size: 15px; font-weight: 500; margin: 10px 5px 10px 15px">
                        <tr>
                            <td style="font: bold; font-size: 14px; font-weight: 800;text-decoration:underline">DesignationChange Letter
                            </td>
                        </tr>
                        <tr>
                            <td>
                       ...
                       <%-- <tr>
                            <td>
                                <asp:Label ID="txt_designation_change_letter" runat="server" Style="border: none;padding: 0px 0px 4px 3px" placeholder="Enter offer letter"></asp:Label>
                            </td>
                        </tr>--%>
                        <tr>
                            <td>
                        ...
                        <tr>
                            <td>
                                <b>HR&nbsp;/&nbsp;<asp:Label ID="txt_HR_1" runat="server" Style="border: none;padding: 0px 0px 4px 3px"></asp:Label>&nbsp;/&nbsp;<asp:Label ID="txt_HR_2" runat="server" Style="border: none;padding: 0px 0px 4px 3px"></asp:Label>&nbsp;/&nbsp;<asp:Label ID="txt_designation_change_letter" runat="server" Style="border: none;padding: 0px 0px 4px 3px"></asp:Label></b>
                            </td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <tr>
                            <td>
                                <b>Name:</b><asp:Label ID="txt_employee_name" runat="server" Style="border: none;padding: 0px 0px 4px 3px" placeholder="Enter date"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <b>Department:</b><asp:Label ID="txt_department" runat="server" Style="border: none;padding: 0px 0px 4px 3px" placeholder="Enter date"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <tr>
                            <td>
                                <br />
                                We congratulate you for your hard work, enthusiasm, dedication and continuous effort in meeting the
             organization objective. On reviewing your performance for the on-going year&nbsp;<asp:Label ID="txt_year" runat="server"></asp:Label>&nbsp;, we are glad to announce
             your designation update:</td>
                        </tr>
                        <tr>
                            <td>
                            </td>
                        ...
                        <tr>
                            <td style="font-size:15px">
                                  <b>Department:</b>&nbsp;<asp:Label ID="txt_department_1" runat="server"></asp:Label>
                             </td>
                        </tr>
                        <tr>
                            <td style="font-size:15px">
                                <b>Designation:</b>&nbsp;<asp:Label ID="txt_designation" runat="server"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <tr>
                            <td>
                                We expect you to keep up your performance in the years to come and grow with the organization. All other terms of employment remains unchanged. Wish you all the best. 
                            </td>
                        </tr>
                        <tr>
                            <td>
                ...
                <div>
                    ...
                    <table style="width: 95%;margin: 10px 5px 10px 15px">
                        <tr>
                            <td>
                                <br />
                                <br /><br /><br />
