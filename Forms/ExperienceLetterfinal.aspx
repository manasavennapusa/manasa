<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ExperienceLetterfinal.aspx.cs" Inherits="Forms_ExperienceLetterfinal" %>
...
<body>
    ...
    <p> <b> Experience Letter </b><br />
        ...
        <br />
        <br />
        <p>  Mr. /Ms______________was employed with Escalon Business Services Pvt Ltd. from ______________________ to _________________________as __________________. During his/her tenure with us, was under training in US Accounting. His major responsibilities included:

</p>
     <p>    • Doing book keeping in US based software like QuickBooks & Property Ware.<br />
        • Preparing monthly management accounts. <br />
        • Reconciliation of Vendors and Banks. </p>
        <br />
        <br />
