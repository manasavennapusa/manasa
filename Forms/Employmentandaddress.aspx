<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Employmentandaddress.aspx.cs" Inherits="Forms_Employmentandaddress" %>
...
<body>
    <form id="form1" runat="server" class="form-horizontal no-margin">
        ...
        <br />
        <br />
    <p> <b> Employement Letter </b> <br />
        ___________________________
        </p>
        <p>  HR/______/______</p>
        <p>  Date ______________</p>
        <p> <b> Name: ___________</b> <br />
        <b>  Department: ___________ </b></p>
        <br />
        <center> <b> TO WHOM IT MAY CONCERN </b></center>
        <br />
        
        <p>This is to certify that Mr. /Ms   _____________with, EMP ID____________, and current address ____________________________, has been employed in our organization from 1st July 2016 till date, as _________________________.  </p>
        <br />
        <br />
