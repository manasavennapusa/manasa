<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SendResignationAcceptanceLetterMail.aspx.cs" Inherits="Forms_SendResignationAcceptanceLetterMail" %>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="form-actions no-margin" style="text-align:right">
                                                        ...
                                                        <asp:Button ID="btnback" runat="server" CssClass="btn btn-info" Text="Back" title="Back To Previous menu" Style="margin-left: 10px" OnClick="btnback_Click" />
                                                    </div>
                                                </td>
                                            </tr>
                                        </table>
