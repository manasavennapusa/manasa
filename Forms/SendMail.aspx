<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SendMail.aspx.cs" Inherits="recruitment_SendMail" %>
                                                                        ...
                                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                            ...
                                                                            <tr style="height: 50px">
                                                                                ...
                                                                                <td class="frm-rght-clr123" width="52%">
                                                                                    <asp:TextBox ID="tbfrom" runat="server" onkeydown=" return MakeReadOnly(this,event);" CssClass="span11" MaxLength="100">connect@escalon.services</asp:TextBox>
                                                                            ...
                                                                            <tr>
                                                                             ...
                                                                             <tr id="trcc" runat="server" visible="false">
                                                                                <td class="frm-lft-clr123 border-bottom" width="48%">CC<span class="star"></span></td>
                                                                                <td class="frm-rght-clr123 border-bottom" width="52%">
                                                                                    <asp:TextBox ID="txt_cc" runat="server" CssClass="span11" Width="" MaxLength="100" onkeydown=" return MakeReadOnly(this,event);" Style="border: 1px solid #ddd" TextMode="SingleLine"></asp:TextBox>
                                                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ControlToValidate="tbto"
                                                                                        Display="Dynamic" ErrorMessage='<img src="../images/error1.gif" alt="" />' ToolTip="Enter To Mail"
                                                                                        ValidationGroup="v" Width="6px" SetFocusOnError="True"><img src="../images/error1.gif" alt="" /></asp:RequiredFieldValidator>
                                                                                </td>
                                                                            </tr>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="form-actions no-margin" style="text-align:right">
                                                        <asp:Button ID="btnsend" runat="server" CssClass="btn btn-info" Text="Send" title="Send Mail" ValidationGroup="v" OnClick="SendEmail" Style="margin-left: 10px" />
