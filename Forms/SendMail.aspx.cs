...
public partial class recruitment_SendMail : System.Web.UI.Page
{
    public int i;
...
"<body>" +
    ...
    "<div>" +
        "<table style='width: 90%;margin-left:20px' border='0' cellspacing='0' cellpadding='0'>" +
            ...
            "<tr>" +
                "<td>" +
                       "<asp:Label ID='lblmessage1' runat='server' style='font-family:Cambria;font-weight:600'>PS : Please send two references of previous employment for internal process <br/> (Reference check) and your acceptance in reply to this mailer to confirm us <br/> officially to close the opening</asp:Label>" +
                "</td>" +
            "</tr>" +
             "<tr>" +
                "<td>" +
            ...
            "<tr>" +
                "<td>" +
                      "<asp:Label ID='lblmessage2' runat='server' style='text-align: justify;font-family: Brush Script MT; font-size: 20px'>Ritu Chitra</asp:Label>" +
                "</td>" +
            "</tr>" +
            "<tr>" +
                "<td>" +
                      "<asp:Label ID='lblmessage3' runat='server' style='font-family:Cambria;font-weight:600'>HR Manager</asp:Label>" + 
                "</td>" +
            "</tr>" +
             "<tr>" +
                "<td>" +
            ...
            "</tr>" +
             "<tr>" +
                "<td>" +
                      "<asp:Label ID='lblmessage4' runat='server' style='font-family:Cambria;font-weight:600'>Email : ritu.chitra@escalon.services</asp:Label>" +
                "</td>" +
            "</tr>" +
             "<tr>" +
                "<td>" +
                      "<asp:Label ID='lblmessage5' runat='server' style='font-family:Cambria;font-weight:600'>Phone : 0172-4643839</asp:Label>" +
                "</td>" +
            "</tr>" +
            "<tr>" +
                "<td>" +
