<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Send_confirmed_mail.aspx.cs" Inherits="Forms_Send_confirmed_mail" %>
                    ...
                    <div class="span12">
                        <div class="widget" style="">
                            <div class="widget-header">
                                <div class="title">
                                    <span class="fs1" aria-hidden="true" data-icon="&#xe14a;">Send Confirmation Mail</span>
                                </div>
                            </div>
                                                                                ...
                                                                                <td class="frm-rght-clr123" width="52%">
                                                                                    <asp:TextBox ID="tbfrom" runat="server" placeholder="YourEmail.@gmail.com" CssClass="span11" MaxLength="100">connect@escalon.services</asp:TextBox>
                                                                                     <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="tbfrom"
                                                                                        Display="Dynamic" ErrorMessage='<img src="../images/error1.gif" alt="" />' ToolTip="Enter From Mail"
