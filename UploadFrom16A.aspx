<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UploadFrom16A.aspx.cs" Inherits="UploadFrom16A" %>
                                        ...
                                        <div class="widget-body">
                                            <fieldset>
                                                <div class="control-group">
                                                    <label class="control-label">Upload Form 16A</label>
                                                    <div class="controls">
                                                        <asp:FileUpload ID="flEmployee" runat="server" />
                                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator12" runat="server"
                                                            ControlToValidate="flEmployee" ValidationGroup="b" CssClass="txt-red" ErrorMessage="Only Pdf format(.pdf)"
