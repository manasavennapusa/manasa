<%@ Page Language="C#" AutoEventWireup="true" CodeFile="helpdesk_dashboard.aspx.cs" Inherits="menudashboard_helpdesk_dashboard" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function drawChart() {
            ...
            $.ajax({
                type: "POST",
                url: "helpdesk_dashboard.aspx/RequstStatusChart",
                data: '{}',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (r) {
                    var data = google.visualization.arrayToDataTable(r.d);
                    var chart = new google.visualization.ColumnChart($("#requeststatuschart")[0]);
    ...
    <script type="text/javascript">
        ...
        function drawChart() {
            ...
            $.ajax({
                type: "POST",
                url: "helpdesk_dashboard.aspx/CatagoryRequestChart",
                data: '{}',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (r) {
                    var data = google.visualization.arrayToDataTable(r.d);
                    var chart = new google.visualization.ColumnChart($("#supportrequestbycatagory")[0]);
                    chart.draw(data, options);
                },
                failure: function (r) {
                    alert(r.d);
    ...
    <script type="text/javascript">
        ...
        function drawChart() {
            ...
            $.ajax({
                type: "POST",
                url: "helpdesk_dashboard.aspx/PriorityAndServiceChart",
                data: '{}',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (r) {
                    var data = google.visualization.arrayToDataTable(r.d);
                    var chart = new google.visualization.ColumnChart($("#priorityandservicechart")[0]);
                    chart.draw(data, options);
                },
                failure: function (r) {
                    alert(r.d);
    ...
    <script type="text/javascript">
        ...
        function drawChart() {
            ...
            $.ajax({
                type: "POST",
                url: "helpdesk_dashboard.aspx/ProblemsByStatusChart",
                data: '{}',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (r) {
                    var data = google.visualization.arrayToDataTable(r.d);
                    var chart = new google.visualization.PieChart($("#problemsbystatuschart")[0]);
    ...
    <script type="text/javascript">
        ...
        var high = parseInt('<%= Session["high"] %>');
        var medium = parseInt('<%= Session["medium"] %>');
        var low = parseInt('<%= Session["low"] %>');
        ...
        function drawChart5() {
            ...
            var chart = new google.visualization.ColumnChart(document.getElementById('reportereqbycatagorychart'));
            chart.draw(data, options);
        }
    </script>
    ...
    <script type="text/javascript">
        ...
        var myhighreq = parseInt('<%= Session["MyhighRequest"] %>');
        var mymediumreq = parseInt('<%= Session["MymediumRequest"] %>');
        var mylowreq = parseInt('<%= Session["MylowRequest"] %>');
        ...
        function drawChart5() {
            ...
            var chart = new google.visualization.ColumnChart(document.getElementById('myreqbycatagory'));
            chart.draw(data, options);
        }
    </script>
...
<body>
    <form id="form1" runat="server" class="border-top-golden">
        ...
        <section class="services-area-6 bg-gray text-center p-25px HelpDesk_dashboard_height">
            <div class="row">
                                    ...
                                    <table class="width-100 text-left">
                                        <tr>
                                            ...
                                            <td class="width-95 align-bottom pt-5px">&nbsp;
                                               <b>Support Requests By Status</b>
                                            </td>
                                        </tr>
                                    </table>
                                ...
                                <td class="width-100">
                                    <table class="width-100 text-left">
                                        <tr>
                                            ...
                                            <td class="width-95 align-bottom pt-5px">&nbsp;
                                               <b>Support Requests By Catagory</b>
                                            </td>
                                        </tr>
                                    </table>
                                    <div id="supportrequestbycatagory"></div>
                                </td>
                            </tr>
                        </table>
                    </div>
                                ...
                                <td class="width-100">
                                    <table class="width-100 text-left">
                                        <tr>
                                            ...
                                            <td class="width-95 align-bottom pt-5px">&nbsp;
                                               <b>Incidents By Priority And Service</b>
                                            </td>
                                        </tr>
                                    </table>
                                    <div id="priorityandservicechart"></div>
                                </td>
                            </tr>
                        </table>
                    </div>
                                ...
                                <td class="width-100">
                                    <table class="width-100 text-left">
                                        <tr>
                                            ...
                                            <td class="width-95 align-bottom pt-5px">&nbsp;
                                                 <b>Problems By Status</b>
                                            </td>
                                        </tr>
                                    </table>
                                    <div id="problemsbystatuschart"></div>
                                </td>
                            </tr>
                        </table>
                    </div>
                                ...
                                <td class="width-100">
                                    <table class="width-100 text-left">
                                        <tr>
                                            ...
                                            <td class="width-95 align-bottom pt-5px">&nbsp;
                                               <b>Reportee Request By catagory</b>
                                            </td>
                                        </tr>
                                    </table>
                                    <div id="reportereqbycatagorychart"></div>
                                </td>
                            </tr>
                        </table>
                    </div>
                                ...
                                <td class="width-100">
                                    <table class="width-100 text-left">
                                        <tr>
                                            ...
                                            <td class="width-95 align-bottom pt-5px">&nbsp;
                                               <b>My Request By catagory</b>
                                            </td>
                                        </tr>
                                    </table>
                                    <div id="myreqbycatagory"></div>
                                </td>
                            </tr>
                        </table>
                    </div>
