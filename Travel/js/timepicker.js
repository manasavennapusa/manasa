...
var imagePath="";
  ...
  function refreshTimePicker(mode) {
    ...
    sHTML = "<table><tr><td><table cellpadding=3 cellspacing=0 >";
    for (i=0;i<=11;i++) {
  ...
  function selectTime(ctl,ctl2) {
    ...
    textCtl=ctl2;
    currentCtl = ctl
 //   currentCtl.src=imagePath+ "calender-icon.jpg";
     //currentCtl.src="../images/calender-icon.jpg";
