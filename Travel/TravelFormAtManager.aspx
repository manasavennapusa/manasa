<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TravelFormAtManager.aspx.cs" Inherits="Travel_TravelFormAtManager" %>
...
<head id="Head1" runat="server">
    ...
    <%--<script type="text/javascript">
        function invokeButtonClick() {
            document.getElementById("btnRejecct").click();
        }

        function Validate() {
            return confirm('Are you want to reject???');
        }
        </script>--%>
                                        ...
                                        <fieldset>
                                            ...
                                            <div class=" no-margin" style="float: right">
                                                <asp:Button ID="btnAddTrip" runat="server" CssClass="btn btn-primary" OnClick="btnAddTrip_Click"
                                                    Text="Add" ValidationGroup="trip" Visible="false" />
                                            ...
                                            <div id="Div1" class="example_alt_pagination">
                                                <asp:GridView ID="grid_Trip" runat="server" AutoGenerateColumns="False" CssClass="table table-condensed table-striped  table-bordered pull-left"
                                                    EmptyDataText="No Data Exists" OnRowDeleting="grid_Trip_RowDeleting" DataKeyNames="tripid">
                                                    <Columns>
                                ...
                                <div class="widget">
                                    ...
                                    <div class="widget-body">
                                        <div id="dt_example3" class="example_alt_pagination">
                                            ...
                                            <asp:GridView ID="Grid_Approvers1" runat="server" AutoGenerateColumns="False" CssClass="table table-condensed table-striped  table-bordered pull-left"
                                                EmptyDataText="No Data  Found" OnPreRender="Grid_Approvers1_PreRender">
                                                <Columns>
                                                    <asp:TemplateField HeaderText="Approver Code">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblcode" runat="server" Text='<%#Eval("approvercode")%>'></asp:Label>
