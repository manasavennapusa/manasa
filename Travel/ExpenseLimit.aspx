<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ExpenseLimit.aspx.cs" Inherits="Travel_ExpenseLimit" %>
                ...
                <ContentTemplate>
                    ...
                    <div class="main-container">
                        ...
                        <div class="page-header">
                            <div class="pull-left">
                                 <span class="fs1" id="create1" runat="server" aria-hidden="true" ><h2>Create Food Expense Tariff</h2></span>
                                <span class="fs1" id="edit1" runat="server" aria-hidden="true" ><h2>Edit Food Expense Tariff</h2></span>
                            </div>
                            ...
                            <div class="span12">
                                <div class="widget">
                                    <div class="widget-header" style="border-bottom: none;">
                                        <div class="title">
                                            <span class="fs1" id="create" runat="server" aria-hidden="true" data-icon="&#xe023;">Create Food Expense Tariff</span>
                                             <span class="fs1" id="edit" runat="server" aria-hidden="true" data-icon="&#xe023;">Edit Food Expense Tariff</span>
                                        </div>
                                    </div>
                                        ...
                                        <fieldset>
                                             <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    <asp:DropDownList ID="ddl_traveltype" CssClass="span4" runat="server" >
                                                        ...
                                                        <asp:ListItem Value="I">International</asp:ListItem> <%--AutoPostBack="true" OnSelectedIndexChanged="ddl_traveltype_SelectedIndexChanged"--%>
                                                    </asp:DropDownList>
                                            ...
                                            <div class="control-group" style="display:none">
                                             ...
                                             <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    <asp:DropDownList ID="ddlCurrecny" runat="server" CssClass="span4">
                                                    </asp:DropDownList>
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    <asp:TextBox ID="txtTariff" runat="server" CssClass="span4" onkeypress="return IsNumeric(event);"></asp:TextBox>
                            ...
                            <div class="span12">
                                <div class="widget no-margin">
                                    <div class="widget-header">
                                        <div class="title">
                                            <span class="fs1" aria-hidden="true" data-icon="&#xe14a;"></span>View Food Expense Tariff                
                                           
                                        </div>
                                    </div>
                                    <div class="widget-body">
                                        <div id="dt_example" class="example_alt_pagination">
                                            <asp:GridView ID="grdtravelExpanse" runat="server" AutoGenerateColumns="False" CssClass="table table-condensed table-striped table-hover table-bordered pull-left"
                                                 ...
                                                 <%--   <asp:TemplateField HeaderText="Grade" HeaderStyle-Width="10%">
                                                  ...
                                                  <%--   <asp:TemplateField HeaderText="Country" HeaderStyle-Width="10%">
                                                    ...
                                                    <asp:TemplateField HeaderText="Currency Code" HeaderStyle-Width="10%">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblcurreny" runat="server" Text='<% #Eval("currencycode")%>'></asp:Label>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="Food Expense" HeaderStyle-Width="10%">
                                                        <ItemTemplate>
                                                    ...
                                                    <asp:TemplateField HeaderText="Edit" HeaderStyle-Width="10%">
                                                        <ItemTemplate>
                                                            <a href="ExpenseLimit.aspx?ID=<%# Eval("ID")%>"
