<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TravelFormAtManagement.aspx.cs" Inherits="Travel_TravelFormAtManagement" %>
                    ...
                    <div class="span12">
                        <div class="widget">
                            <div class="widget-header">
                                ...
                                <asp:Button ID="btnAddAdvance" runat="server" CssClass="btn btn-info pull-right" ValidationGroup="allo" Visible="false"
                                ...
                                <fieldset>
                                    ...
                                    <div id="dt_example" class="example_alt_pagination">
                                        <asp:GridView ID="grid_Advance" runat="server" AutoGenerateColumns="False" CssClass="table table-condensed table-striped  table-bordered pull-left"
                                            EmptyDataText="No Data Exists" OnPreRender="grid_Advance_PreRender" OnRowDeleting="grid_Advance_RowDeleting" DataKeyNames="id" OnRowEditing="grid_Advance_RowEditing">
                                            <Columns>
                    ...
                    <div class="span12">
                        <div class="widget">
                            <div class="widget-header" style="border-bottom: none;">
                                ...
                                <asp:Button ID="btnAddTrip" runat="server" CssClass="btn btn-info pull-right" OnClick="btnAddTrip_Click" Visible="false"
                                ...
                                <fieldset>
                                                ...
                                                <table style="width: 100%">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="frm-rght-clr123" style="width: 54%">
                                                            <asp:TextBox ID="txtdepartdate" runat="server" CssClass="span10" onkeypress="return isCharOrSpace()"></asp:TextBox>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="frm-rght-clr123">
                                                            <asp:TextBox ID="txtdeparttime" runat="server" CssClass="span10" onkeypress="return isCharOrSpace()"></asp:TextBox>
                                            ...
                                            <td style="vertical-align: top; width: 50%">
                                                <table style="width: 99%;" align="right">
                                                    <tr>
                                                        ...
                                                        <td class="frm-rght-clr123">
                                                            <asp:TextBox ID="txtPTD" runat="server" CssClass="span10" onkeypress="return isCharOrSpace()"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td class="frm-lft-clr123" width="44%">Date Of Arrival</td>
                                                        <td class="frm-rght-clr123" width="55%">
                                                            <asp:TextBox ID="txtarvlDate" runat="server" CssClass="span10"></asp:TextBox>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="frm-rght-clr123">
                                                            <asp:TextBox ID="txtArvlTime" runat="server" CssClass="span10" onkeypress="return isCharOrSpace()"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                    ...
                                    <div id="dt_example1" class="example_alt_pagination">
                                        <asp:GridView ID="grid_Trip" runat="server" AutoGenerateColumns="False" CssClass="table table-condensed table-striped  table-bordered pull-left"
                                            EmptyDataText="No Data Exists" OnPreRender="grid_Trip_PreRender" OnRowDeleting="grid_Trip_RowDeleting" DataKeyNames="tripid" OnRowEditing="grid_Trip_RowEditing">
                                            <Columns>
                        ...
                        <div class="widget">
                            ...
                            <div class="widget-body">
                                <div id="dt_example3" class="example_alt_pagination">
                                    ...
                                    <asp:GridView ID="Grid_Approvers2" runat="server" AutoGenerateColumns="False" CssClass="table table-condensed table-striped  table-bordered pull-left"
                                        EmptyDataText="No Data  Found" OnPreRender="Grid_Approvers2_PreRender">
                                        <Columns>
                                            <asp:TemplateField HeaderText="Approver Code">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblcode" runat="server" Text='<%#Eval("approvercode")%>'></asp:Label>
                    ...
                    <div class="row-fluid">
                        ...
                        <div class="span4" style="text-align: right">
                            <asp:Button ID="btnSumitForm" runat="server" CssClass="btn btn-primary"
                                Text="Approve" ValidationGroup="travel" OnClick="btnSumitForm_Click" OnClientClick="return confirm('Are you sure. you want to Approve?')" />
                            <asp:Button ID="btnRejecct" runat="server" CssClass="btn btn-primary"
                                Text="Reject" ValidationGroup="cmts" OnClick="btnRejecct_Click" OnClientClick="return confirmReject();" />
                            <asp:Button ID="btn_travelCancel" runat="server" CssClass="btn btn-primary" Visible="false"
