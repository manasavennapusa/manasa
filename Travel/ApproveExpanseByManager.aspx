<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ApproveExpanseByManager.aspx.cs" Inherits="Travel_ApproveExpanseByManager" %>
                                    ...
                                    <div class="widget-body">
                                        <div id="dt_example1" class="example_alt_pagination">
                                            <asp:GridView ID="grid_Trip" runat="server" AutoGenerateColumns="False" CssClass="table table-condensed table-striped  table-bordered pull-left"
                                                EmptyDataText="No Data Exists" OnPreRender="grid_Trip_PreRender" DataKeyNames="tripid">
                                                <Columns>
                                                    <asp:TemplateField HeaderText="S.No.">
                                                        <ItemTemplate>
                                                            <%# Container.DataItemIndex +1 %>
                                                            ...
                                                            <asp:GridView ID="grdExpenseSummary" runat="server" AutoGenerateColumns="False" CssClass="gvclass" Width="100%"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="Sanctioned Amount" HeaderStyle-Width="25%">
                                                                        <ItemTemplate>
                                                                            <asp:Label ID="txtSantionedAmount" runat="server" ForeColor="Red" Text='<%#Eval("sanctionedamount")%>'></asp:Label>
                                                                        </ItemTemplate>
                                                                        <ItemStyle HorizontalAlign="Right" />
                                                                    </asp:TemplateField>
                                                                </Columns>
                                            ...
                                            <asp:GridView ID="GridTally" runat="server" AutoGenerateColumns="False" CssClass="table table-condensed table-striped  table-bordered pull-left" Width="100%"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Pre Travel Advance Given Amount" HeaderStyle-Width="35%">
                                                        <ItemTemplate>
                                                            <asp:Label ID="txtgiven" runat="server" CssClass="span12" ForeColor="Blue" Style="text-align: right" Text='<%#Eval("giventotal")%>'></asp:Label>
                                                        </ItemTemplate>
                                                        <ItemStyle HorizontalAlign="Right" />
                                                        <FooterStyle HorizontalAlign="Right" />
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="Expense Sanctioned Amount" HeaderStyle-Width="35%">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblamount" runat="server" ForeColor="Green" Text='<%#Eval("sanctionedamount")%>'></asp:Label>
                                                        </ItemTemplate>
                                                        <ItemStyle HorizontalAlign="Right" />
                                ...
                                <div class="widget">
                                    ...
                                    <div class="widget-body">
                                        <div id="dt_example3" class="example_alt_pagination">
                                            ...
                                            <asp:GridView ID="Grid_Approvers7" runat="server" AutoGenerateColumns="False" CssClass="table table-condensed table-striped  table-bordered pull-left"
                                                EmptyDataText="No Data  Found" OnPreRender="Grid_Approvers7_PreRender">
                                                <Columns>
                            ...
                            <div class="row-fluid">
                                ...
                                <div class="span4" style="text-align: right">
                                    ...
                                    <asp:Button ID="btnBack" runat="server" CssClass="btn btn-primary"
                                        Text="Cancel" OnClick="btnBack_Click" CausesValidation="false" />
                                </div>
                            </div>
                        </div>
