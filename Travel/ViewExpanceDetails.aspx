<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ViewExpanceDetails.aspx.cs" Inherits="Travel_ViewExpanceDetails" %>
                ...
                <ContentTemplate>
                    ...
                    <div class="main-container">
                        ...
                        <div class="page-header">
                            <div class="pull-left">
                                <h2>View Approved Expense Details</h2>
                            </div>
                                        ...
                                        <div id="dt_example" class="example_alt_pagination">
                                            <asp:GridView ID="grid_Travel" runat="server" AutoGenerateColumns="False" CssClass="table table-condensed table-striped  table-bordered pull-left"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:HyperLinkField HeaderText="View" HeaderStyle-Width="10%" DataNavigateUrlFields="travelid" DataNavigateUrlFormatString="~/Travel/ViewExpanceDetails.aspx?travelID={0}"
                                                        Text='View'>
                                                    ...
                                                    <asp:GridView ID="gridExpanse" runat="server" AutoGenerateColumns="False" CssClass="table table-condensed table-striped  table-bordered pull-left"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderText="Date">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lbllevel" runat="server" Text='<%#Eval("traveldate","{0:dd-MMM-yyyy}")%>'></asp:Label>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                       ...
                       <div class="row-fluid" id="approverdetails" runat="server">
                        ...
                        <div class="row-fluid" id="divpreviouscomment" runat="server">
                            ...
                            <div class="form-actions no-margin" style="text-align: right; vertical-align: central" id="divbuttons" runat="server">
                                <asp:Button ID="btnPrint" runat="server" CssClass="btn btn-primary" OnClick="btnPrint_Click" Text="Print" Style="margin-top: 20px"/>
