<%@ Page Language="C#" AutoEventWireup="true" CodeFile="StayTariff.aspx.cs" Inherits="Travel_StayTariff" %>
                ...
                <ContentTemplate>
                    ...
                    <div class="main-container">
                        <div class="page-header">
                            <div class="pull-left">
                                 <span class="fs1" id="create1" runat="server" ><h2>Create L & C / Stay Tariff Master</h2></span>
                                 <span class="fs1" id="edit1" runat="server" ><h2>Edit L & C / Stay Tariff Master</h2></span>
                            </div>
                            ...
                            <div class="span12">
                                <div class="widget">
                                    <div class="widget-header" style="border-bottom: none;">
                                        <div class="title">
                                            <span class="fs1" id="create" runat="server" aria-hidden="true" data-icon="&#xe023;">Create L & C / Stay Tariff Master</span>
                                            <span class="fs1" id="edit" runat="server" aria-hidden="true" data-icon="&#xe023;">Edit L & C / Stay Tariff Master</span>
                                        </div>
                                    </div>
                                        ...
                                        <fieldset>
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    ...
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="ddl_traveltype"
                                            ...
                                            <div class="control-group" id="divtier" runat="server">
                                                <label class="control-label">Tier</label>
                                                <div class="controls">
                                                    <asp:DropDownList ID="ddl_tier" runat="server" CssClass="span4"></asp:DropDownList>
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="ddl_tier"
                                            ...
                                            <div class="control-group" Style="display: none">
                                                ...
                                                <div class="controls">
                                                    ...
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="ddl_grade"
                                            ...
                                            <div class="control-group">
                                                ...
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="ddlCurrecny"
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    <asp:TextBox ID="txtTariff" runat="server" CssClass="span4" MaxLength="14" onkeypress="return IsNumeric(event);" ></asp:TextBox>
                                            ...
                                            <div class="form-actions no-margin" style="text-align: right">
                                                <asp:Button ID="btnSave" runat="server" Text="Submit" OnClick="btnSave_Click" CssClass="btn btn-primary" ValidationGroup="c" />
                                                <asp:Button ID="btnUpdate" runat="server" Text="Update" OnClick="btnUpdate_Click" CssClass="btn btn-primary" ValidationGroup="c" />
                                                <asp:Button ID="btnCancel" runat="server" Text="Reset" CausesValidation="false" CssClass="btn btn-primary" OnClick="btnCancel_Click" />&nbsp;
                            ...
                            <div class="span12">
                                <div class="widget no-margin">
                                    <div class="widget-header">
                                        <div class="title">
                                            <span class="fs1" aria-hidden="true" data-icon="&#xe14a;"></span>View L & C / Stay Tariff Master 
                                           
                                        </div>
                                    </div>
                                    <div class="widget-body">
                                        <div id="dt_example" class="example_alt_pagination">
                                            <asp:GridView ID="grdtravelTariff" runat="server" AutoGenerateColumns="False" CssClass="table table-condensed table-striped  table-bordered pull-left"
                                                OnPageIndexChanging="grdtravelTariff_PageIndexChanging" OnPreRender="grdtravelTariff_PreRender"
                                                OnRowDeleting="grdtravelTariff_RowDeleting" DataKeyNames="staytafiffid"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Tier" HeaderStyle-Width="10%">
                                                        <ItemTemplate>
                                                    ...
                                                    <asp:TemplateField HeaderText="Stay Tariff" HeaderStyle-Width="10%">
                                                        <ItemTemplate>
                                                    ...
                                                    <asp:TemplateField HeaderText="Edit" HeaderStyle-Width="10%">
                                                        <ItemTemplate>
                                                            <a href="StayTariff.aspx?ID=<%# Eval("staytafiffid")%>"
