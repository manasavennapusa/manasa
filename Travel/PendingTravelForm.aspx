<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PendingTravelForm.aspx.cs" Inherits="Travel_PendingTravelForm" %>
            ...
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                <ContentTemplate>
                    ...
                    <div class="main-container">
                        ...
                        <div class="row-fluid" id="miscellaneousdetails" runat="server" style="display: none" visible="false">
                            <div class="span12">
                                <div class="widget">
                                    <div class="widget-header" style="border-bottom: none;">
                                        <div class="title">
                            ...
                            <div class="row-fluid">
                                <div class="span8" style="text-align: left">
                                    ...
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator13" runat="server" ControlToValidate="txtmgrcomments"
                                        ...
                                        Width="12px" ErrorMessage='<img src="../img/error1.gif" alt="" />'></asp:RequiredFieldValidator>
                                </div>
                                <div class="span4" style="text-align: right">
                                    ...
                                    <asp:Button ID="btnCancelTravel" runat="server" CssClass="btn btn-primary" Style="margin-top: 20px" ValidationGroup="cmts"
                                        Text="Cancel Travel"  OnClientClick="return confirmCancel();"  OnClick="btnCancelTravel_Click" />
                                </div>
                            </div>
                        </div>
                    </div>
