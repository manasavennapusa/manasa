<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TravelView.aspx.cs" Inherits="Travel_TravelView" %>
                            ...
                            <div class="widget-body">
                                <fieldset>
                                    <table style="width: 100%">
                                        ...
                                        <tr>
                                            <td class="frm-lft-clr123 border-bottom">Bank Name
                                            </td>
                                            <td class="frm-rght-clr123 border-bottom">
                                    ...
                                    <table style="width: 100%">
                                        ...
                                        <tr>
                                            ...
                                            <td class="frm-rght-clr123 border-bottom" style="width: 80%">
                                                <asp:Label ID="txt_travelpurpose" runat="server"></asp:Label>
                                            </td>
                                        </tr>
                                    </table>
                                </fieldset>
                ...
                <div class="row-fluid">
                    <div class="span12">
                        <div class="widget">
                            <div class="widget-header">
                                <div class="title">
                                    <span class="fs1" aria-hidden="true" data-icon="&#xe14a;"></span>Travel Summary 
                                    ...
                                    <tr>
                                        ...
                                        <td style="width: 50%; vertical-align: top">
                                            <table style="width: 99%" align="right">
                                                <tr>
                                                    <td class="txt02" colspan="2" style="height: 25px">Advance Estimationi Details </td>
                                                </tr>
                                                <tr>
                                                    <td colspan="2">
                                                ...
                                                <tr>
                                                    <td class="txt02" colspan="2" style="height: 25px">Total Estimation Amount</td>
