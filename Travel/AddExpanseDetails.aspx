<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddExpanseDetails.aspx.cs" Inherits="Travel_AddExpanseDetails" %>
                                                                    ...
                                                                    <fieldset>
                                                                        ...
                                                                        <div class="control-group">
                                                                            ...
                                                                            <div class="controls">
                                                                                ...
                                                                                <cc1:CalendarExtender ID="CalendarExtender2" runat="server" PopupButtonID="Image3" TargetControlID="txtDate" Enabled="True" Format="dd MMM yyyy"></cc1:CalendarExtender>
                                                                ...
                                                                <div class="widget-body">
                                                                    <fieldset>
                                                                        ...
                                                                        <div class="control-group">
                                                                            <label class="control-label">Receipt Number</label>
                                                                            <div class="controls">
                                                                                <asp:TextBox ID="txtLodgingReceiptno" runat="server" CssClass="span6" onkeypress="isChar_Number_space_slash()" MaxLength="15"></asp:TextBox>
                                                                        ...
                                                                        <div class="control-group">
                                                                            ...
                                                                            <div class="controls">
                                                                                ...
                                                                                <cc1:CalendarExtender ID="CalendarExtender1" runat="server" PopupButtonID="Image1" TargetControlID="txtStartdate" Enabled="True" Format="dd MMM yyyy"></cc1:CalendarExtender>
                                                                        ...
                                                                        <div class="control-group">
                                                                            ...
                                                                            <div class="controls">
                                                                                ...
                                                                                <cc1:CalendarExtender ID="CalendarExtender3" runat="server" PopupButtonID="Image2" TargetControlID="txtEnddate" Enabled="True" Format="dd MMM yyyy"></cc1:CalendarExtender>
                                                                    ...
                                                                    <fieldset>
                                                                        ...
                                                                        <div class="control-group">
                                                                            ...
                                                                            <div class="controls">
                                                                                ...
                                                                                <cc1:CalendarExtender ID="calendarextender5" runat="server" PopupButtonID="image5" TargetControlID="txtOOPDate" Enabled="true" Format="dd MMM yyyy"></cc1:CalendarExtender>
                                                                        ...
                                                                        <div class="control-group" id="divoopbill" runat="server" visible="false">
                                                                            ...
                                                                            <div class="controls">
                                                                                ...
                                                                                <asp:RequiredFieldValidator ID="rq_oopbillupload" runat="server" ControlToValidate="File_UploadDft4"
                                                                                    ...
                                                                                    ValidationGroup="O" float="right" SetFocusOn
                                                                                    Error="True"><img src="../img/error1.gif" alt="" /></asp:RequiredFieldValidator>
                                                                            </div>
                                                                        </div>
                                                                    ...
                                                                    <fieldset>
                                                                        ...
                                                                        <div class="control-group">
                                                                            ...
                                                                            <div class="controls">
                                                                                ...
                                                                                <cc1:CalendarExtender ID="calendarextender6" runat="server" TargetControlID="txtMiscDate" PopupButtonID="image6" Enabled="true" Format="dd MMM yyyy"></cc1:CalendarExtender>
                                                                    ...
                                                                    <fieldset>
                                                                        ...
                                                                        <div class="control-group">
                                                                            ...
                                                                            <div class="controls">
                                                                                ...
                                                                                <cc1:CalendarExtender ID="calendarextendar8" runat="server" PopupButtonID="image8" TargetControlID="txtPersonalCarDate" Enabled="true" Format="dd MMM yyyy"></cc1:CalendarExtender>
                                                                    ...
                                                                    <fieldset>
                                                                        ...
                                                                        <div class="control-group">
                                                                            ...
                                                                            <div class="controls">
                                                                                ...
                                                                                <cc1:CalendarExtender ID="calendarextender7" runat="server" TargetControlID="txtPhoneDate" PopupButtonID="image7" Enabled="true" Format="dd MMM yyyy"></cc1:CalendarExtender>
                                                                        ...
                                                                        <div class="control-group">
                                                                            ...
                                                                            <div class="controls">
                                                                                <asp:TextBox ID="txtPhoneNumber" runat="server" CssClass="span6" onkeypress="return isNumber()" MaxLength="12"></asp:TextBox>
                                        ...
                                        <div class="widget">
                                            ...
                                            <div class="widget-body">
                                                <table style="width: 100%">
                                                    ...
                                                    <tr>
                                                        <td class="txt02" style="height: 40px">Total Pre Travel Amount</td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                    ...
                                                    <tr id="trkitallowance1" runat="server">
                                                        <td style="height: 25px" class="txt02">Kit Allowance</td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        <td style="height: 25px" class="txt02">Total Advance Given </td>
