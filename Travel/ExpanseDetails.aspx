<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ExpanseDetails.aspx.cs" Inherits="Travel_ExpanseDetails" %>
                                        ...
                                        <div id="dt_example" class="example_alt_pagination">
                                            <asp:GridView ID="grid_Travel" runat="server" AutoGenerateColumns="False" CssClass="table table-condensed table-striped  table-bordered pull-left"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:HyperLinkField HeaderText="View" HeaderStyle-Width="10%" DataNavigateUrlFields="travelid" DataNavigateUrlFormatString="~/Travel/AddExpanseDetails.aspx?travelid={0}"
                                                        Text='View'>
