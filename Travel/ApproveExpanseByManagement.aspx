<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ApproveExpanseByManagement.aspx.cs" Inherits="Travel_ApproveExpanseByManagement" %>
                                ...
                                <div id="dt_example" class="example_alt_pagination">
                                    <asp:GridView ID="grid_Travel" runat="server" AutoGenerateColumns="False" CssClass="table table-condensed table-striped  table-bordered pull-left"
                                        ...
                                        <Columns>
                                            ...
                                            <%--<asp:HyperLinkField HeaderText="View" HeaderStyle-Width="10%" DataNavigateUrlFields="travelid" DataNavigateUrlFormatString="~/Travel/ApproveExpanseByManagement.aspx?travelID={0}"
                                                        Text='View'>
                                            ...
                                            <td style="width: 33%; vertical-align: top">
                                                <table style="width: 100%">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="frm-rght-clr123 border-bottom">
                                                            <asp:Label ID="lblempstatusa" runat="server"></asp:Label>
                                                        </td>
                                                    </tr>
                                    ...
                                    <div id="Div1" class="example_alt_pagination">
                                        <asp:GridView ID="grid_Trip" runat="server" AutoGenerateColumns="False" CssClass="table table-condensed table-striped  table-bordered pull-left"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Exception" HeaderStyle-Width="5%" Visible="false">
                                                    <ItemTemplate>
                                                        <span class="fs1" aria-hidden="true" data-icon='<%#Eval("ExpanseException").ToString()=="0"?"":"&#xe0fe;"%>'></span>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                ...
                                                <asp:TemplateField HeaderText="Expense View" HeaderStyle-Width="5%">
                                                    <ItemTemplate>
                                                        <%--<asp:LinkButton  ID="lbtnEdit" runat="server" CommandName="Edit" CssClass="link05" Text="View"></asp:LinkButton>--%>
                                                        <a href="javascript:void(window.open('ViewExpanseDetails.aspx?tripid=<%# Eval("tripid") %>','title','height=650,width=1100,left=100,top=30'));" class="link05">View </a>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                            </Columns>
                                        </asp:GridView>
                                ...
                                <div class="example_alt_pagination">
                                    ...
                                    <asp:GridView ID="GridTally" runat="server" AutoGenerateColumns="False" CssClass="table table-condensed table-striped  table-bordered pull-left" Width="100%"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Pre Travel Advance Given Amount" HeaderStyle-Width="35%">
                                                <ItemTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="Organization Pay Back" HeaderStyle-Width="35%">
                                                <ItemTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="Employee Pay Back" HeaderStyle-Width="35%">
                                                <ItemTemplate>
                                ...
                                <div class="widget">
                                    ...
                                    <div class="widget-body">
                                        <div id="dt_example3" class="example_alt_pagination">
                                            ...
                                            <asp:GridView ID="Grid_Approvers9" runat="server" AutoGenerateColumns="False" CssClass="table table-condensed table-striped  table-bordered pull-left"
                                                EmptyDataText="No Data  Found" OnPreRender="Grid_Approvers9_PreRender">
                                                <Columns>
                    ...
                    <div class="row-fluid">
                        <div class="span8" style="text-align: left">
                            ...
                            <asp:RegularExpressionValidator ID="RegularExpressionValidator2" ControlToValidate="txtmgrcomments"
                             ValidationGroup="travel" runat="server" ValidationExpression="^[a-zA-Z0-9]+$" ToolTip="Enter only AlphaNumeric value"
                        ...
                        <div class="span4" style="text-align: right">
                            ...
                            <asp:Button ID="btnRejecct" runat="server" CssClass="btn btn-primary"
                                Text="Reject" ValidationGroup="cmts" OnClick="btnRejecct_Click" OnClientClick="return confirmCancel();" />
                            <asp:Button ID="btnBack" runat="server" CssClass="btn btn-primary"
                                Text="Cancel" CausesValidation="false" OnClick="btnBack_Click" />
                        </div>
                    </div>
                </div>
            </div>
