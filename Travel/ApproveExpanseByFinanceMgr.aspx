<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ApproveExpanseByFinanceMgr.aspx.cs" Inherits="Travel_ApproveExpanseByFinanceMgr" %>
                                        ...
                                        <div id="dt_example" class="example_alt_pagination">
                                            <asp:GridView ID="grid_Travel" runat="server" AutoGenerateColumns="False" CssClass="table table-condensed table-striped  table-bordered pull-left"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:HyperLinkField HeaderText="View" HeaderStyle-Width="10%" DataNavigateUrlFields="travelid" DataNavigateUrlFormatString="~/Travel/ApproveExpanseByFinanceMgr.aspx?travelID={0}"
                                                        Text='View'>
                                ...
                                <div class="widget">
                                    ...
                                    <div class="widget-body">
                                        <div class="example_alt_pagination">
                                            <asp:GridView ID="GridTally" runat="server" AutoGenerateColumns="False" CssClass="gvclass" Width="100%"
                                                EmptyDataText="No Data  Found" ShowFooter="false">
                                                <Columns>
                                ...
                                <div class="widget">
                                    ...
                                    <div class="widget-body">
                                        <div id="dt_example3" class="example_alt_pagination">
                                            ...
                                            <asp:GridView ID="Grid_Approvers8" runat="server" AutoGenerateColumns="False" CssClass="table table-condensed table-striped  table-bordered pull-left"
                                                EmptyDataText="No Data  Found" OnPreRender="Grid_Approvers8_PreRender">
                                                <Columns>
                        ...
                        <div class="form-actions no-margin" style="padding-left: 20px" id="divbuttons" runat="server">
                            <div class="row-fluid">
                                ...
                                <div class="span4" style="text-align: right">
                                    <asp:Button ID="btnsendmail" runat="server" CssClass="btn btn-primary" Text="Send Mail" ValidationGroup="travel" OnClick="btnsendmail_Click" OnClientClick="return confirm('Are you sure.You want to Send')" />
