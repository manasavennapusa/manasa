                        ...
                        <tr>
                            <td height="5" valign="top">
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                        <td class="frm-lft-clr123  border-bottom" width="15%">Employee Name</td>
                                        ...
                                        <td class="frm-lft-clr123  border-bottom" style="width: 11%">Department</td>
                                                                ...
                                                                <td class="" valign="top">
                                                                    <div class="widget-content">
                                                                        ...
                                                                        <asp:GridView ID="empgrid" runat="server" CellSpacing="0" CellPadding="4" DataKeyNames="empcode" Width="100%"
                                                                            ...
                                                                            CssClass="table table-hover table-striped table-bordered table-highlight-head" BorderWidth="0px" AllowPaging="True" PageSize="50" EmptyDataText="No such employee exists !" OnRowEditing="empgrid_RowEditing" OnPageIndexChanging="empgrid_PageIndexChanging">
                                                                            <Columns>
