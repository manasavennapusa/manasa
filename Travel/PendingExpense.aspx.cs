...
public partial class Travel_PendingExpense : System.Web.UI.Page
{
    string sqlstr;
    ...
    protected void bindGrid()
    {
        ...
        DataSet ds = DBTask.ExecuteDataset(ConfigurationManager.ConnectionStrings["intranetConnectionString"].ConnectionString.ToString(), CommandType.StoredProcedure, "sp_travel_gettravelExpansepending", param);
