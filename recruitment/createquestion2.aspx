<%@ Page Language="C#" AutoEventWireup="true" CodeFile="createquestion2.aspx.cs" Inherits="createquestion2" %>
            ...
            <table width="100%" cellpadding="0" cellspacing="0" border="0">
                ...
                <tr>
                    ...
                    <td class="frm-rght-clr123" width="25%">
                        <%--<asp:TextBox ID="TextBox1" runat="server" CssClass="blue1" MaxLength="200" Width=""></asp:TextBox>--%>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td class="frm-rght-clr123" width="25%">
                        <asp:DropDownList ID="ddl_subject" runat="server" CssClass="blue1" Width=""
                            Height="20px">
                        </asp:DropDownList>
                ...
                <tr>
                    ...
                    <td class="frm-rght-clr123" width="25%">
                        <asp:DropDownList ID="ddl_category" runat="server" CssClass="blue1" Width="" Height="20px">
                            <asp:ListItem Value="0">--Select--</asp:ListItem>
                            <asp:ListItem Value="Written">Written</asp:ListItem>
                            <asp:ListItem Value="Online">Online</asp:ListItem>
                            <asp:ListItem Value="Interview">Interview</asp:ListItem>
                        </asp:DropDownList>
                        <%--<asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="ddl_category"
                ...
                <tr>
                    ...
                    <td class="frm-rght-clr123" width="25%">
                        <asp:DropDownList ID="ddl_sub_subject" runat="server" CssClass="blue1" Width=""
                            Height="20px">
                        </asp:DropDownList>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="ddl_sub_subject"
                            Display="Dynamic" ErrorMessage='<img src="../images/error1.gif" alt="" />' ToolTip="Select Sub Subject Name" InitialValue="0"
                            ValidationGroup="v" Width="6px" SetFocusOnError="True"><img src="../images/error1.gif" alt="" /></asp:RequiredFieldValidator>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td class="frm-rght-clr123" width="25%">
                        <asp:TextBox ID="txt_ques_dec" runat="server" CssClass="blue1" TextMode="MultiLine" MaxLength="200" Width=""></asp:TextBox>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="txt_ques_dec"
                ...
                <tr>
                    ...
                    <td class="frm-rght-clr123" width="25%">
                        <asp:TextBox ID="txt_optionA" runat="server" CssClass="blue1" TextMode="MultiLine" MaxLength="200" Width=""></asp:TextBox>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td class="frm-rght-clr123" width="25%">
                        <asp:TextBox ID="txt_optionB" runat="server" CssClass="blue1" TextMode="MultiLine" MaxLength="200" Width=""></asp:TextBox>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td class="frm-rght-clr123" width="25%">
                        <asp:TextBox ID="txt_optionC" runat="server" CssClass="blue1" TextMode="MultiLine" MaxLength="200" Width=""></asp:TextBox>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td class="frm-rght-clr123" width="25%">
                        <asp:TextBox ID="txt_optionD" runat="server" CssClass="blue1" TextMode="MultiLine" MaxLength="200" Width=""></asp:TextBox>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td class="frm-rght-clr123" width="25%">
                        <asp:TextBox ID="txt_optionE" runat="server" CssClass="blue1" TextMode="MultiLine" MaxLength="200" Width=""></asp:TextBox>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td class="frm-rght-clr123" width="25%">
                        <asp:TextBox ID="txt_marks" runat="server" CssClass="blue1" MaxLength="2" Width="" onkeypress="retrun isNumber()"></asp:TextBox>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="txt_marks"
                            Display="Dynamic" ErrorMessage='<img src="../images/error1.gif" alt="" />' ToolTip="Enter Marks"
                            ValidationGroup="v" Width="6px" SetFocusOnError="True"><img src="../images/error1.gif" alt="" /></asp:RequiredFieldValidator>
                        <asp:RangeValidator ID="RangeValidator2" runat="server" ControlToValidate="txt_marks" Type="Integer"
                           ErrorMessage='<img src="../images/error1.gif" alt="" />' ToolTip="Enter max 20 Questions (1-20)" MinimumValue="1" MaximumValue="20"
                ...
                <tr>
                    <td align="right" colspan="2" >
                      <%--  <asp:Button ID="btnadd" runat="server" Text="Add" CssClass="button" ValidationGroup="v" OnClick="btnadd_Click" />--%>
                        <asp:Button ID="btnSubmit" runat="server" Text="Submit" CssClass="button" ValidationGroup="v" OnClick="btnSubmit_Click" />
                        &nbsp;
