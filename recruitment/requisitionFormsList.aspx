<%@ Page Language="C#" AutoEventWireup="true" CodeFile="requisitionFormsList.aspx.cs"
    Inherits="recruitment_requisitionFormsList" %>
                                            ...
                                            <div class="widget-body">
                                                <div id="dt_example" class="example_alt_pagination">
                                                    <asp:GridView ID="grdPendingRRF" runat="server" AutoGenerateColumns="False" CaptionAlign="Left" AllowSorting="True" OnPreRender="grdPendingRRF_PreRender"
                                                        ...
                                                        <Columns>
                                                            <asp:TemplateField HeaderText="RRF_Code" Visible="true">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblrrfID" runat="server" Text='<%#Eval("id")%>' Visible="false"></asp:Label>
                                                            ...
                                                            <asp:TemplateField HeaderText=" View" Visible="false">
                                                                <ItemTemplate>
                                                                    <a href='rrfview.aspx?id=<%# Eval("id") %>' class="link05">Candidates</a>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                            <asp:TemplateField HeaderText="View">
                                                                <ItemTemplate>
                                                                    <%--<a href='viewRequistionStatus.aspx?id=<%# Eval("id") %>&rrf_id=<%# Eval("rrf_code")%>'' class="link05"><%# Eval("rrf_code") %></a>--%>
                                                                    <a href='viewRequistionStatus.aspx?id=<%# Eval("id") %>&rrf_id=<%# Eval("rrf_code")%>'' class="link05"><img src="../images/view.png" width="17" height="17" border="0"></a>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                        </Columns>
                                                    </asp:GridView>
                                                ...
                                                <div id="dt_example1" class="example_alt_pagination">
                                                    <asp:GridView ID="grdRejectedRRF" runat="server" AutoGenerateColumns="False" AllowSorting="True" OnPreRender="grdRejectedRRF_PreRender"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderText="View">
                                                                <ItemTemplate>
                                                                    <%--<a href='viewrejectedrequisitionapprover.aspx?id=<%# Eval("id") %>' class="link05"><%# Eval("rrf_code") %></a>--%>
                                                                    <a href='viewrejectedrequisitionapprover.aspx?id=<%# Eval("id") %>' class="link05"><img src="../images/view.png" width="17" height="17" border="0"></a>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                        </Columns>
                                                    </asp:GridView>
                                                    ...
                                                    <asp:GridView ID="grdRRF" runat="server" AutoGenerateColumns="false" AllowSorting="True" OnPreRender="grdRRF_PreRender"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderText="Candidate">
                                                                <ItemTemplate>
                                                                    <%--<a href='rrfview.aspx?id=<%# Eval("id") %>' class="link05">Candidates</a>--%>
                                                                    <a href='rrfview.aspx?id=<%# Eval("id") %>' class="link05"><img src="../images/view.png" width="17" height="17" border="0"></a>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                            <asp:TemplateField HeaderText="RRF">
                                                                <ItemTemplate>
                                                                    <%--<a href='viewRequistionStatus.aspx?id=<%# Eval("id") %>' class="link05"><%# Eval("rrf_code") %></a>--%>
                                                                    <a href='viewRequistionStatus.aspx?id=<%# Eval("id") %>' class="link05"><img src="../images/view.png" width="17" height="17" border="0"></a>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                        </Columns>
                                                    </asp:GridView>
