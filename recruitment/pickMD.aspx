<%@ Page Language="C#" AutoEventWireup="true" CodeFile="pickMD.aspx.cs" Inherits="Leave_admin_pickemployee"
...
<head runat="server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        function returnempcode(val, val2) {
           ...
           // alert(val);
           // alert(val2);
            window.opener.document.getElementById("txtMD").value = val2;
            window.opener.document.getElementById("hf_mdcode").value = val;
            window.opener.focus();
            window.close();
        }
