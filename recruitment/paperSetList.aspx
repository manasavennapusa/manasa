<%@ Page Language="C#" AutoEventWireup="true" CodeFile="paperSetList.aspx.cs" Inherits="recruitment_paperSetList" %>
            ...
            <table width="100%" cellpadding="0" cellspacing="0" border="0">
                ...
                <tr>
                    <td class="frm-rght-clr123 border-bottom" width="25%">
                        <asp:DropDownList ID="ddl_paper" runat="server" CssClass="blue1" Width="142px" Height="25px" OnSelectedIndexChanged="ddl_paper_SelectedIndexChanged" AutoPostBack="true">
                        </asp:DropDownList>
                    </td>
                    <td class="frm-rght-clr123 border-bottom" width="25%">
                ...
                <tr>
                    <td colspan="4">
                        <asp:GridView ID="grdpaper" runat="server" AutoGenerateColumns="False" Width="100%"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="PPR CODE">
                                    <ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="QUESTIONS">
                                    <ItemTemplate>
                                        <asp:Label ID="lblQUES" runat="server" Text='<%# Eval("noofquestion") %>'></asp:Label>
                                    </ItemTemplate>
                                    <HeaderStyle CssClass="frm-lft-clr123" Width="17%" />
                                    <ItemStyle CssClass="frm-rght-clr1234"></ItemStyle>
                                </asp:TemplateField>
