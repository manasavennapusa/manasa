<%@ Page Language="C#" AutoEventWireup="true" CodeFile="interviewPanelList.aspx.cs"
    Inherits="recruitment_interviewPanelList" %>
            ...
            <table width="100%" cellpadding="0" cellspacing="0" border="0">
                    ...
                    <td valign="top" class="blue-brdr-1" colspan="4">
                        <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                            <tr>
                                ...
                                <td class="txt01">INTERVIEW PANEL
                                </td>
                                <td align="right">
                ...
                <tr>
                    <td class="frm-rght-clr123 border-bottom" width="25%">
                        <asp:DropDownList ID="ddl_panel" runat="server" CssClass="blue1" Width="142px" Height="20px">
                        </asp:DropDownList>
                    </td>
                    <td class="frm-lft-clr123">Subject Names:
                    </td>
                    <td class="frm-rght-clr123 border-bottom" width="25%">
                ...
                <tr>
                    <td colspan="5">
                        <asp:GridView ID="grdPanel" runat="server" AutoGenerateColumns="False" Width="100%"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Resource Names">
                                    <ItemTemplate>
