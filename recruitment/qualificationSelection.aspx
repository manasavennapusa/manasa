<%@ Page Language="C#" AutoEventWireup="true" CodeFile="qualificationSelection.aspx.cs"
    Inherits="recruitment_qualificationSelection" %>
    ...
    <form id="form1" runat="server">
        ...
        <div>
            <table width="100%" cellpadding="0" cellspacing="0" border="0">
                    ...
                    <td valign="top" class="blue-brdr-1" colspan="4">
                        <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                            <tr>
                                ...
                                <td class="txt01">QUALIFICATION SELECTION DIALOG BOX
                                </td>
                                <td align="right">
                        ...
                        <asp:GridView ID="grdQualification" runat="server" AutoGenerateColumns="False" Width="100%"
                            ...
                            <Columns>
                                <asp:TemplateField HeaderText=" Qualification">
                                    <ItemTemplate>
                                        <asp:CheckBox ID="chkQualification" runat="server" />
                                    </ItemTemplate>
                                    <HeaderStyle CssClass="frm-lft-clr123" Width="50%" />
                ...
                <tr>
                    <td colspan="4" width="100%" class="frm-rght-clr123 border-bottom ">
                        <table width="100%" cellpadding="0" cellspacing="0" border="0">
                            <tr>
                                <td>&nbsp;
