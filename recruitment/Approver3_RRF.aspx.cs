...
public partial class recruitment_approver3_RRF : System.Web.UI.Page
{
    ...
    protected void bind_RRF()
    {
        ...
        DataSet ds = new DataSet();
        ds = DBTask.ExecuteDataset(ConfigurationManager.ConnectionStrings["intranetConnectionString"].ConnectionString.ToString(), CommandType.StoredProcedure, "sp_recruitment_get_RRFs_by_approver3", sqlparam);
    ...
    protected void btn_Approve_Click(object sender, EventArgs e)
    {
        ...
        //DataSet ds = new DataSet();
        int i = DBTask.ExecuteNonQuery(ConfigurationManager.ConnectionStrings["intranetConnectionString"].ConnectionString.ToString(), CommandType.StoredProcedure, "sp_recruitment_update_approver3", sqlParam);
        ...
        Response.Redirect("approver3_RRF.aspx?Approved=RRF" + id);
        //int id = Convert.ToInt32(Request.QueryString["id"]);
        //string sqlstr = "update tbl_recruitment_requisition_form set approver2_status='A' where id='" + id + "'";
        //DataSet ds = new DataSet();
    ...
    protected void btn_reject_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            int i = DBTask.ExecuteNonQuery(ConfigurationManager.ConnectionStrings["intranetConnectionString"].ConnectionString.ToString(), CommandType.StoredProcedure, "sp_recruitment_Reject_approver3", sqlParam);

            RecruitmentApprovers objEmail = new RecruitmentApprovers();
            SendEmailLM(objEmail.GetRRFId(id));

            Response.Redirect("approver3_RRF.aspx?Rejected=RRF" + id);
        }
    ...
    {
        Response.Redirect("approver3_RRF.aspx");
    }
