<%@ Page Language="C#" AutoEventWireup="true" CodeFile="approver3_RRF.aspx.cs" Inherits="recruitment_approver3_RRF" %>
                                            ...
                                            <asp:GridView ID="grdRRF" runat="server" AutoGenerateColumns="False" EmptyDataText="No Data Found."
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText=" View">
                                                        <ItemTemplate>
                                                            <a href='approver3_RRF.aspx?id=<%# Eval("id") %>' class="link05"><%# Eval("rrf_code") %></a>
