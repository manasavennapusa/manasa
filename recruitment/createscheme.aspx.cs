...
public partial class createscheme : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            if (Request.QueryString["id"] != null)
            {
                ...
                lblheader.Text = "EDIT SCHEME";
            }
            else
            {
                btnadd.Text = "Add";
                btnclear.Text = "Clear";
                lblheader.Text = "CREATE SCHEME";
            }
        }
    ...
    protected void btnclear_Click(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] != null)
        {
            Response.Redirect("schemeList.aspx");
        }
    ...
    protected void update_Round()
    {
        ...
        //    Response.Redirect("schemeList.aspx?updated=true");
        //    cleartext();
        //}
    }
    ...
    private void cleartext()
    {
        txt_schemename.Text = "";
        txt_time.Text = "";
        //ddl_roundtype.SelectedValue = "";
        ddl_Prority.SelectedValue = "";
