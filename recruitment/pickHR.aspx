<%@ Page Language="C#" AutoEventWireup="true" CodeFile="pickHR.aspx.cs" Inherits="Leave_admin_pickemployee"
...
<head runat="server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        function returnempcode(val, val2) {
           ...
           // alert(val);
           // alert(val2);
            window.opener.document.getElementById("txtHR").value = val2;
            window.opener.document.getElementById("hf_hrcode").value = val;
            window.opener.focus();
            window.close();
