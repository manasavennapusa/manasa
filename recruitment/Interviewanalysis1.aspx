<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Interviewanalysis1.aspx.cs" Inherits="recruitment_Interviewanalysis1" %>
                    ...
                    <div class="span12">
                        <div class="widget no-margin">
                            <div class="widget-header">
                                <div class="title">
                                    <span class="fs1" aria-hidden="true" data-icon="&#xe14c;"></span>CANDIDATES SELECTED IN ROUND 1
                                </div>
                    ...
                    <div class="span12">
                        <div class="widget">
                            ...
                            <div class="widget-body">
                                <table class="table table-condensed table-bordered no-margin">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td style="border-bottom:1px solid #e0e0e0" runat="server">
                                        ...
                                        <tr style="background-color:#f2f2f2" runat="server">
                                            <td style="background-color:#f2f2f2" runat="server"><b>HR</b></td>
                                            <td style="border-right:none; border-left:none; background-color:#f2f2f2" runat="server"></td>
                                            <td style="border-right:none; border-left:none; background-color:#f2f2f2" runat="server"></td>
                                            <td style="border-right:none; border-left:none; background-color:#f2f2f2" runat="server"></td>
                                            <td style="border-right:none; border-left:none; background-color:#f2f2f2" runat="server"></td>
                                            <td style="border-right:none; border-left:none; background-color:#f2f2f2" runat="server"></td>
                                        ...
                                        <tr>
                                            ...
                                            <td runat="server" style="border-bottom:none">
                                        ...
                                        <tr>
                                            ...
                                            <td runat="server" style="border-bottom:none; border-top:none">
                                        ...
                                        <tr>
                                            ...
                                            <td runat="server" style="border-top:none">
                                ...
                                <div class="form-actions no-margin" style="padding-left:600px" runat="server">
                                    <asp:Button ID="btnInsert" runat="server" Text="Submit" CssClass="btn btn-info" OnClick="btnInsert_Click" OnClientClick="return validaterating();"  />&nbsp;&nbsp;
