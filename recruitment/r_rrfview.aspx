<%@ Page Language="C#" AutoEventWireup="true" CodeFile="r_rrfview.aspx.cs" Inherits="recruitment_r_rrfview" %>
                        ...
                        <div class="widget">
                            ...
                            <div class="widget-body">
                                <div id="wizard">
                                    ...
                                    <div>
                                        <p>
                                            <asp:GridView ID="grdConfirmed" runat="server" AutoGenerateColumns="False" AllowSorting="True"
                                    ...
                                    <div>
                                        <p>
                                            <asp:GridView ID="grdprocess" runat="server" AutoGenerateColumns="False" AllowSorting="True"
                                                EmptyDataText="No data Found." CssClass="table table-condensed table-striped  table-bordered pull-left">
                                                <Columns>
                                                    <asp:TemplateField HeaderText="Candidate Name">
                                                        <ItemTemplate>
                                    ...
                                    <div>
                                        <p>
                                            <asp:GridView ID="grdRejectedcandidates" runat="server" AutoGenerateColumns="False" CaptionAlign="Left" AllowSorting="True"
                                                EmptyDataText="No Data Found." CssClass="table table-condensed table-striped  table-bordered pull-left">
                                                <Columns>
                                                    <asp:TemplateField HeaderText="Candidate Name">
                                                        <ItemTemplate>
