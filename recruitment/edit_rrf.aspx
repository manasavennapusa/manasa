<%@ Page Language="C#" AutoEventWireup="true" CodeFile="edit_rrf.aspx.cs" Inherits="recruitment_edit_rrf" %>
                ...
                <ContentTemplate>
                    ...
                    <div class="main-container">
                        <div class="page-header">
                            <div class="pull-left">
                                <%--<h2>RECRUITMENT REQUISITION FORM<%--<asp:Label ID="lblheader" runat="server"></asp:Label></h4></div>--%>
                                <h2>Edit Recruitment Requisition Form</h2>
                                <br />
                                ...
                                <div class="widget">
                                    ...
                                    <div class="widget-body">
                                        ...
                                        <div class="span6">
                                            <div class="control-group">
                                                <label class="control-label">
                                                    Total No of Posts<span class="star"></span>
                                                </label>
                                                <div class="controls controls-row">
                                                    <asp:TextBox ID="txt_Posts" runat="server" CssClass="span10"  onkeypress="return isNumber()"></asp:TextBox>
                                            ...
                                            <div class="control-group">
                                                <label class="control-label">
                                                    Vacancy Type<span class="star"></span>
                                                </label>
                                                <div class="controls controls-row">
                                            ...
                                            <div class="control-group">
                                                <label class="control-label">
                                                    Reasons of Request<span class="star"></span>
                                                </label>
                                                <div class="controls controls-row">
                                            ...
                                            <div class="control-group">
                                                <label class="control-label">
                                                    Industries Preferred<span class="star"></span>
                                                </label>
                                                <div class="controls controls-row">
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="controls controls-row">
                                                    ...
                                                    <a href="JavaScript:newPopup1('PickSkills.aspx');" class="btn btn-small btn-primary hidden-tablet hidden-phone" style="margin-left: 5px; margin-top:10px">Select</a>
                                            ...
                                            <div class="control-group">
                                                <label class="control-label">
                                                    Educational Qualifications<span class="star"></span>
                                                </label>
                                                <div class="controls controls-row">
                                                    ...
                                                    &nbsp;  <a href="JavaScript:newPopup1('pickQualification.aspx');" class="btn btn-small btn-primary hidden-tablet hidden-phone" style="margin-left: 5px; margin-top:-9px"">Select </a>
                                        ...
                                        <div class="span6">
                                            <div class="control-group">
                                                <label class="control-label">
                                                    Request Type<span class="star"></span>
                                                </label>
                                                <div class="controls controls-row">
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="controls controls-row">
                                                    <asp:DropDownList ID="ddl_location" runat="server" CssClass="span10" AutoPostBack="true" OnSelectedIndexChanged="ddl_location_SelectedIndexChanged">
                                                    </asp:DropDownList>
                                                </div>
                                            </div>
                                               <div class="control-group">
                                                <label class="control-label">
                                                    Department Type<span class="star"></span>
                                                </label>
                                                <div class="controls controls-row">
                                            ...
                                            <div class="control-group" id="abc" runat="server" visible="false">
                                                <label class="control-label">
                                                    Cost Center
                                                </label>
                                                <div class="controls controls-row">
                                            ...
                                            <div class="control-group">
                                                <label class="control-label">
                                                    Experience (In Years)<span class="star"></span>
                                                </label>
                                                <div class="controls controls-row">
                                                    ...
                                                    <asp:RegularExpressionValidator ID="RegularExpressionValidator5" ControlToValidate="txt_experience"
                                                        ValidationGroup="rrf" runat="server" ValidationExpression="^[0-9\:\-\s]+$" ToolTip="Enter only Numbers"
                                                        ErrorMessage='<img src="../images/error1.gif" alt=""  />'></asp:RegularExpressionValidator>
                                                    <%--<asp:RequiredFieldValidator ID="RequiredFieldValidator13" runat="server" ControlToValidate="txt_experience"
                                                        Display="Dynamic" ErrorMessage='<img src="images/error1.gif" alt="" />' ToolTip="Enter Experience"
                                                        ValidationGroup="rrf" Width="6px" SetFocusOnError="True"><img src="../images/error1.gif" alt="" /></asp:RequiredFieldValidator>--%>
                                            ...
                                            <div class="control-group">
                                                <label class="control-label">
                                                    Additional Qualifications<span class="star"></span>
                                                </label>
                                                <div class="controls controls-row">
                                                ...
                                                ErrorMessage='<img src="../images/error1.gif" alt=""  />'></asp:RegularExpressionValidator>
                                                    --%><asp:RequiredFieldValidator ID="RequiredFieldValidator14" runat="server" ControlToValidate="txt_additionalqualifiers"
                                                        Display="Dynamic" ErrorMessage='<img src="images/error1.gif" alt="" />' ToolTip="Enter Additional Qualifications"
                                                        ValidationGroup="rrf" Width="6px" SetFocusOnError="True"><img src="../images/error1.gif" alt="" /></asp:RequiredFieldValidator>
                                                </div>
                                            </div>
                                            ...
                                            <div class="control-group">
                                                <label class="control-label">
                                                    Job Description<span class="star"></span>
                                                </label>
                                                <div class="controls controls-row">
                        ...
                        <div class="row-fluid">
                            <div class="span12">
                                ...
                                <asp:Button ID="btn_Submit" runat="server" Text="Update" CssClass="btn btn-info" ValidationGroup="rrf" OnClick="btn_Submit_Click" />&nbsp;&nbsp;&nbsp;
                                <asp:Button ID="btnclear" runat="server" Text="Reset" CssClass="btn btn-info" OnClick="btnclear_Click" />
                            </div>
                                </div>
