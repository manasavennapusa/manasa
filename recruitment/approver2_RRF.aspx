<%@ Page Language="C#" AutoEventWireup="true" CodeFile="approver2_RRF.aspx.cs" Inherits="recruitment_approver2_RRF" %>
            ...
            <asp:UpdatePanel ID="updatepanel1" runat="server" UpdateMode="Always">
                <ContentTemplate>
                    ...
                    <div class="main-container">
                            ...
                            <div class="span12">
                                <div class="widget no-margin">
                                    <div class="widget-header">
                                        <div class="title">
                                            <span class="fs1" aria-hidden="true" data-icon="&#xe14a;"></span>RECRUITMENT REQUISITIION FORMS                                     
                                        </div>
                                    </div>
                                    <div class="widget-body">
                                        <div id="dt_example" class="example_alt_pagination">
                                            <asp:GridView ID="grdRRF" runat="server" AutoGenerateColumns="False" AllowSorting="True" EmptyDataText="No Data Found."
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText=" View">
                                                        <ItemTemplate>
                                                            <a href='approver2_RRF.aspx?id=<%# Eval("id") %>' class="link05"><%# Eval("rrf_code") %></a>
                        ...
                        <div id="tbl_status" runat="server" visible="false">
                            <div class="row-fluid">
                                <div class="span12">
                                    <div class="widget">
                                        ...
                                        <div class="form-actions no-margin">
                                            <asp:Button ID="btn_Approve" runat="server" Text="Approve" CssClass="btn btn-primary" OnClick="btn_Approve_Click" />
                                            <asp:Button ID="btn_reject" runat="server" Text="Reject" CssClass="btn btn-danger" OnClick="btn_reject_Click" ValidationGroup="rrf" />
                                            <asp:Button ID="btn_back" runat="server" Text="Back" CssClass="btn" OnClick="btn_back_Click" />
                                        </div>
                                    </div>
