...
public partial class recruitment_InterviewAnalysis2 : System.Web.UI.Page
{
    string UserCode;
    ...
    protected void bindDetails()
    {
        ...
        string sqlstr1 = "select * from tbl_recruitment_interviewrrating2 where Candidate_id='" + Request.QueryString["id"].ToString() + "'";
    ...
    {
        Response.Redirect("~/recruitment/round2candidates.aspx");
    }
    ...
    protected void InsertFeedback()
    {
        ...
        try
        {
            ...
            i = SQLServer.ExecuteNonQuery(ConfigurationManager.ConnectionStrings["intranetConnectionString"].ConnectionString.ToString(), CommandType.StoredProcedure, "sp_recruitment_insert_InterviewRating2", sqlParam);
            //if (i < 0)
            //{
            ...
            //{
            //    //cleartext();
            //    Response.Redirect("~/recruitment/round2candidates.aspx?Submit=True");
            //}
        }
        catch (Exception ex)
        {
