<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PickBH.aspx.cs" Inherits="recruitment_PickBH" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        function returnempcode(val, val2) {
            ...
            // alert(val);
            // alert(val2);
            window.opener.document.getElementById("txtBH").value = val2;
            window.opener.document.getElementById("hf_bhcode").value = val;
            window.opener.focus();
            window.close();
