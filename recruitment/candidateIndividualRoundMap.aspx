<%@ Page Language="C#" AutoEventWireup="true" CodeFile="candidateIndividualRoundMap.aspx.cs"
    Inherits="recruitment_candidateIndividualRoundMap" %>
    ...
    <form id="form1" runat="server">
        ...
        <div>
            <table width="100%" cellpadding="0" cellspacing="0" border="0">
                    ...
                    <td valign="top" class="blue-brdr-1" colspan="4">
                        <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                            <tr>
                                ...
                                <td class="txt01">CANDIDATES ROUNDS MAP
                                </td>
                                <td align="right">
                ...
                <tr>
                    <td class="frm-rght-clr123 border-bottom" width="25%">RRF Number
                    </td>
                    <td class="frm-rght-clr123 border-bottom" width="25%">
                        <asp:Label ID="lblrrfno" runat="server"></asp:Label>
                    </td>
                    <td class="frm-rght-clr123 border-bottom" width="25%">Scheme Name
                    </td>
                    <td class="frm-rght-clr123 border-bottom " width="25%">
                        ...
                        <asp:GridView ID="grdgroupscheme" runat="server" AutoGenerateColumns="False" Width="100%"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Panel/PaperId">
                                    <ItemTemplate>
                                        <asp:DropDownList ID="lbl4" runat="server" Width="80px"></asp:DropDownList>
                                    </ItemTemplate>
                                    <HeaderStyle CssClass="frm-lft-clr123" Width="15%" />
                                    <ItemStyle CssClass="frm-rght-clr1234"></ItemStyle>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Access Key">
                                    <ItemTemplate>
                                        <asp:TextBox ID="lbl5" runat="server"></asp:TextBox>
                                    </ItemTemplate>
                                    <HeaderStyle CssClass="frm-lft-clr123" Width="15%" />
                                    <ItemStyle CssClass="frm-rght-clr1234"></ItemStyle>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Attandence">
                                    <ItemTemplate>
