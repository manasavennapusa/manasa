<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DepartmentwiseorQTreport.aspx.cs" Inherits="Query_DepartmentwiseorQTreport" %>
                        ...
                        <div class="widget">
                            <div class="widget-header" style="border-bottom: none;">
                                <div class="title">
                                    ...
                                    Query Report Department wise Or Query Type wise
                                </div>
                            </div>
                                ...
                                <div id="dt_example" class="example_alt_pagination">
                                    ...
                                    <asp:GridView ID="gvQueryReport" runat="server" Width="100%" AutoGenerateColumns="False"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField>
                                                <ItemTemplate>
                                                    <a href="QueryReportDetails.aspx?id=<%#DataBinder.Eval(Container.DataItem, "id")%>"
                                                        target="_self">View</a>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                        </Columns>
