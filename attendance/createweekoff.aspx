<%@ Page Language="C#" AutoEventWireup="true" CodeFile="createweekoff.aspx.cs" Inherits="attendance_createweekoff" %>
                                    ...
                                    <div class="widget-body">
                                        <fieldset>
                                            ...
                                            <div class="form-actions no-margin">
                                                <asp:Button ID="btnsbmit" runat="server" Text="Submit" CssClass="btn btn-info pull-right pull-right" OnClick="btnsbmit_Click" OnClientClick="return ValidateData();" ToolTip="Click here to submit the new holiday" />
                                                <asp:Button ID="btn_reset" runat="server" CssClass="btn btn-info pull-right pull-right" ValidationGroup="nothing" Text="Reset" OnClick="btn_reset_Click" />
                                            </div>
                                        </fieldset>
                                    </div>
                                </div>
