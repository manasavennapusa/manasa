<%@ Page Language="C#" AutoEventWireup="true" CodeFile="uploadempipmachinecodemapping.aspx.cs" Inherits="attendance_uploadempipmachinecodemapping" %>
                                        ...
                                        <div class="widget-body">
                                            <fieldset>
                                                ...
                                                <div class="form-actions no-margin">
                                                    <asp:Button ID="btnSubmit" runat="server" OnClick="btnUpload_Click" Text="Upload" CssClass="btn btn-primary" />
                                                </div>
                                            </fieldset>
                                        </div>
                                    </div>
