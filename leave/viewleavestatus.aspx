<%@ Page Language="C#" AutoEventWireup="true" CodeFile="viewleavestatus.aspx.cs" Inherits="leave_viewleavestatus" %>
                                    ...
                                    <div class="widget-body">
                                        <div id="dt_example" class="example_alt_pagination">
                                            <asp:GridView ID="leave_approval_grid" runat="server" AutoGenerateColumns="False" DataKeyNames="id"
                                                DataSourceID="SqlDataSource2" OnPreRender="leave_approval_grid_PreRender" CssClass="table table-striped table-bordered table-hover table-checkable table-responsive datatable">
                                                <Columns>
