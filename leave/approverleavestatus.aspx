<%@ Page Language="C#" AutoEventWireup="true" CodeFile="approverleavestatus.aspx.cs" Inherits="leave_approverleavestatus" %>
                                ...
                                <div class="widget no-margin">
                                    <div class="widget-header">
                                        <div class="title">
                                            ...
                                            <asp:Label ID="Label1" runat="server" Text="Leave Status"></asp:Label>
                                        </div>
                                    </div>
                                    <div class="widget-body">
                                        <div id="dt_example" class="example_alt_pagination">
                                            <asp:GridView ID="leave_approval_grid" runat="server" EmptyDataText="no records found!!." AutoGenerateColumns="False" DataSourceID="SqlDataSource2" DataKeyNames="id"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Leave Type" HeaderStyle-Width="20%">
                                                        <ItemTemplate>
                                                            <asp:Label ID="leavename" runat="server" Text='<%# Bind("leavename") %>'></asp:Label>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                            ...
                                            <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>"
                                                ProviderName="System.Data.SqlClient" SelectCommand="sp_leave_fetchleavesummary_approver"
