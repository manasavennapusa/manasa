                                    ...
                                    <div class="widget-body">
                                        <fieldset>
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="controls span3">
                                                    <asp:Label ID="lbl_nod" runat="server"></asp:Label>
                                                </div>
                                            </div>
                                        </fieldset>
                                    </div>
                                    ...
                                    <div class="widget-body">
                                        <fieldset>
                                            ...
                                            <div class="form-actions no-margin">
                                                <asp:Button ID="btn_modify" runat="server" CssClass="btn btn-info pull-right" Style="margin-right: 5px" Text="Change Date" OnClick="btn_modify_Click" />&nbsp;
                                                <asp:Button ID="txt_cancel" runat="server" CssClass="btn btn-danger pull-right" Style="margin-right: 5px" Text="Cancel leave" OnClick="btn_cancel_Click" />
                                            </div>
                                        </fieldset>
                                    </div>
                                </div>
