...
public partial class leave_picemployeresigned : System.Web.UI.Page
{
    ...
    protected void bindempdetail()
    {
        ...
        try
        {
            ...
            string query = "sp_leave_fetch_emp_detail3_resigned";
            ...
            Common.Console.Output.AssignParameter(p, 3, "@status", "String", 50, "2");
    ...
    protected void ddl_branch_DataBound1(object sender, EventArgs e)
    {
        ddl_branch.Items.Insert(0, new ListItem("All", "0"));
    }
