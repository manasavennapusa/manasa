...
public partial class leave_comofdetailsreport : System.Web.UI.Page
{
    string sqlstr;
    ...
    protected void fetchleavedetail()
    {
        try
        {
            ...
            ds = SQLServer.ExecuteDataset(connection, CommandType.StoredProcedure, "[sp_Compoff_showempleave_audit]", sqlparm);
    ...
    protected void btn_export_Click(object sender, EventArgs e)
    {
        if (grid_leave.Rows.Count > 0)
        {
            ...
            Response.Charset = "";
            string FileName = "CompoffReport" + DateTime.Now + ".xls";
