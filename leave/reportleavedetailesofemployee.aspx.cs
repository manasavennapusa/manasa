...
public partial class leave_reportleavedetailesofemployee : System.Web.UI.Page
{
    string sqlstr;
    ...
    protected void fetchleavedetail()
    {
        try
        {
            ...
            ds = SQLServer.ExecuteDataset(connection, CommandType.StoredProcedure, "[sp_leave_showempleave_audit]", sqlparm);
