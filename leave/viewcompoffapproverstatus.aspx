<%@ Page Language="C#" AutoEventWireup="true" CodeFile="viewcompoffapproverstatus.aspx.cs" Inherits="leave_viewcompoffapproverstatus" %>
<!DOCTYPE html>
                                        ...
                                        <fieldset>
                                            ...
                                            <div class="form-actions no-margin" style="display:none">
                                                <asp:Button ID="btn_approve" runat="server" Style="margin-right: 5px" CssClass="btn btn-info pull-right" OnClick="btn_approve_Click"
                                                    Text="Approve" />&nbsp;&nbsp;<asp:Button ID="btn_backuser" Style="margin-right: 5px" runat="server" CssClass="btn btn-info pull-right" Visible="false" OnClick="btn_backuser_Click"
