<%@ Page Language="C#" AutoEventWireup="true" CodeFile="picemployeresigned.aspx.cs" Inherits="leave_picemployeresigned" %>
                        ...
                        <div class="widget no-margin">
                            <div class="widget-header">
                                <div class="title">
                                    ...
                                    <span class="fs1" aria-hidden="true" data-icon="&#xe14a;"></span>Resigned Employees
                            ...
                            <div class="widget-body">
                                <fieldset>
                                    <div class="control-group">
                                        <label class="control-label" style="">Work Location</label>
                                        <div class="controls ">
                                            <asp:DropDownList ID="ddl_branch" runat="server" CssClass="span3" Width="220px" Height=""
                                                DataSourceID="sql_data_branch" DataTextField="branch_name" DataValueField="Branch_Id" OnDataBound="ddl_branch_DataBound1"
                                    ...
                                    <asp:GridView ID="empgrid" runat="server" DataKeyNames="empcode"
                                        ...
                                        <Columns>
                                            <asp:TemplateField HeaderText="Employee Code" HeaderStyle-Width="24%">
                                                <ItemTemplate>
                                                    <a href="javascript:returnempcode('<%# DataBinder.Eval(Container.DataItem, "empcode") %>')" id="lblempcode" class="link05" style="color:#2b97c1"><%# DataBinder.Eval(Container.DataItem, "empcode") %></a>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField HeaderText="Employee Role">
                                             ...
                                             <asp:TemplateField HeaderText="Resigned date" HeaderStyle-Width="24%">
                                                <ItemTemplate>
                                                    <asp:Label ID="l4" runat="server" Text='<%# Bind ("Resigned_date") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                        </Columns>
                                    </asp:GridView>
