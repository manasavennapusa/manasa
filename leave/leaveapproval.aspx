<%@ Page Language="C#" AutoEventWireup="true" CodeFile="leaveapproval.aspx.cs" Inherits="leave_leaveapproval" %>
                                ...
                                <div class="widget no-margin">
                                    ...
                                    <div class="widget-body">
                                        <div id="dt_example" class="example_alt_pagination">
                                            <asp:GridView ID="leave_approval_grid" runat="server" EmptyDataText="no leave requests found!!."
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Leave Type">
                                                        ...
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblleavetype" runat="server" Text='<%# Bind("leavename")%>'></asp:Label>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                            ...
                                            <%--<asp:SqlDataSource ID="SqlDataSource1" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" runat="server" SelectCommand="sp_leave_fetchleavesummary" SelectCommandType="StoredProcedure">
                                                <SelectParameters>
