<%@ Page Language="C#" AutoEventWireup="true" CodeFile="leaveapprovalbyproxyapprover.aspx.cs" Inherits="leave_leaveapprovalbyproxyapprover" %>
                                ...
                                <div class="widget no-margin">
                                    ...
                                    <div class="widget-body">
                                        <div id="dt_example" class="example_alt_pagination">
                                            <asp:GridView ID="leave_approval_grid" runat="server"
                                                AutoGenerateColumns="False" DataSourceID="SqlDataSource1" DataKeyNames="id" CssClass="table table-striped table-bordered table-hover table-checkable table-responsive datatable" OnPreRender="leave_approval_grid_PreRender">
                                                <Columns>
                                            ...
                                            <asp:SqlDataSource ID="SqlDataSource1" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" runat="server" SelectCommand="sp_leave_fetchleavesummary_proxy" SelectCommandType="StoredProcedure">
                                                <SelectParameters>
