<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CmpoffApprovalStatus.aspx.cs" Inherits="leave_CmpoffApprovalStatus" %>
<!DOCTYPE html>
                                ...
                                <div class="widget no-margin">
                                    ...
                                    <div class="widget-body">
                                        <div id="dt_example" class="example_alt_pagination">
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Status">
                                                        ...
                                                        <ItemTemplate>
                                                            ...
                                                            <asp:Label ID="Label5" runat="server" Text='<%# Bind("leavestatus") %>' class="label label-success" Visible='<%#Eval("leavestatus").ToString()=="Approved"?true:false%>'></asp:Label>
                                           ...
                                           <%-- <asp:SqlDataSource ID="SqlDataSource1" ConnectionString="<%$ ConnectionStrings:intranetConnectionString %>" runat="server" SelectCommand="sp_leave_fetchcompoff_summary_status_approver" SelectCommandType="StoredProcedure">
                                                <SelectParameters>
