<%@ Page Language="C#" AutoEventWireup="true" CodeFile="comofdetailsreport.aspx.cs" Inherits="leave_comofdetailsreport" %>
                                            ...
                                            <Columns>
                                               ...
                                               <%-- <asp:TemplateField HeaderText="Leave Type" HeaderStyle-Width="15%">
                                                ...
                                                <asp:TemplateField HeaderText="Comments" HeaderStyle-Width="50%">
                                                    <ItemTemplate>
                                                        <asp:Label ID="l7" runat="server" Text='<%# Bind("comment") %>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                            </Columns>
                                            <RowStyle Height="5px" />
