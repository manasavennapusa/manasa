<%@ Page Language="C#" AutoEventWireup="true" CodeFile="reportoddetailsofemployee.aspx.cs" Inherits="leave_reportoddetailsofemployee" %>
                            ...
                            <div class="widget-body">
                                <fieldset>
                                    ...
                                    <div class="form-actions no-margin">
                                        <asp:Button ID="Button1" runat="server" CssClass="btn btn-info" Text="Search" OnClick="Button1_Click" OnClientClick="return ValidateData();" />
                    ...
                    <div class="row-fluid">
                        <div class="span12">
                            <div class="widget no-margin">
                                <div class="widget-header">
                                    <div class="title">
                                        <span class="fs1" aria-hidden="true" data-icon="&#xe14a;"></span>OD Details Report
                                    </div>
                                </div>
                                <div class="widget-body">
                                        ...
                                        <asp:GridView ID="grid_leave" runat="server" EmptyDataText="No records found!!" AutoGenerateColumns="False" CssClass="table table-condensed table-striped table-hover table-bordered pull-left" OnPreRender="grid_leave_PreRender">
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Comments" HeaderStyle-Width="50%">
                                                    <ItemTemplate>
                                                        <asp:Label ID="l8" runat="server" Text='<%# Bind("comment") %>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                            </Columns>
                                            <RowStyle Height="5px" />
