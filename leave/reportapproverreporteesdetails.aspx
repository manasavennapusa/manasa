<%@ Page Language="C#" AutoEventWireup="true" CodeFile="reportapproverreporteesdetails.aspx.cs" Inherits="leave_reportapproverreporteesdetails" %>
            ...
            <div class="dashboard-wrapper" style="margin-left: 0px;">
                <div class="main-container">
                    ...
                    <div class="page-header">
                        <div class="pull-left">
                            <h2>Employee Reporting Details</h2>
                        </div>
                    ...
                    <div class="row-fluid">
                        <div class="span12">
                            <div class="widget no-margin">
                                <div class="widget-header">
                                    <div class="title">
                                        <span class="fs1" aria-hidden="true" data-icon="&#xe14a;"></span>Employee Reporting Details
                                    </div>
                                </div>
                                <div class="widget-body">
                                    <div id="dt_example" class="example_alt_pagination">
                                        <asp:GridView ID="empgrid" runat="server" EmptyDataText="No records found!!"
                                            CssClass="table table-hover table-striped table-bordered table-highlight-head" OnPreRender="empgrid_PreRender" AutoGenerateColumns="false">
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderStyle-Width="14%">
                                                    <ItemTemplate>
                                                        <a class="link05" href="javascript:void(window.open('myapprovers.aspx?empcode=<%#DataBinder.Eval(Container.DataItem, "empcode")%>&name=<%#DataBinder.Eval(Container.DataItem, "name")%>','title','height=300,width=500,left=200,top=20',resizable='no'));">Approver List</a>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
