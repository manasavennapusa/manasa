<%@ Page Language="C#" AutoEventWireup="true" CodeFile="hrcompoffupdate.aspx.cs" Inherits="leave_hrcompoffupdate" %>
    ...
    <form id="myForm" runat="server">
        <script type="text/javascript">
            function ValidateEmpcode() {
                ...
                if (empcode.value == "") {
                    alert("Please pick the Employee.");
                    return false;
                }
                return true;
            }
                            ...
                            <div class="row-fluid">
                                <div class="widget">
                                    <div class="widget-header">
                                        ...
                                        <div>
                                            <a href="#myModal" role="button" id="colink" runat="server" visible="false" class="btn btn-info pull-right" data-toggle="modal">Comp-off Status</a>
                                        </div>
                                    </div>
                                    <div class="widget-body">
                                        <fieldset>
                                    ...
                                    <div class="widget-body">
                                        <fieldset>
                                            ...
                                            <div class="form-actions no-margin">
                                                <asp:Button ID="btn_submit" runat="server" Style="margin-right: 5px;" CssClass="btn btn-success pull-right" Text="Update" OnClientClick="return CheckIsRepeat();" OnClick="btn_submit_Click1" ValidationGroup="v" Enabled="False" />
