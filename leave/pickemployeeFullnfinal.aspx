<%@ Page Language="C#" AutoEventWireup="true" CodeFile="pickemployeeFullnfinal.aspx.cs" Inherits="leave_pickemployeeFullnfinal" %>
                ...
                <div class="row-fluid">
                    <div class="span12">
                        <div class="widget no-margin">
                            ...
                            <div class="widget-body">
                                <div id="dt_example" class="example_alt_pagination" style="font-size:small">
                                    <asp:GridView ID="empgrid" runat="server" DataKeyNames="empcode" Font-Size="Small"
