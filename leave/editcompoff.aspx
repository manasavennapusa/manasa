<%@ Page Language="C#" AutoEventWireup="true" CodeFile="editcompoff.aspx.cs" Inherits="leave_editcompoff" %>
                                    ...
                                    <div class="widget-body">
                                        <fieldset>
                                            ...
                                            <div class="form-actions no-margin">
                                                <asp:Button ID="btn_submit" runat="server" CssClass="btn btn-success pull-right" style="margin-right:5px" Text="Update" OnClick="btn_submit_Click1" ValidationGroup="v" />
                                                <asp:Button ID="txt_cancel" runat="server" CssClass="btn btn-danger pull-right" style="margin-right:5px" OnClick="btn_cancel_Click"
                                                    Text="Cancel leave" />
