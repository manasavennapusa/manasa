<%@ Page Language="C#" AutoEventWireup="true" CodeFile="viewleaveapproverproxy.aspx.cs" Inherits="leave_viewleaveapproverproxy" %>
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField>
                                                        ...
                                                        <ItemTemplate>
                                                            ...
                                                            <asp:Label ID="Label8" runat="server" Text='<%# Bind("status") %>' class="label label-important" Visible='<%#Eval("status").ToString()=="Approved with Dotted Approver"?true:false%>'></asp:Label>
                                                            <asp:Label ID="Label10" runat="server" Text='<%# Bind("status") %>' class="label label-success" Visible='<%#Eval("status").ToString()=="Rejected by Dotted Approver"?true:false%>'></asp:Label>
                                    ...
                                    <div class="widget-body">
                                        <fieldset>
                                            ...
                                            <div class="form-actions no-margin">
                                                <asp:Button ID="btn_approve" runat="server" CssClass="btn btn-success pull-right " Style="margin-right: 5px" OnClick="btn_approve_Click"
                                                    Text="Approve" />&nbsp;&nbsp;
                                                <asp:Button ID="btn_backuser" runat="server" CssClass="btn btn-info pull-right " Style="margin-right: 5px" OnClick="btn_backuser_Click"
                                                    Text="Back to User" />&nbsp;&nbsp;
                                                ...
                                                <asp:HiddenField ID="hidd_approverid" runat="server" Value="0" />
                                            </div>
                                        </fieldset>
                                    </div>
                                </div>
