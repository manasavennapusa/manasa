<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Year_Ending_Report.aspx.cs" Inherits="leave_Year_Ending_Report" %>
            ...
            <div class="dashboard-wrapper" style="margin-left: 0px;">
                <div class="main-container">
                    ...
                    <div class="page-header">
                        <div class="pull-left">
                            <h2> My Year Ending Leave Reportees</h2>
                        </div>
                    ...
                    <div class="row-fluid">
                        <div class="span12">
                            <div class="widget no-margin">
                                <div class="widget-header">
                                    <div class="title">
                                        <span class="fs1" aria-hidden="true" data-icon="&#xe14a;"></span>My Year Ending Leave Reportees
                                    </div>
                                </div>
                                <div class="widget-body">
