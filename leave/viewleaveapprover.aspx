<%@ Page Language="C#" AutoEventWireup="true" CodeFile="viewleaveapprover.aspx.cs" Inherits="leave_viewleaveapprover" %>
                                    ...
                                    <div class="widget-body">
                                        <fieldset>
                                            ...
                                            <div class="form-actions no-margin">
                                                ...
                                                <asp:Button ID="btn_backuser" runat="server" CssClass="btn btn-info pull-right " Style="margin-right: 5px; display:none;" OnClick="btn_backuser_Click"
                                                    Text="Back to User" />&nbsp;&nbsp;
                                                <asp:Button ID="btn_cancel" runat="server" CssClass="btn btn-danger pull-right " Style="margin-right: 5px"
                                                 ...
                                                 <asp:Button ID="btn_approve" runat="server" CssClass="btn btn-success pull-right " Style="margin-right: 5px" OnClick="btn_approve_Click1"
                                                    Text="Approve"/>&nbsp;
