<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Linemanager_update_leave.aspx.cs" Inherits="leave_Linemanager_update_leave" %>
            ...
            <div class="dashboard-wrapper" style="margin-left: 0px;">
                <div class="main-container">
                    ...
                    <div class="page-header">
                        <div class="pull-left">
                            <h2>Leave Apply & Update by Manager </h2>
                        </div>
                    ...
                    <div class="row-fluid">
                        <div class="widget">
                            <div class="widget-header">
                                <div class="title">
                                    <span class="fs1" aria-hidden="true" data-icon="&#xe14a;"></span>Leave Apply & Updated by Manager 
                                </div>
                                ...
                                <fieldset>
                                    <div class="control-group">
                                        <div class="controls controls-row">
                                            ...
                                            <div class="controls span3">
                                                <a href="JavaScript:newPopup1('PickMangeremployee.aspx');"><i class="icon-user"></i>Pick Employee</a>
                                            </div>
                            ...
                            <div class="widget-body">
                                <fieldset>
                                    ...
                                    <div class="form-actions no-margin">
                                        <asp:Button ID="btn_submit" runat="server" CssClass="btn btn-success pull-right " Style="margin-right: 5px" Text="Update" OnClick="btn_submit_Click" OnClientClick="return ValidateLeave();" />
                                        <asp:Button ID="btn_reset" runat="server" CssClass="btn btn-info pull-right " Text="Reset" Style="margin-right: 5px" OnClick="btn_reset_Click" />
