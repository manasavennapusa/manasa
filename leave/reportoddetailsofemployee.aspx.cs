...
public partial class leave_reportoddetailsofemployee : System.Web.UI.Page
{
    string sqlstr;
    ...
    protected void fetchleavedetail()
    {
        try
        {
            ...
            ds = SQLServer.ExecuteDataset(connection, CommandType.StoredProcedure, "[sp_leave_showempod_audit]", sqlparm);
