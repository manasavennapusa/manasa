<%@ Page Language="C#" AutoEventWireup="true" CodeFile="viewodapprover.aspx.cs" Inherits="leave_viewodapprover" %>
                                        ...
                                        <fieldset>
                                            ...
                                            <div class="form-actions no-margin">
                                                <asp:Button ID="btn_approve" runat="server" CssClass="btn btn-success pull-right " Style="margin-right: 5px" OnClick="btn_approve_Click"
                                                    Text="Approve" />
                                                <asp:Button ID="btn_back" runat="server" CssClass="btn btn-info pull-right " Style="margin-right: 5px" Text="Back to user" OnClick="btn_back_Click" Visible="false" />
                                                <asp:Button ID="btn_cancel" runat="server" Text="Reject" CssClass="btn btn-danger pull-right " Style="margin-right: 5px" OnClick="btn_cancel_Click" />
