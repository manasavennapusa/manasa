<%@ Page Language="C#" AutoEventWireup="true" CodeFile="reportleaveregister.aspx.cs" Inherits="leave_reportleaveregister" %>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <asp:DropDownList ID="drp_leavestatus" runat="server" CssClass="span3" Width="">
                                                ...
                                                <asp:ListItem Selected="True" Value="6">Approved</asp:ListItem>
                    ...
                    <div class="row-fluid">
                        <div class="span12">
                            <div class="widget no-margin">
                                <div class="widget-header">
                                    <div class="title">
                                        <span class="fs1" aria-hidden="true" data-icon="&#xe14a;"></span>Leave Register
                                    </div>
                                </div>
                                <div class="widget-body">
                                    <div id="dt_example" class="example_alt_pagination">
                                        <asp:GridView ID="empleavegrid" runat="server" EmptyDataText="No records found!!" AutoGenerateColumns="False"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Emp Name" HeaderStyle-Width="18%">
                                                    <ItemTemplate>
                                                        <asp:Label ID="l2" runat="server" Text='<%# Bind ("ename") %>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="id" Visible="false" HeaderStyle-Width="5%">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblid" runat="server" Text='<%# Bind ("leaveid") %>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                ...
                                                <asp:TemplateField HeaderText="Department" HeaderStyle-Width="18%">
                                                    <ItemTemplate>
                                                        <asp:Label ID="l3" runat="server" Text='<%# Bind ("department") %>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                 <asp:TemplateField HeaderText="Leave Type" HeaderStyle-Width="20%">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblleave" runat="server" Text='<%# Bind ("leavetype") %>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                 <asp:TemplateField HeaderText="Date Range" HeaderStyle-Width="20%">
                                                    <ItemTemplate>
                                               ...
                                               <%-- <asp:TemplateField HeaderStyle-Width="10%">
                                                    <ItemTemplate>
                                                        <a class="link05" href="javascript:void(window.open('myleavedetails.aspx?id=<%#DataBinder.Eval(Container.DataItem, "leaveid")%>&status=<%=drp_leavestatus.SelectedValue%>&empcode=<%#DataBinder.Eval(Container.DataItem, "empcode")%>','title','height=300,width=500,left=200,top=20',resizable='no'));">View Detail</a>
                                                    </ItemTemplate>
                                                </asp:TemplateField>--%>
                                            </Columns>
                                            <RowStyle Height="5px" />
