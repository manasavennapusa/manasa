<%@ Page Language="C#" AutoEventWireup="true" CodeFile="createleavepolicy.aspx.cs" Inherits="leave_createleavepolicy" %>
                        ...
                        <div class="widget-body">
                            <fieldset>
                                ...
                                <div class="form-actions no-margin">
                                    <asp:Button ID="btnsubmit" runat="server"  ValidationGroup="v"  CssClass="btn btn-info  " Text="Submit" OnClick="btnsubmit_Click"  />&nbsp;&nbsp;
