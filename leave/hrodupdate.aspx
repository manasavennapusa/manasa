<%@ Page Language="C#" AutoEventWireup="true" CodeFile="hrodupdate.aspx.cs" Inherits="leave_hrodupdate" %>
                                    ...
                                    <div class="widget-body">
                                        <fieldset>
                                            ...
                                            <div class="form-actions no-margin">
                                                <asp:Button ID="btn_sbmit" runat="server" CssClass="btn btn-info pull-right " Text="Submit" OnClick="btn_sbmit_Click" OnClientClick="return ValidateOD();" />
