...
public partial class leave_ComoffRegistreReport : System.Web.UI.Page
{
    string strsql;
    ...
    DataSet GetLeave()
    {
        ...
        leave.no_of_days as nod
        from 
        tbl_intranet_employee_jobDetails emp  
        inner join 
        tbl_leave_apply_compoff leave on emp.empcode=leave.empcode
        ...
        where ((leave.fromdate>='" + sdate + "' and leave.todate<='" + edate + "')) and leave.leave_status=" + drp_leavestatus.SelectedValue;
        ...
        ,deg.designationname,dep.department_name,branch.branch_name,leave.no_of_days";
    ...
    protected void btn_export_Click(object sender, EventArgs e)
    {
        if (empleavegrid.Rows.Count > 0)
        {
            ...
            Response.Charset = "";
            string FileName = "CompoffRegisterReport" + DateTime.Now + ".xls";
