<%@ Page Language="C#" AutoEventWireup="true" CodeFile="viewcompoffhr.aspx.cs" Inherits="leave_viewcompoffhr" %>
                                    ...
                                    <div class="widget-body">
                                        <fieldset>
                                            ...
                                            <div class="form-actions no-margin">
                                                <asp:Button ID="btn_approve" Style="margin-right: 5px" runat="server" CssClass="btn btn-info pull-right" OnClick="btn_approve_Click"
                                                    Text="Update" />&nbsp;&nbsp;<asp:Button ID="btn_cancel" runat="server" CssClass="btn btn-info pull-right"
                                                        Text="Reset" Visible="false" Style="margin-right: 5px" />
                                            </div>
                                        </fieldset>
                                    </div>
                                </div>
