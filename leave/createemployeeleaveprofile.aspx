<%@ Page Language="C#" AutoEventWireup="true" CodeFile="createemployeeleaveprofile.aspx.cs" Inherits="leave_createemployeeleaveprofile" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        function ValidateLeaveProfile() {
            ...
            //if (empcode.value == "") {
            //    alert("Please pick the employee code");
            //    return false;
            //}
            //if (hrcode.value == "") {
                ...
                <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                    <ContentTemplate>
                                ...
                                <div class="widget-body">
                                    <fieldset>
                                        <div class="control-group">
                                            <label class="control-label span3">Employee Code<span class="star"></span></label>
                                            <div class="controls span5">
                                                <asp:TextBox ID="txt_employee" runat="server" CssClass="span3" Width="220px" Enabled="false" onkeypress="return isKey(event);" ondrop="return false;" onpaste="return false;"></asp:TextBox>&nbsp;&nbsp;
                                                       <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txt_employee"
                                                Display="Dynamic" ErrorMessage='<img src="../images/error1.gif" alt="" />' ToolTip="Please Enter Employee Name"
                                                ValidationGroup="v" Width="16px" SetFocusOnError="True"><img src="../images/error1.gif" alt="" /></asp:RequiredFieldValidator>
                                                &nbsp;
                                                <a href="JavaScript:newPopup1('PickEmployee.aspx');" title="Pick Employee" style="width:20px"><i class="icon-user"></i></a>
                                            </div>
                                            <div class=" span3"></div>
                                        </div>
                                    </fieldset>
                                ...
                                <div class="widget-body">
                                    <fieldset>
                                        <div class="control-group">
                                            ...
                                            <div class="controls span3">
                                                <asp:DropDownList ID="drp_policy" runat="server" CssClass="span3" Width="220px" OnDataBound="drp_policy_DataBound">
                                                </asp:DropDownList>
                                                  <asp:RequiredFieldValidator ID="requiredgender" runat="server" ValidationGroup="v" ControlToValidate="drp_policy"
                        ...
                        <div class="form-actions no-margin">
                            ...
                            <%--OnClientClick="return ValidateLeaveProfile()"--%>
                            <asp:Button ID="Button1" runat="server" CssClass="btn btn-info " Text="Reset" OnClick="btn_reset_Click" />
