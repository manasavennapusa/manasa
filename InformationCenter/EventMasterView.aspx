<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EventMasterView.aspx.cs" Inherits="InformationCenter_EventMasterView" %>
                                ...
                                <div class="widget-body">
                                    <fieldset>
                                        <div class="control-group">
                                            <a href="EventMasterView.aspx" class="link-red1">Today's Events</a> &nbsp;l&nbsp;
                    <a href="EventMasterView.aspx?news=1" class="link-red1">Date Wise Events</a>&nbsp;&nbsp;
                    <a href="EventMasterView.aspx?news=2" class="link-red1">Priority Wise Events</a> &nbsp;&nbsp;<asp:TextBox
                        ID="txtsearch" CssClass="blue1" Text="" runat="server" MaxLength="150" Width="241px"></asp:TextBox>
                                        ...
                                        <div class="control-group">
                                            <img src="../images/date-icon.png" width="10" height="10" alt="" runat="server"
                                                id="img1" />&nbsp;
                    <asp:Label ID="lbldate" runat="server" Text=""></asp:Label>
                        ...
                        <div class="row-fluid">
                            ...
                            <asp:GridView ID="Newsgrid" runat="server" AutoGenerateColumns="False" CellPadding="2"
                                ...
                                EmptyDataText="No Events has been posted today. Click on Datewise link to view more news"
                            ...
                            <asp:GridView ID="newsdatewise" runat="server" AutoGenerateColumns="False" CellPadding="2"
                                ...
                                OnPageIndexChanging="newsdatewise_PageIndexChanging" CssClass="table table-hover table-striped table-bordered table-highlight-head">
                                <Columns>
                                    <asp:BoundField DataField="heading" HeaderText="Heading" HeaderStyle-Width="30%"></asp:BoundField>
                                    <asp:BoundField DataField="description" HeaderText="Description" HeaderStyle-Width="30%"></asp:BoundField>
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="2">
                            <tr>
                                ...
                                <td width="18%">
                                    <asp:DropDownList ID="ddlcategory" CssClass="blue1" runat="server">
                                ...
                                <td width="68%">
                                    ...
                                    <span id="Span1" runat="server" enableviewstate="false" class="txt02"></span>
                                </td>
                            </tr>
                        </table>
                    </td>
                            ...
                            <div class="widget-body">
                                ...
                                <div class="widget-content">
                                    <div id="dt_example" class="example_alt_pagination">
                                        <asp:GridView ID="Newsgrid" runat="server" AutoGenerateColumns="False" DataKeyNames="id" ShowHeader="true" Width="100%"
                                            EmptyDataText="No Events has been posted today. Click on Datewise link to view more news"
                                            ToolTip="News posted"  OnPreRender="Newsgrid_PreRender"
                                            CssClass="table table-hover table-striped table-bordered table-highlight-head">
                                            <Columns>
                                                <asp:BoundField DataField="heading" HeaderText="Heading" HeaderStyle-Width="30%"></asp:BoundField>
                                                <asp:BoundField DataField="description" HeaderText="Description" HeaderStyle-Width="30%"></asp:BoundField>
                                ...
                                <div class="widget-content">
                                    <div id="dt_example1" class="example_alt_pagination">
                                        <asp:GridView ID="newsdatewise" runat="server" AutoGenerateColumns="False" DataKeyNames="id" ShowHeader="true" Width="100%"
                                            EmptyDataText="No news has been posted" ToolTip="News posted" AllowPaging="True" OnPreRender="newsdatewise_PreRender"
                                            CssClass="table table-hover table-striped table-bordered table-highlight-head">
                                            <Columns>
                                                <asp:BoundField DataField="heading" HeaderText="Heading" HeaderStyle-Width="30%"></asp:BoundField>
                                                <asp:BoundField DataField="description" HeaderText="Description" HeaderStyle-Width="30%"></asp:BoundField>
