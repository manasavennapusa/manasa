<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PolicyDockitView.aspx.cs" Inherits="InformationCenter_PolicyDockitView" %>
                                        ...
                                        <fieldset>
                                            <div class="control-group">
                                                <asp:TextBox ID="txtsearch"  CssClass="blue1" Text="" runat="server"
                                                     MaxLength="150" Width="241px" placeHolder="Search Policy Dockit"></asp:TextBox>
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField>
                                    <ItemTemplate>
                                        ...
                                        <a href="upload/policydockit/<%#DataBinder.Eval(Container.DataItem,"upload")%>"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField>
                                    <ItemTemplate>
                                        ...
                                        <a href="upload/policydockit/<%#DataBinder.Eval(Container.DataItem,"upload")%>"
                                            target="_blank">Download Policy Dockit </a>
