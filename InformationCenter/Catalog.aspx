<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Catalog.aspx.cs" Inherits="InformationCenter_Catalog" %>
                                    ...
                                    <fieldset>
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                              ...
                                              <%--  <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ToolTip="Enter Description" ControlToValidate="txtdescription"
                                                    Display="Dynamic" ErrorMessage="Enter Description" ValidationGroup="v" ForeColor="Red"><img src="../images/error1.gif" alt="Enter Description" /></asp:RequiredFieldValidator>--%>
                                            </div>
                                        </div>
                                        <div class="control-group">
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="form-actions no-margin">
                                                    <asp:Button ID="Button1" runat="server" CssClass="btn btn-primary" Text="Submit" OnClick="btnsubmit_Click"
                                                        ValidationGroup="v" />&nbsp;
                                            <asp:Button ID="Button2" runat="server" CssClass="btn btn-primary" Text="Reset" OnClick="btnreset_Click" />
                                                </div>
