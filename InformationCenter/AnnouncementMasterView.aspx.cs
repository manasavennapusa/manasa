...
public partial class InformationCenter_AnnouncementMasterView : System.Web.UI.Page
{
    string sqlstr;
    DataSet ds;
    ...
    protected void bindgrid()
    {
        try
        {
            sqlstr = "SELECT id,heading,description,(CASE WHEN posteddate='01/01/1900' THEN '' ELSE CONVERT(CHAR(15), posteddate, 106) END) posteddate,posteddate posteddate1,postedby FROM ANNOUNCEMENTS ORDER BY posteddate1 desc";
    ...
    //        {
    //            sqlstr = "";
    //            sqlstr = "SELECT id,heading,description,(CASE WHEN posteddate='01/01/1900' THEN '' ELSE CONVERT(CHAR(15), posteddate, 106) END) posteddate,posteddate posteddate1,postedby FROM ANNOUNCEMENTS WHERE 1=1";
