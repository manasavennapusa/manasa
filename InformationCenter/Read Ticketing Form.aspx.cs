...
public partial class InformationCenter_Read_Ticketing_Form : System.Web.UI.Page
{
    ...
    protected bool saverecords()
    {
        try
        {
            ...
            ds = DBTask.ExecuteDataset(ConfigurationManager.ConnectionStrings["intranetConnectionString"].ConnectionString.ToString(), CommandType.StoredProcedure, "intranet_insert_feedback_sp", newparameter);
            return true;
        }
    ...
    {
        sqlstr = "SELECT id,heading,description,postedby,posteddate FROM tbl_intranet_feedback ORDER BY posteddate desc";
    ...
    protected void griddetails_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        ...
        sqlstr = "DELETE FROM tbl_intranet_feedback WHERE id=" + code;
    ...
    protected void griddetails_RowUpdating(object sender, GridViewUpdateEventArgs e)
    {
        ...
        if (strname != "")
        {
            ...
            Response.Redirect("financialfi.aspx");
        ...
        else
        {
            ...
            Output.Show("Please enter Heading!");
