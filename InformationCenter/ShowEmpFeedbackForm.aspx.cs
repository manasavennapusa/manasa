...
public partial class InformationCenter_ShowEmpFeedbackForm : System.Web.UI.Page
{
...
createddate from tbl_intranet_employeesatisfactionsurvey where sno=" + Convert.ToInt32(Request.QueryString["sno"].ToString());
        ...
        //}
        bindemployee_detail(ds1.Tables[0].Rows[0]["empcode"].ToString());
    ...
    protected void bindemployee_detail(String empcode)
    {
