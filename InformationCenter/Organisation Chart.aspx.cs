...
public partial class InformationCenter_Organisation_Chart : System.Web.UI.Page
{
        ...
        try
        {
            if (Page.IsValid)
            {
                if (fupload.PostedFile.FileName.ToString() != "")
                {
                    ...
                    fupload.PostedFile.SaveAs(Server.MapPath("../InformationCenter/upload/organizationchart/" + file_name));
                ...
                else
                {
                    ...
                    Response.Redirect("Organisation Chart.aspx?update=true");                
    ...
    protected bool saverecords()
    {
        try
        {
            if (Convert.ToInt32(ViewState["flagedit"]) != 1)
            {
                ...
                ds = DBTask.ExecuteDataset(ConfigurationManager.ConnectionStrings["intranetConnectionString"].ConnectionString.ToString(), CommandType.StoredProcedure, "intranet_insert_organisation_sp", newparameter);
                return false;
            }
            if (Convert.ToInt32(ViewState["flagedit"]) == 1)
            {
                ...
                if (fupload.PostedFile.FileName.ToString() != "")
                {
                    ...
                    {
                        string file = Server.MapPath("../InformationCenter/upload/organizationchart/") + ds.Tables[0].Rows[0]["upload"].ToString();
               ...
               ds = DBTask.ExecuteDataset(ConfigurationManager.ConnectionStrings["intranetConnectionString"].ConnectionString.ToString(), CommandType.StoredProcedure, "intranet_update_organisation_sp", newparameter);
               return true;        
            }
            return true;
        }
    ...
    protected void griddetails_RowEditing(object sender, GridViewEditEventArgs e)
    {
        ...
        {
            dftlink1.HRef = "../InformationCenter/upload/organizationchart/" + ds.Tables[0].Rows[0]["upload"].ToString();
        ...
        //lbl_file.Text = "<a href='../InformationCenter/upload/organizationchart/" + ds.Tables[0].Rows[0]["upload"].ToString() + "'>" + ds.Tables[0].Rows[0]["upload"].ToString() + "</a>";
    }
    ...
    protected void reset()
    {
        ...
        lbl_file.Text = "";       
        ViewState.Remove("file_name");
        Response.Redirect("Organisation Chart.aspx");
    }
}