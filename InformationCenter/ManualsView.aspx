<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ManualsView.aspx.cs" Inherits="InformationCenter_ManualsView" %>
                        ...
                        <div class="main-container">
                                        ...
                                        <fieldset>
                                            <div class="control-group">
                                                <asp:TextBox ID="txtsearch"  CssClass="blue1" Text="" runat="server"
                                                     MaxLength="150" Width="241px" placeHolder="Search Manuals"></asp:TextBox>
                            ...
                            <div class="row-fluid">
                                ...
                                <div class="widget">
                                    ...
                                    <div class="widget-header">
                                        <div class="title">
                                            <span class="fs1" aria-hidden="true" data-icon="&#xe14a;"></span>Manuals             
                                        </div>
                                    </div>
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField>
                                    <ItemTemplate>
                                        ...
                                        <a href="upload/manuals/<%#DataBinder.Eval(Container.DataItem,"upload")%>"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField>
                                    <ItemTemplate>
                                        ...
                                        <a href="upload/manuals/<%#DataBinder.Eval(Container.DataItem,"upload")%>"
                                            target="_blank">Download Manuals </a>
