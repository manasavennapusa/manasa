...
public partial class InformationCenter_ISO_Documents : System.Web.UI.Page
{
        ...
        try
        {
            if (Page.IsValid)
            {
                if (fupload.PostedFile.FileName.ToString() != "")
                {
                    ...
                    fupload.PostedFile.SaveAs(Server.MapPath("../InformationCenter/upload/isodocuments/" + file_name));
                ...
                else
                {
                    ...
                    Response.Redirect("ISO Documents.aspx?update=true");
        ...
        try
        {
            ...
            if (Convert.ToInt32(ViewState["flagedit"]) == 1)
            {
                ...
                if (fupload.PostedFile.FileName.ToString() != "")
                {
                    ...
                    {
                        string file = Server.MapPath("../InformationCenter/upload/isodocuments/") + ds.Tables[0].Rows[0]["upload"].ToString();
    ...
    protected void griddetails_RowEditing(object sender, GridViewEditEventArgs e)
    {
        ...
        lbl_file.Text = "<a href='../InformationCenter/upload/isodocuments/" + ds.Tables[0].Rows[0]["upload"].ToString() + "'>" + ds.Tables[0].Rows[0]["upload"].ToString() + "</a>";
    }
