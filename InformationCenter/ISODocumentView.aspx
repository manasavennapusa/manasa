<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ISODocumentView.aspx.cs" Inherits="InformationCenter_ISODocumentView" %>
                        ...
                        <div class="main-container">
                            ...
                            <div class="row-fluid">
                                <div class="widget">
                                    <div class="widget-header">
                                        <div class="title">
                                            <span class="fs1" aria-hidden="true" data-icon="&#xe14a;"></span>ISO Document Details                 
                                        </div>
                                    </div>
                            ...
                            <div class="row-fluid">
                                ...
                                <div class="widget">
                                    ...
                                    <div class="widget-header">
                                        <div class="title">
                                            <span class="fs1" aria-hidden="true" data-icon="&#xe14a;"></span>ISO Documents  
                                        </div>
                                    </div>
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField>
                                    <ItemTemplate>
                                        ...
                                        <a href="upload/isodocuments/<%#DataBinder.Eval(Container.DataItem,"upload")%>"
                                            target="_blank">View/Download Product Information </a>
