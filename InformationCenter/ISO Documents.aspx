<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ISO Documents.aspx.cs" Inherits="InformationCenter_ISO_Documents" %>
                            ...
                            <div class="widget">
                                ...
                                <div class="widget-header">
                                    <div class="title">
                                        ...
                                        <asp:Label ID="lblhead" runat="server" Text="Creat"></asp:Label>
                                    </div>
                                </div>
                                    ...
                                    <fieldset>
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                ...
                                                <asp:RequiredFieldValidator ToolTip="Select Type" ID="RequiredFieldValidator7" runat="server" ControlToValidate="ddltype"
                                                    ErrorMessage="Select Type" InitialValue="0" ValidationGroup="v"
                                                    Display="Dynamic" ForeColor="Red"><img src="../images/error1.gif" alt="Enter Description" /></asp:RequiredFieldValidator>
                                            </div>
                                        </div>
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                ...
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtdescription"
                                                    Display="Dynamic" ErrorMessage="Enter Description" ToolTip="Enter Description" ValidationGroup="v" ForeColor="Red"><img src="../images/error1.gif" alt="Enter Description" /></asp:RequiredFieldValidator>
                                            </div>
                                        </div>
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                ...
                                                <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="fupload"
                                                    ...
                                                    ValidationGroup="v" ForeColor="Red"><img src="../images/error1.gif" alt="File not supported" /></asp:RegularExpressionValidator>
