<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Upload Bulletin.aspx.cs" Inherits="InformationCenter_Upload_Bulletin" %>
                    ...
                    <div class="main-container">
                        ...
                        <div class="row-fluid">
                            ...
                            <div class="widget">
                                ...
                                <div class="widget-header">
                                    <div class="title">
                                        <span class="fs1" aria-hidden="true" data-icon="&#xe14a;"></span>Upload Bulletin Posting Form	
                                    ...
                                    <fieldset>
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                ...
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ToolTip="Select Type" ControlToValidate="ddltype"
                                                    ErrorMessage="Select Type" InitialValue="0" ValidationGroup="v"
                                                    Display="Dynamic" ForeColor="Red" ><img src="../images/error1.gif" alt="Attach File" /></asp:RequiredFieldValidator>
                                            </div>
                                        </div>
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <asp:TextBox ID="txtsubject" size="40" CssClass="span4" ToolTip="Enter Subject" runat="server"  onkeypress="return isKey(event);"></asp:TextBox>
                                                 <asp:RequiredFieldValidator ID="RequiredFieldValidator1" ToolTip="Enter Subject" ControlToValidate="txtsubject" runat="server" ErrorMessage="Enter Subject" ValidationGroup="v" ForeColor="Red">
                                                     <img src="../images/error1.gif" alt="Attach File" />
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <asp:TextBox ID="txtdescription" ToolTip="Enter Description" CssClass="span4" runat="server"  TextMode="MultiLine" onkeypress="return isKey(event);"></asp:TextBox>
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" ToolTip="Enter Description" ControlToValidate="txtdescription" runat="server" ErrorMessage="Enter Description" ValidationGroup="v" ForeColor="Red">
                                                    <img src="../images/error1.gif" alt="Attach File" /></asp:RequiredFieldValidator>
                                            </div>
                                        </div>
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                ...
                                                <asp:RequiredFieldValidator ID="rfvupload" runat="server" ControlToValidate="fupload"
                                                    Display="Dynamic" ErrorMessage="Attach Document" ToolTip="Attach Document" ValidationGroup="v" ForeColor="Red"><img src="../images/error1.gif" alt="Attach File" /></asp:RequiredFieldValidator>
                                            ...
                                            <div class="control-group">
                                                <label class="control-label">Expire <%--<span class="star"></span>--%></label>
                                            <div class="controls">
                                                    
                                                    <asp:DropDownList ToolTip=" Select Expiry Duration" ID="ddlexpiry" runat="server" CssClass="blue1"  Width="287px">
                                                        <asp:ListItem Value="00">-Expiry Duration-</asp:ListItem>
                                                 ...
                                                 <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ToolTip=" Select Expiry Duration" ControlToValidate="ddlexpiry"
                                                    ErrorMessage="Select Type" InitialValue="00" ValidationGroup="v"
                                                    Display="Dynamic" ForeColor="Red" ><img src="../images/error1.gif" alt="Attach File" /></asp:RequiredFieldValidator>
                                                </div>
                                                </div>
                        ...
                        <div class="row-fluid">
                            ...
                            <div class="widget">
                                ...
                                <div class="widget-header">
                                    <div class="title">
                                        <span class="fs1" aria-hidden="true" data-icon="&#xe14a;"></span>Uploaded Bulletin             
                                    </div>
                                </div>
                                                ...
                                                <asp:GridView ID="griddetails" runat="server" Width="100%" AutoGenerateColumns="False"
                                                    ...
                                                    <Columns>
                                                        <asp:TemplateField HeaderText="Type">
                                                            ...
                                                            <ItemStyle Width="12%" VerticalAlign="Top" CssClass="" />
                                                        ...
                                                        <asp:TemplateField HeaderText="Subject">
                                                            ...
                                                            <ItemStyle Width="22%" VerticalAlign="Top" CssClass="" />
                                                            <HeaderStyle CssClass="" />
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="Description">
                                                            <ItemStyle Width="35%" VerticalAlign="Top" CssClass="" />
                                                            <HeaderStyle CssClass="" />
                                                            <ItemTemplate>
                                                        ...
                                                        <asp:TemplateField HeaderText="Attached Document">
                                                            <ItemStyle Width="20%" VerticalAlign="Top" CssClass="" />
                                                            <HeaderStyle CssClass="" />
                                                            <ItemTemplate>
                                                        ...
                                                        <asp:TemplateField>
                                                            <ItemStyle Width="11%" VerticalAlign="Top" CssClass="" />
                                                            <HeaderStyle CssClass="" />
                                                            <ItemTemplate>
