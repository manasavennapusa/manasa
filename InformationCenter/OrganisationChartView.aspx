<%@ Page Language="C#" AutoEventWireup="true" CodeFile="OrganisationChartView.aspx.cs" Inherits="InformationCenter_OrganisationChartView" %>
                                        ...
                                        <fieldset>
                                            <div class="control-group">
                                                <asp:TextBox ID="txtsearch"  CssClass="blue1" Text="" runat="server"
                                                     MaxLength="150" Width="241px" placeHolder="Search Organisation chart"></asp:TextBox>
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField>
                                    <ItemTemplate>
                                        ...
                                        <a href="../InformationCenter/upload/organizationchart/<%#DataBinder.Eval(Container.DataItem,"upload")%>"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField>
                                    <ItemTemplate>
                                        ...
                                        <a href="../InformationCenter/upload/organizationchart/<%#DataBinder.Eval(Container.DataItem,"upload")%>"
                                            target="_blank">Download Organisation Chart</a>
