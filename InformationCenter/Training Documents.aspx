<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Training Documents.aspx.cs" Inherits="InformationCenter_Training_Documents" %>
                                        ...
                                        <fieldset>
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    ...
                                                    Display="Dynamic" ErrorMessage=" Enter Subject" ToolTip=" Enter Subject" ValidationGroup="v"><img src="../images/error1.gif" alt=""></asp:RequiredFieldValidator>
                                                </div>
                                            </div>
                                            <div class="control-group">
                                                <label class="control-label">Description</label>
                                                <div class="controls">
                                                    <asp:TextBox ID="txtdescription" CssClass="span4" runat="server"  TextMode="MultiLine" onkeypress="return isKey(event);"></asp:TextBox>
                                                     <%--<asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="txtdescription"
                                                    Display="Dynamic" ErrorMessage=" Enter Description" ToolTip=" Enter Description" ValidationGroup="v"><img src="../images/error1.gif" alt=""></asp:RequiredFieldValidator>--%>
                                                </div>
                                            </div>
                                             <div class="control-group">
