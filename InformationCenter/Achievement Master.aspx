<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Achievement Master.aspx.cs" Inherits="InformationCenter_Achievement_Master" %>
                                    ...
                                    <fieldset>
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                ...
                                                <asp:RequiredFieldValidator ToolTip="Enter Heading" ID="RequiredFieldValidator1" ControlToValidate="txtheading" ErrorMessage=" Enter Heading" runat="server" ValidationGroup="v" ForeColor="Red"><img src="../images/error1.gif" alt="Enter Heading" /></asp:RequiredFieldValidator>
                                            </div>
                                        </div>
                                        <div class="control-group">
                                    ...
                                    <fieldset>
                                        <div class="widget-content">
                                            <asp:GridView ID="achievementsdetails" runat="server" Width="100%" AutoGenerateColumns="False"
                                                ...
                                                BorderWidth="0px" OnPageIndexChanging="achievementsdetails_PageIndexChanging"
                                                ...
                                                ToolTip="News Details" AllowPaging="True" CssClass="table table-hover table-striped table-bordered table-highlight-head">
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Status" runat="server" visible="false">
                                                        <ItemTemplate>
                                                    ...
                                                    <asp:TemplateField HeaderText="Priority" runat="server" visible="false">
                                                        <ItemTemplate>
