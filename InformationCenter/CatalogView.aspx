<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CatalogView.aspx.cs" Inherits="InformationCenter_CatalogView" %>
                                        ...
                                        <fieldset>
                                            <div class="control-group">
                                                <asp:TextBox ID="txtsearch"  CssClass="blue1" Text="" runat="server"
                                                     MaxLength="150" Width="241px" placeHolder="Search Catalog"></asp:TextBox>
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField>
                                    <ItemTemplate>
                                        ...
                                        <a href="upload/catalogs/<%#DataBinder.Eval(Container.DataItem,"upload")%>"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField>
                                    <ItemTemplate>
                                        ...
                                        <a href="upload/catalogs/<%#DataBinder.Eval(Container.DataItem,"upload")%>"
                                            target="_blank">Download News Details</a>
