<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Financial.aspx.cs" Inherits="InformationCenter_Financial" %>
                                    ...
                                    <fieldset>
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                ...
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" ControlToValidate="txtsubject" ErrorMessage="Enter Heading" runat="server" ValidationGroup="a" ToolTip="Enter Heading" ForeColor="Red"><img src="../images/error1.gif" alt="Enter Heading" /></asp:RequiredFieldValidator>
                                            </div>
                                        </div>
                                        <div class="control-group">
