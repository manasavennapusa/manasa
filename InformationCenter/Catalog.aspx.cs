...
public partial class InformationCenter_Catalog : System.Web.UI.Page
{
        ...
        try
        {
            if (Page.IsValid)
            {
                ...
                else
                {
                    ...
                    lblhead.Text = "Create";
                    Button1.Text = "Submit";
                    Response.Redirect("Catalog.aspx?update=true");
        ...
        try
        {
            ...
            if (Convert.ToInt32(ViewState["flagedit"]) == 1)
            {
                ...
                if (fupload.PostedFile.FileName.ToString() != "")
                {
                    ...
                    {
                        string file = Server.MapPath("../InformationCenter/upload/catalogs/") + ds.Tables[0].Rows[0]["upload"].ToString();
                ...
                ds = DBTask.ExecuteDataset(ConfigurationManager.ConnectionStrings["intranetConnectionString"].ConnectionString.ToString(), CommandType.StoredProcedure, "intranet_update_catalog_sp", newparameter);
                return true;
            }
            return true;
        }
    ...
    protected void griddetails_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
       ...
       // reset();
       // Response.Redirect("Catalog.aspx?delte=true");
    }
    ...
    protected void griddetails_RowEditing(object sender, GridViewEditEventArgs e)
    {
        ...
        //lbl_file.Text = "<a href='../InformationCenter/upload/catalogs/" + ds.Tables[0].Rows[0]["upload"].ToString() + "'>" + ds.Tables[0].Rows[0]["upload"].ToString() + "</a>";
    }
