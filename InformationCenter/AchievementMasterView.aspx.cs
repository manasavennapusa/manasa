...
public partial class InformationCenter_AchievementMasterView : System.Web.UI.Page
{
    string sqlstr;
    DataSet ds;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            //string strWatermark = "Search Achievement";
    ...
    protected void bindgrid()
    {
        try
        {
            sqlstr = "SELECT id,category,heading,description,(CASE WHEN posteddate='01/01/1900' THEN '' ELSE CONVERT(CHAR(15), posteddate, 106) END) posteddate,posteddate posteddate1,postedby FROM ACHIEVEMENTS ORDER BY posteddate1 desc";
    ...
    //        {
    //            sqlstr = "";
    //            sqlstr = "SELECT id,heading,description,(CASE WHEN posteddate='01/01/1900' THEN '' ELSE CONVERT(CHAR(15), posteddate, 106) END) posteddate,posteddate posteddate1,postedby FROM ACHIEVEMENTS WHERE 1=1";
