<%@ Page Language="C#" AutoEventWireup="true" CodeFile="JobDescriptionView.aspx.cs" Inherits="InformationCenter_JobDescriptionView" %>
                                        ...
                                        <fieldset>
                                            <div class="control-group">
                                                <asp:TextBox ID="txtsearch"  CssClass="blue1" Text="" runat="server"
                                                     MaxLength="150" Width="241px" placeHolder="Search Job Description"></asp:TextBox>
                                                <asp:Button ID="btnsubmit" runat="server" CssClass="btn btn-primary" Text="Submit" OnClick="btnsearch_Click" ValidationGroup="c" />
                                            </div>
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField>
                                    <ItemTemplate>
                                        ...
                                        <a href="../upload/hrdocuments/<%#DataBinder.Eval(Container.DataItem,"upload")%>"
                                            target="_blank">Download Product Information </a>
                        ...
                        <div class="widget no-margin">
                            ...
                            <div class="widget-body">
                                <div id="dt_example" class="example_alt_pagination">
                                 <asp:GridView ID="griddetails" runat="server" AutoGenerateColumns="False" DataKeyNames="id"
                            ShowHeader="true" Width="100%" OnPreRender="griddetails_PreRender"
                            EmptyDataText="No product information has been posted" ToolTip="Product Information Posted"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField>
                                    <ItemTemplate>
                                        ...
                                        <a href="upload/hrdocuments/<%#DataBinder.Eval(Container.DataItem,"upload")%>"
                                            target="_blank">Download Job Description </a>
