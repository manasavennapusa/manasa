<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Organisation Chart.aspx.cs" Inherits="InformationCenter_Organisation_Chart" %>
                                        ...
                                        <fieldset>
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    ...
                                                    Display="Dynamic" ErrorMessage="Select Type" InitialValue="0"
                                                    ValidationGroup="v" ForeColor="Red"><img src="../images/error1.gif" alt="File not supported" /></asp:RequiredFieldValidator>
                                                </div>
                                            </div>
                                            ...
                                            <div class="control-group">
                                                ...
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtsubject"
                                                    Display="Dynamic" ErrorMessage="Enter Description" ValidationGroup="v" ForeColor="Red" ToolTip="Enter Subject"><img src="../images/error1.gif" alt="File not supported" />
                                            ...
                                            <div class="control-group">
                                               ...
                                               <%-- <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtdescription"
                                                    Display="Dynamic" ErrorMessage="Enter Description" ValidationGroup="v" ToolTip="Enter description" ForeColor="Red"><img src="../images/error1.gif" alt="File not supported" />
                                                            </asp:RequiredFieldValidator>--%>
                                                </div>
                                            </div>
                                             <div class="control-group">
                                                ...
                                                <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="fupload"
                                                    ...
                                                    ValidationGroup="v"><img src="../images/error1.gif" alt="File not supported" /></asp:RegularExpressionValidator><p style="color: red">(Supported Files are PDF,Docx.Doc)</p>
                                                ...
                                                <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="fupload"
                                                    CssClass="txt-red" Display="Dynamic" ErrorMessage='Attach supported File'
                                                    ValidationExpression="^.+(.doc|.DOC|.docx|.DOCX|.rtf|.RTF|.pdf|.PDF|.xls|.XLS|.ppt|.PPT)$"
                                                    ValidationGroup="v" ToolTip="Format not supported" ForeColor="Red"><img src="../images/error1.gif" alt="File not supported" /></asp:RegularExpressionValidator>--%>
                                            ...
                                            <asp:GridView ID="griddetails" runat="server" Width="100%" AutoGenerateColumns="False"
                                               ...
                                               CssClass="table table-hover table-striped table-bordered table-highlight-head">
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Deldte" HeaderStyle-Width="10%">
                                                        <ItemTemplate>
