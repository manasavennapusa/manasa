...
public partial class RegistrartionForm : System.Web.UI.Page
{
    string _path;
    ...
    protected void insertdata()
    {
      ...
      //  DateTime date = DateTime.ParseExact(txt_Dob.Text, "dd/MM/yyyy", CultureInfo.InvariantCulture);
        ...
        try
        {
            ...
            //Output.AssignParameter(sqlparam, 20, "@designation", "String", 0, desdrop.SelectedItem.ToString());
    ...
    protected void Butncheckemail_Click(object sender, EventArgs e)
    {
        int flag = 0;
