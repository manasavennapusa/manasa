...
<head id="Head1" runat="server">
    ...
    <link type="text/javascript" href="../icomoon/style.css" rel="stylesheet" />
                                    ...
                                    <tr>
                                        <td width="50%" valign="top">
                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                ...
                                                <tr id="Tr1" runat="server" visible="false" style="height: 50px">
                                                ...
                                                <tr id="Tr2" runat="server" visible="false" style="height: 50px">
                                            ...
                                            <table width="99%" border="0" align="right" cellpadding="0" cellspacing="0">
                                                ...
                                                <tr>
                                                    ...
                                                    <td width="52%" class="frm-rght-clr123">
                                                        ...
                                                        <asp:Image ID="empimg" runat="server" Height="91px" Width="150px" ImageUrl="Upload/photo/image.jpg/.jpeg"></asp:Image>
                                                        &nbsp;<br />
                                                        <br />
                                                            ...
                                                            <tr>
                                                                <td width="50%" valign="top">
                                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                        ...
                                                                        <tr id="trconforimdate" runat="server" visible="False" style="height: 50px;">
                                                                ...
                                                                <td valign="top">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <tr id="trnoticepriod2" runat="server" style="height: 50px;">
                                                            ...
                                                            <tr>
                                                                <td width="50%" valign="top">
                                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                        ...
                                                                        <tr id="sss" runat="server" visible="false" style="height: 50px">
                                    ...
                                    <div>
                                        <p>
                                            ...
                                            <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                                ...
                                                <tr id="tr112" runat="server" visible="false">
                                                    <td colspan="2" width="100%">
                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                            <tr>
                                                                <td width="50%" valign="top">
                                                            ...
                                                            <tr>
                                                                <td valign="top" width="50%">
                                                                    <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                                                        ...
                                                                        <tr id="tr121" runat="server" visible="false" style="height:50px">
                                                                ...
                                                                <td valign="top">
                                                                    <table cellspacing="0" cellpadding="0" width="99%" align="right" border="0">
                                                                        ...
                                                                        <tr id="tr120" runat="server" visible="false" style="height:50px">
