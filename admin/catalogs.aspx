                                ...
                                <td valign="top" class="blue-brdr-1">
                                    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                        <tr>
                                            ...
                                            <td class="txt01">Catalog Posting Form
                                            </td>
                                            <td align="right">
                                        ...
                                        <tr>
                                            ...
                                            <td width="75%" class="frm-rght-clr123">
                                                ...
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ControlToValidate="ddltype"
                                                    ...
                                                    Display="Dynamic" Height="1px" Width="15px" ToolTip="Select Type"><img src="../img/error1.gif" alt="*" /></asp:RequiredFieldValidator>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td width="75%" class="frm-rght-clr123">
                                                <asp:TextBox ID="txtsubject" runat="server" CssClass="blue1" Width="235px"></asp:TextBox>&nbsp;<asp:RequiredFieldValidator
                                                    ...
                                                    ValidationGroup="v" Display="Dynamic" ToolTip="Add Subject"><img src="../img/error1.gif" alt="*" /></asp:RequiredFieldValidator>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td width="75%" class="frm-rght-clr123">
                                                ...
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtdescription"
                                                    Display="Dynamic" ErrorMessage="Description" ValidationGroup="v" ToolTip="Add Description"><img src="../img/error1.gif" alt="*" /></asp:RequiredFieldValidator>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="frm-lft-clr123">Upload Catalog <span class="star"></span>
                                            </td>
