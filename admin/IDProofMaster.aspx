<%@ Page Language="C#" AutoEventWireup="true" CodeFile="IDProofMaster.aspx.cs" Inherits="admin_IDProofMaster" %>
                        ...
                        <div class="widget">
                            <div class="widget-header" style="border-bottom: none;">
                                <div class="title">
                                    ...
                                    <asp:Label ID="lblhead" runat="server" Text="Create Document Type"></asp:Label>
                                </div>
                            </div>
                                ...
                                <fieldset>
                                    ...
                                    <div class="form-actions no-margin">
                                        <asp:Button ID="btncity" runat="server" CssClass="btn btn-primary" OnClick="btncity_Click"
                                         ...
                                         <asp:Button ID="btnrest" runat="server" CssClass="btn btn-primary" Text="Cancel" OnClick="btnrest_Click" ></asp:Button>
                                    </div>
                                </fieldset>
                                    ...
                                    <asp:GridView ID="Grid_Emp" runat="server" AutoGenerateColumns="False" CssClass="table table-condensed table-striped  table-bordered pull-left"
                                        ...
                                        <Columns>
                                             <asp:TemplateField HeaderText="Document Type ID">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblcity" runat="server" Text='<%#Eval("id")%>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            ...
                                            <asp:HyperLinkField HeaderText="Edit" DataNavigateUrlFields="id" DataNavigateUrlFormatString="~/admin/IDProofMaster.aspx?Id={0}"
