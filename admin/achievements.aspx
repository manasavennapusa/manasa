<%@ Page Language="C#" AutoEventWireup="true" CodeFile="achievements.aspx.cs" Inherits="intranet_achievements" %>
                            ...
                            <td valign="top" class="blue-brdr-1">
                                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                    <tr>
                                        ...
                                        <td class="txt01">Intranet Achievements Master Form
                                        </td>
                                        <td align="right">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="frm-rght-clr123">
                                                        ...
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="ddlcategory" InitialValue="0"
                                                            ErrorMessage="please select Category" ValidationGroup="v" Display="Dynamic"><img src="../img/error1.gif" alt="*" /></asp:RequiredFieldValidator>
