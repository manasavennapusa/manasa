<%@ Page Language="C#" AutoEventWireup="true" CodeFile="productinformation.aspx.cs" Inherits="intranet_productinformation" %>
                                ...
                                <td valign="top" class="blue-brdr-1">
                                    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                        <tr>
                                            ...
                                            <td class="txt01">Product Information Posting Form</td>
                                        ...
                                        <tr>
                                            ...
                                            <td width="75%" class="frm-rght-clr123">
                                                ...
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ControlToValidate="ddltype" Display="Dynamic"
                                                    ErrorMessage="Select Type" InitialValue="---Select Type---" ValidationGroup="v"><img src="../img/error1.gif" alt="*" /></asp:RequiredFieldValidator></td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td width="75%" class="frm-rght-clr123">
                                                ...
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtdescription" Display="Dynamic"
                                                    ErrorMessage="Description" ValidationGroup="v"><img src="../img/error1.gif" alt="*" /></asp:RequiredFieldValidator></td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td class="frm-rght-clr123">
                                                ...
                                                <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="fupload"
                                                    CssClass="txt-red" ErrorMessage='<img src="../img/error1.gif" alt="File not supported" />' ValidationExpression="^.+(.doc|.DOC|.docx|.DOCX|.rtf|.RTF|.pdf|.PDF|.xls|.XLS|.ppt|.PPT)$" ValidationGroup="v" Display="Dynamic"><img src="../img/error1.gif" alt="File not supported" /></asp:RegularExpressionValidator>
