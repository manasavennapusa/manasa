<%@ Page Language="C#" AutoEventWireup="true" CodeFile="viewemployeesatisfactionform.aspx.cs" Inherits="admin_viewemployeesatisfactionform" %>
                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        ...
                                        <tr>
                                            <td class="border-bottom">
                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                    <tr>
                                                        <td class="frm-lft-clr123" width="30%">I have confidence in the leadership of TriMedx</td>
                                            ...
                                            <td class="border-bottom">
                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                    <tr>
                                                        ...
                                                        <td class="frm-lft-clr123 border-bottom" width="30%">Individual initiative is encouraged at TriMedx  </td>
                                                        <td class="frm-rght-clr123 border-bottom" width="20%">
                                                            <asp:Label ID="Label9" runat="server" Text="Label"></asp:Label>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td class="frm-lft-clr123"  width="30%"">Nothing at TriMedx keeps me from doing my best every day</td>
                                                        <td class="frm-rght-clr123" width="20%"">
                                            ...
                                            <td class="border-bottom">
                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                    <tr>
                                                        ...
                                                        <td class="frm-lft-clr123 border-bottom" width="30%">I feel I can trust what TriMedx tells me</td>
                                                        <td class="frm-rght-clr123 border-bottom" width="20%">
...
Performance appraisal items</b>
                                                        ...
                                                        <td class="border-bottom">
                                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                <tr>
                                                                    ...
                                                                    <td class="frm-lft-clr123 border-bottom" width="30%">I feel I am contributing to TriMedx’s mission</td>
                                                                    <td class="frm-rght-clr123 border-bottom" width="20%">
                                                    ...
                                                    <tr>
                                                        <td class="border-bottom">
                                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                ...
                                                                <tr>
                                                                    <td class="frm-lft-clr123" width="30%">I feel I am valued at TriMedx</td>
                                                                    <td class="frm-rght-clr123" width="20%">
                                                                    ...
                                                                    <td class="frm-lft-clr123  border-bottom" width="30%">TriMedx gives enough recognition for work that's well done </td>
                                                                    <td class="frm-rght-clr123  border-bottom" width="20%">
                                                    ...
                                                    <tr>
                                                        <td class="frm-lft-clr123">11.	TriMedx 's Training Program 
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <td class="border-bottom">
                                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                <tr>
                                                                    <td class="frm-lft-clr123" width="30%">TriMedx provided as much initial training as I needed </td>
                                                                    <td class="frm-rght-clr123" width="20%">
                                                                    ...
                                                                    <td class="frm-lft-clr123" width="30%">TriMedx provides as much ongoing training as I need </td>
                                                                    <td class="frm-rght-clr123" width="20%">
                                                    ...
                                                    <tr>
                                                        <td class="frm-lft-clr123">12.	How long do you plan to continue your career with TriMedx?
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <td class="frm-lft-clr123">13.	Would you recommend employment at TriMedx to a friend?
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <td class="frm-lft-clr123">14. What I like best about working in TriMedx?
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <td class="frm-lft-clr123">15. Things that TriMedx should do to make it a better workplace?
                                                        </td>
