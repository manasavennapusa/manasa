                ...
                <SelectParameters>
                    <asp:ControlParameter ControlID="drpbranch" Name="branchid" PropertyName="SelectedValue" DefaultValue="0" />
                                                                                ...
                                                                                <tr style="height: 50px">
                                                                                    ...
                                                                                    <td class="frm-rght-clr123 border-bottom" width="52%">
                                                                                        ...
                                                                                        <asp:CompareValidator ID="CompareValidator2" runat="server" ControlToValidate="drpempstatus"
                                                                                            ...
                                                                                            ToolTip="Select Employee Status" ValidationGroup="v" ValueToCompare="0" Operator="NotEqual"></asp:CompareValidator>
                                                                            ...
                                                                            <td height="5" colspan="2">
                                                                                ...
                                                                                <tr id="trDOL" runat="server" visible="false" style="height: 50px">
                                                                                    ...
                                                                                    <td class="frm-rght-clr123 border-bottom" width="51%" style="border-top: none;">
                                                                                        <asp:TextBox ID="txtdol" runat="server" CssClass="span11" Width="100px" onkeypress="return enterdate(event);" onkeydown="return enterdate(event);"></asp:TextBox>&nbsp;
                                                            ...
                                                            <ContentTemplate>
                                                                <table style="border-collapse: collapse" bordercolor="#d9d9d9" cellspacing="0" cellpadding="4"
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <asp:TextBox ID="txtToDate" runat="server" Width="70px" CssClass="span11" onkeypress="return enterdate(event);" onkeydown="return enterdate(event);"></asp:TextBox>&#160;<asp:Image
                                                                ...
                                                                <td valign="top" width="50%">
                                                                    <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td class="frm-rght-clr123 ">
                                                                                <asp:TextBox ID="txt_passportexpdate" runat="server" CssClass="span11" onkeypress="return isNumber_slash();"></asp:TextBox>&nbsp;<asp:Image
                                                                                        ...
                                                                                        <td valign="top" width="50%">
                                                                                            <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                                                                                ...
                                                                                                <tr>
                                                                                                    ...
                                                                                                    <td class="frm-rght-clr123  border-bottom" width="52%">
                                                                                                        <asp:TextBox ID="txt_doa" runat="server" CssClass="span11" onkeypress="return enterdate(event);" onkeydown="return enterdate(event);"></asp:TextBox>&nbsp;<asp:Image
                                                                                            ...
                                                                                            <table cellspacing="0" cellpadding="0" width="99%" align="right" border="0">
                                                                                                ...
                                                                                                <tr>
                                                                                                    ...
                                                                                                    <td class="frm-rght-clr123" width="52%">
                                                                                                        ...
                                                                                                        <%-- <asp:CompareValidator ID="cv_s_dob" runat="server" ControlToCompare="txt_doa" ControlToValidate="txt_s_DOB"
                                                                                                                ErrorMessage='<img src="../img/error1.gif" alt="" />' Operator="LessThan"
                                                                                                                SetFocusOnError="True" Type="Date" ToolTip="Select valid date " ValidationGroup="v"></asp:CompareValidator>--%>
                                                                                                    </td>
                                                                                                </tr>
                                    ...
                                    <fieldset>
                                        <div class="control-group">
                                            <div class="controls span9">
                                                 <label class="control-label span3" style="width:100px">InComplte</label>
                                               &nbsp; &nbsp;&nbsp;&nbsp;<asp:CheckBox ID="cknotcomplete" runat="server" Checked="false" OnCheckedChanged="cknotcomplete_CheckedChanged" AutoPostBack="true" />
                                            </div>
                                        </div>
                                        <div class="control-group">
                                            <label class="control-label span3">Comments</label>
                                            <div class="controls span9">
                                                <asp:TextBox ID="txtcomments" runat="server" TextMode="MultiLine" Visible="false" Rows="5" Width="500px"></asp:TextBox>
                                            </div>
                                        </div>
                                    </fieldset>
                                </div>
                                ...
                                <div class="form-actions no-margin">
                                    <asp:Button ID="btngeneralsubmit" runat="server" align="right" CssClass="btn btn-success " OnClick="btngeneralsubmit_Click"
                                        Text="Approve" ValidationGroup="v" />
                                    <asp:Button ID="btnreject" runat="server" align="right" CssClass="btn btn-danger " OnClick="btnreject_Click"
                                        Text="Reject" ValidationGroup="r" Visible="false" />
                                </div>
