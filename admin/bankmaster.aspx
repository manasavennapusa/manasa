                                    ...
                                    <div class="widget-body">
                                        <fieldset>
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    <asp:TextBox ID="txt_bankname" size="40" CssClass="span4" runat="server"  onkeypress="return isCharOrSpace()"></asp:TextBox>
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    ...
                                                    <asp:RegularExpressionValidator ID="RegularExpressionValidator1" ControlToValidate="txt_bankcode"
                                                        ValidationGroup="v" runat="server" ValidationExpression="^[a-zA-Z'.\-\s\0-9]+$" ToolTip="Enter only alphabets"
                                                        ErrorMessage='<img src="../img/error1.gif" alt=""  />'></asp:RegularExpressionValidator>
                                                </div>
                                            </div>

                                            <div class="control-group" dir="acc" runat="server" visible="false">
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    <asp:TextBox ID="txt_bankaddr" runat="server" CssClass="span4" size="40" 
                                            ...
                                            <div class="form-actions no-margin">
                                                <asp:Button ID="btnsbmit" runat="server" Text="Submit" CssClass="btn btn-primary" OnClick="btnsbmit_Click"
                                                    ValidationGroup="v" ToolTip="Click to submit the created leave" />&nbsp;
                                                <asp:Button ID="btn_reset" runat="server" CssClass="btn btn-primary" OnClick="btn_reset_Click"
                                                    Text="Reset" />
                                            </div>
                                        </fieldset>
                                    </div>
