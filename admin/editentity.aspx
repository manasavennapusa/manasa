<%@ Page Language="C#" AutoEventWireup="true" CodeFile="editentity.aspx.cs" Inherits="admin_editentity" %>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="frm-rght-clr123" width="77%">
                                            <asp:TextBox ID="txt_entity_name" runat="server" CssClass="blue1" Width="182px"></asp:TextBox>
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ControlToValidate="txt_entity_name"
                                                Display="Dynamic" SetFocusOnError="True" ToolTip="Enter Entity Name" ValidationGroup="c"
                                    ...
                                    <tr>
                                        ...
                                        <td class="frm-rght-clr123 border-bottom">
                                            <asp:Button ID="btnsv"  runat="server" Text="Save" CssClass="button"
                                                ValidationGroup="c" onclick="btnsv_Click"></asp:Button>
                                        </td>
                                    </tr>
                                    <tr>
