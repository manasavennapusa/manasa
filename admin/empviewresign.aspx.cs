...
public partial class admin_empviewresign : System.Web.UI.Page
{
    string sqlstr;
    ...
    protected void bindempdetail()
    {
        try
        {
            ...
            ds = SQLServer.ExecuteDataset(connection, CommandType.StoredProcedure, "sp_resign_emp_detail", sqlparam);
