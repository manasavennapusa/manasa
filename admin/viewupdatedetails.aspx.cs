...
public partial class admin_viewupdatedetails : System.Web.UI.Page
{
    string sqlstr;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            ddl_department_type.Items.Insert(0, new ListItem("All", "0"));
            bindempdetail();
        }
    ...
    protected void bind_departmnt(int ss)
    {
        try
        {
            connection = activity.OpenConnection();
            sqlstr = "select departmentid,department_name from tbl_internate_departmentdetails where dept_type_id='" + ss + "' order by department_name";
            DataSet ds1 = SQLServer.ExecuteDataset(connection, CommandType.Text, sqlstr);

            dept_type.DataTextField = "department_name";
            dept_type.DataValueField = "departmentid";
    ...
    protected void bindempdetail()
    {
        ...
        try
        {
            if (RoleId == "28")
            {
                ...
                ds = SQLServer.ExecuteDataset(connection, CommandType.StoredProcedure, "sp_leave_fetch_emp_detail5", sqlparam);
            ...
            else
            {
                ...
                sqlparam[2] = new SqlParameter("@department", SqlDbType.Int);
                sqlparam[2].Value = dept_type.SelectedValue;
                ...
                sqlparam[6].Value = ddl_department_type.SelectedValue;
                ...
                //ds = SQLServer.ExecuteDataset(connection, CommandType.StoredProcedure, "sp_leave_fetch_emp_detail5", sqlparam); //if u want previous code use this storeprocedure  name sp_leave_fetch_emp_detail2
                //empgrid.DataSource = ds;
                //empgrid.DataBind();
            }
        }
    ...
    {
        BindDesignation(dept_type.SelectedValue);
    }
    protected void ddl_department_type_SelectedIndexChanged(object sender, EventArgs e)
    {
        bind_departmnt(Convert.ToInt16(ddl_department_type.SelectedValue));
    }
    private void bind_departmenttype(int branchid)
    {
        ...
        try
        {
            ...
            ddl_department_type.DataTextField = "dept_type_name";
            ddl_department_type.DataValueField = "dept_type_id";
            ddl_department_type.DataSource = ds1;
            ddl_department_type.DataBind();
            ddl_department_type.Items.Insert(0, new ListItem("All", "0"));
        }
        catch (Exception ex)
        {
