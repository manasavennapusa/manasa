                    ...
                    <div class="span12">
                        <div class="widget no-margin">
                            <div class="widget-header">
                                <div class="title">
                                    <span class="fs1" aria-hidden="true" data-icon="&#xe14a;"></span>Print/View/Edit
                                </div>
                            </div>
                            <div class="widget-body">
                                <div id="dt_example" class="example_alt_pagination">
                                    <asp:GridView ID="empgrid"
                                        ...
                                        OnPreRender="empgrid_PreRender2">
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Department Type">
                                                <ItemTemplate>
                                                    <asp:Label ID="l2" runat="server" Text='<%# Bind ("dept_type_name") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            ...
                                            <asp:HyperLinkField DataNavigateUrlFields="empcode" HeaderText="Print" DataNavigateUrlFormatString="printemp.aspx?empcode={0}" NavigateUrl="printemp.aspx" Text="&lt;img src='../images/print.png'/&gt;" Target="_blank" ControlStyle-Width="20px"></asp:HyperLinkField>
                                            ...
                                            <asp:HyperLinkField DataNavigateUrlFields="empcode" HeaderText="Edit" DataNavigateUrlFormatString="editempmaster.aspx?empcode={0}"
                                                NavigateUrl="editempmaster.aspx" Text="&lt;img src='../images/edit.png'/&gt;"></asp:HyperLinkField>
