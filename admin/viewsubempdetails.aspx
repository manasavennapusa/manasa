<%@ Page Language="C#" AutoEventWireup="true" CodeFile="viewsubempdetails.aspx.cs" Inherits="admin_viewsubempdetails" %>
                                                                                    ...
                                                                                    <tr>
                                                                                        <td colspan="2">
                                                                                            <table id="Table2" cellspacing="0" cellpadding="0" width="100%" border="0">
                                                                                                <tr>
                                                                                                    <td colspan="2" class="txt02">Emergency Contact Details:
                                                                                                    </td>
                                                                                                </tr>
                                                                                                <tr>
