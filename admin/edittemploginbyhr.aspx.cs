...
public partial class admin_edittemploginbyhr : System.Web.UI.Page
{
    ...
    {
        sqlstr = "SELECT empcode,esi_no,esi_disp,pf_no,pf_no_dept,pan_no,ward,ptno FROM tbl_intranet_employee_payrollDetails  WHERE empcode = '" + empcode + "'";
        ds = DBTask.ExecuteDataset(ConfigurationManager.ConnectionStrings["intranetConnectionString"].ConnectionString.ToString(), CommandType.Text, sqlstr);
        if (ds.Tables[0].Rows.Count < 1)
            return;
    ...
    {
        string sqlstr = "select id,child_name,gender ,(CASE WHEN dob='01/01/1900' THEN '' ELSE CONVERT(CHAR(10), dob, 101) END)child_dob from tbl_intranet_employee_childrendetail where empcode ='" + empcode + "'";
        ds = DBTask.ExecuteDataset(ConfigurationManager.ConnectionStrings["intranetConnectionString"].ConnectionString.ToString(), CommandType.Text, sqlstr);
        if (ds.Tables[0].Rows.Count < 1)
            return;
        if (Session["acc_education"] == null)
    ...
    protected void edit_Job_detail(string emp_code)
    {
        ...
        ds = DBTask.ExecuteDataset(ConfigurationManager.ConnectionStrings["intranetConnectionString"].ConnectionString.ToString(), CommandType.StoredProcedure, "sp_intranet_edit_jobdetails_for_temphr", sqlparam);
    ...
    protected void edit_login_role(string emp_code)
    {
        ...
        DBTask.ExecuteDataset(ConfigurationManager.ConnectionStrings["intranetConnectionString"].ConnectionString.ToString(), CommandType.Text, sqlstr, sqlparam);
    }
    ...
    protected void edit_payroll_detail(string empcode)
    {
        ...
        ds = DBTask.ExecuteDataset(ConfigurationManager.ConnectionStrings["intranetConnectionString"].ConnectionString.ToString(), CommandType.StoredProcedure, "sp_intranet_edit_payrolldetails", sqlparam);
    }
    ...
    protected void btngeneralsubmit_Click(object sender, EventArgs e)
    {
        ...
        edit_Job_detail(emp_code);
        edit_login_role(emp_code);
        ...
        edit_emp_documents(emp_code);
        edit_Training_details(emp_code);
        resetcontact();
    ...
    protected void edit_Training_details(string emp_code)
    {
        if (Session["training"] != null)
        {
    ...
    protected void edit_personal_detail(string empcode)
    {
        ...
        DBTask.ExecuteNonQuery(ConfigurationManager.ConnectionStrings["intranetConnectionString"].ConnectionString.ToString(), CommandType.StoredProcedure, "[sp_intranet_Edit_personaldetails]", sqlParam);
    }
    ...
    protected void edit_contact_detail(string empcode)
    {
        ...
        DBTask.ExecuteNonQuery(ConfigurationManager.ConnectionStrings["intranetConnectionString"].ConnectionString.ToString(), CommandType.StoredProcedure, "[sp_intranet_EDIT_contactdetails]", sqlParam);
    }
    //---------------------------------End-----------------------------------------------
    ...
    protected void edit_emp_documents(string empcode)
    {
        ...
        DBTask.ExecuteNonQuery(ConfigurationManager.ConnectionStrings["intranetConnectionString"].ConnectionString.ToString(), CommandType.StoredProcedure, "sp_update_emp_doc_upload", sqlParam);
    ...
    //        ds_A = DBTask.ExecuteDataset(ConfigurationManager.ConnectionStrings["intranetConnectionString"].ConnectionString.ToString(), CommandType.Text, sqlstr);
    ...
    //        ds_T = DBTask.ExecuteDataset(ConfigurationManager.ConnectionStrings["intranetConnectionString"].ConnectionString.ToString(), CommandType.Text, sqlstr);
    ...
    protected void bind_empstatus()
    {
        ...
        ds_empstat = DBTask.ExecuteDataset(ConfigurationManager.ConnectionStrings["intranetConnectionString"].ConnectionString.ToString(), CommandType.Text, sqlstr);
    ...
    protected void bind_ddlCCgroup()
    {
        ...
        ds_ccg = DBTask.ExecuteDataset(ConfigurationManager.ConnectionStrings["intranetConnectionString"].ConnectionString.ToString(), CommandType.Text, sqlstr);
    ...
    protected void bind_cc_code(int accgroupid)
    {
        ...
        dset = DBTask.ExecuteDataset(ConfigurationManager.ConnectionStrings["intranetConnectionString"].ConnectionString.ToString(), CommandType.Text, sqlstr);
    ...
    protected void bind_cc(int cc_id)
    {
        ...
        dset3 = DBTask.ExecuteDataset(ConfigurationManager.ConnectionStrings["intranetConnectionString"].ConnectionString.ToString(), CommandType.Text, sqlstr1);
    ...
    protected void bind_ddl_aCCgroup()
    {
        ...
        dset5 = DBTask.ExecuteDataset(ConfigurationManager.ConnectionStrings["intranetConnectionString"].ConnectionString.ToString(), CommandType.Text, sqlstr);
    ...
    protected void bind_ddl_acc_code(int accgroupid)
    {
        ...
        dset4 = DBTask.ExecuteDataset(ConfigurationManager.ConnectionStrings["intranetConnectionString"].ConnectionString.ToString(), CommandType.Text, sqlstr);
    ...
    protected void bind_acc(int acc_id)
    {
        ...
        dset2 = DBTask.ExecuteDataset(ConfigurationManager.ConnectionStrings["intranetConnectionString"].ConnectionString.ToString(), CommandType.Text, sqlstr1);
    ...
    protected void cknotcomplete_CheckedChanged(object sender, EventArgs e)
    {
        if (cknotcomplete.Checked == true)
        {
            txtcomments.Visible = true;
            btnreject.Visible = true;
            btngeneralsubmit.Visible = false;
        }
        else if (cknotcomplete.Checked == false)
        {
