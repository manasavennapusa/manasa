<%@ Page Language="C#" AutoEventWireup="true" CodeFile="createentity.aspx.cs" Inherits="admin_createentity" %>
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="frm-rght-clr123" width="75%">
                                                        <asp:TextBox ID="txt_entityname" runat="server" CssClass="blue1" Width="142px"></asp:TextBox>
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ControlToValidate="txt_entityname"
