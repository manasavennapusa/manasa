<%@ Page Language="C#" AutoEventWireup="true" CodeFile="viewedbdeatilspage.aspx.cs" Inherits="admin_viewedbdeatilspage" %>
                            ...
                            <div class="widget-body">
                                <div id="wizard">
                                    ...
                                    <div>
                                       ...
                                       <asp:Button ID="btnsubmit" runat="server" Text="Approve" CssClass="btn-success" OnClick="btnsubmit_Click" />
                                       <asp:Button ID="btn_Reject" runat="server" Text="Reject" CssClass="btn-danger" OnClick="btn_Reject_Click"/>
