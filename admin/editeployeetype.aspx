<%@ Page Language="C#" AutoEventWireup="true" CodeFile="editeployeetype.aspx.cs" Inherits="admin_editeployeetype" %>
                        ...
                        <div class="widget">
                            <div class="widget-header" style="border-bottom: none;">
                                <div class="title">
                                    ...
                                    <span id="message" runat="server" class="txt-red" enableviewstate="false"></span>Edit Employee
                                </div>
                            </div>
                                ...
                                <fieldset>
                                    ...
                                    <div class="control-group">
                                        <label class="control-label">Employee Type <span class="star" style="color:red">*</span></label>
                                         <asp:RequiredFieldValidator ID="ddl_per_statddde" runat="server" ControlToValidate="txt_employeetype"
