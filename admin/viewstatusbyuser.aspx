<%@ Page Language="C#" AutoEventWireup="true" CodeFile="viewstatusbyuser.aspx.cs" Inherits="admin_viewstatusbyuser" %>
                        ...
                        <div class="widget no-margin">
                            ...
                            <div class="widget-body">
                                <div id="dt_example" class="example_alt_pagination">
                                    <asp:GridView ID="empgrid" runat="server" DataKeyNames="empcode" AutoGenerateColumns="False" EmptyDataText="No such employee exists !" AllowSorting="true"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:HyperLinkField DataNavigateUrlFields="empcode" DataNavigateUrlFormatString="Viewuserdetails.aspx?empcode={0}"
                                                NavigateUrl="admin/Viewuserdetails.aspx?empcode={0}" Text="&lt;img src='images/View.png'/&gt;"></asp:HyperLinkField>
                                        </Columns>
                                    </asp:GridView>
                                </div>
                                <div class="clearfix"></div>
