                                ...
                                <td valign="top" class="blue-brdr-1">
                                    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                        <tr>
                                            ...
                                            <td class="txt01">Bulletin documents upload
                                            </td>
                                            <td align="right">
                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                            ...
                                            <td width="75%" class="frm-rght-clr123">
                                                ...
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ControlToValidate="ddlType"
                                                    ErrorMessage="Select Type" InitialValue="---Select Type---" ValidationGroup="v" Display="Dynamic">
                                        ...
                                        <tr>
                                            ...
                                            <td class="frm-rght-clr123">
                                                ...
                                                <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="fupload"
                                                    CssClass="txt-red" Display="Dynamic" ErrorMessage='<img src="../img/error1.gif" alt="File not supported" />'
                                                    ValidationExpression="^.+(.doc|.DOC|.docx|.DOCX|.rtf|.RTF|.pdf|.PDF|.xls|.XLS|.ppt|.PPT)$"
                                                    ValidationGroup="v"><img src="../img/error1.gif" alt="File not supported" /></asp:RegularExpressionValidator>
                                                <asp:Label ID="lbl_file" runat="server"></asp:Label>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td width="25%" class="frm-lft-clr123" valign="top">Expire 
                                            </td>
                                            <td width="75%" class="frm-rght-clr123">&nbsp;<asp:DropDownList ID="ddlexpiry" runat="server" CssClass="blue1">
