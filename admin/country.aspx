<%@ Page Language="C#" AutoEventWireup="true" CodeFile="country.aspx.cs" Inherits="admin_country" %>
                                    ...
                                    <div class="widget-body">
                                        <fieldset>
                                            ...
                                            <div class="form-actions no-margin">
                                                <asp:Button ID="btncountry" runat="server" CssClass="btn btn-info" Text="Submit" ValidationGroup="c"
                                                    OnClick="btncountry_Click" />

                                                <asp:Button ID="btnreset" runat="server" CssClass="btn btn-info" Text="Reset" ValidationGroup=""
