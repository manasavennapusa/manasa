<%@ Page Language="C#" AutoEventWireup="true" CodeFile="edittemploginbyhr.aspx.cs" Inherits="admin_edittemploginbyhr" %>
    ...
    function IsEmpty(aTextField) {
        ...
        <script type="text/javascript">
            function ValidateEducation() {
                ...
                if (fromyear.value != '' && toyear.value != '')
                    if (fromyear.value > toyear.value) {
                        toyear.focus();
                        alert("To-Year should be grater than or equal to From-Year in Educational Qualification");
                        return false;
                    }
        ...
        <script type="text/javascript">
            function ValidateProfessional() {
                ...
                if (fromyear.value != '' && toyear.value != '')
                    if (fromyear.value > toyear.value) {
                        toyear.focus();
                        alert("To-Year should be grater than or equal to From-Year in  Professional Qualification");
                        return false;
                    }
        ...
        <script type="text/javascript">
            ...
            function ValidateCompany() {
                ...
                if (fromyear.value != '' && toyear.value != '')
                    if (fromyear.value > toyear.value) {
                        toyear.focus();
                        alert("To-Year should be grater than or equal to From-Year in Experience Details.");
                        return false;
                    }
                return true;
            }
        ...
        <script type="text/javascript" lang="javascript">
            function ValidateChildren() {
                ...
                var cdob1 = document.getElementById('<%=txt_child_Dob.ClientID %>');
                    ...
                    <div class="span12">
                        <div class="widget">
                            <div class="widget-header" style="border-bottom: none;">
                                <div class="title">
                                    <span class="fs1" aria-hidden="true" data-icon="&#xe023;"></span>Validate
                                </div>
                            </div>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <ContentTemplate>
                                                                    ...
                                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                        <tr style="height: 50px">
                                                                            ...
                                                                            <td class="frm-rght-clr123" width="52%">
                                                                                ...
                                                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="ddlSalutation"
                                                                                    Display="Dynamic" SetFocusOnError="True" ToolTip="Select Title" ValidationGroup="e"
                                                                        ...
                                                                        <tr style="height: 50px">
                                                                            ...
                                                                            <td class="frm-rght-clr123" width="52%">
                                                                                <asp:TextBox ID="txtfirstname" runat="server" placeholder="Max. 50 Char.." CssClass="span11" MaxLength="200" onkeydown="return isAlpha(event.keyCode);" ondrop="return false;"></asp:TextBox>
                                                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtfirstname"
                                                                                    Display="Dynamic" SetFocusOnError="True" ToolTip="Enter Employee Name" ValidationGroup="e"
                                                                ...
                                                                <ContentTemplate>
                                                                    ...
                                                                    <table width="99%" border="0" align="right" cellpadding="0" cellspacing="0">
                                                                            ...
                                                                            <td colspan="2">
                                                                                ...
                                                                                <table width="100%" border="0" align="right" cellpadding="0" cellspacing="0" style="height: 50px">
                                                                                    <tr>
                                                                                        ...
                                                                                        <td class="frm-rght-clr123" width="52%">
                                                                                            <%--<asp:TextBox ID="txtempcode" runat="server" CssClass="span7" placeholder="Max. 50 Char.." MaxLength="50" OnTextChanged="txtempcode_TextChanged" AutoPostBack="true"></asp:TextBox>--%>
                                                                        ...
                                                                        <tr style="height: 50px">
                                                                            <td width="47.8%" class="frm-lft-clr123 border-bottom">Employee No.<span class="star"></span>
                                                                            </td>
                                                                            <td width="52.2%" class="frm-rght-clr123 border-bottom">
                                                                                ...
                                                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="txt_card_no"
                                                                                    Display="Dynamic" SetFocusOnError="True" ToolTip="Enter Employee No" ValidationGroup="e"
                                                                                    Width="6px"><img src="../img/error1.gif" alt="" /></asp:RequiredFieldValidator>
                                                                            </td>
                                                                        </tr>
                                                                        <tr style="height: 40px">
                                                                            <td colspan="3">
                                                                                <asp:UpdatePanel ID="updpanell" runat="server">
                                                                                    <ContentTemplate>
                                                                                        <table width="100%" border="0" align="right" cellpadding="0" cellspacing="0" style="height: 50px">
                                                                                            <tr>
                                                                                                ...
                                                                                                <td width="52%" class="frm-rght-clr123 border-bottom">
                                                                                                    ...
                                                                                                    <br />
                                                                                                    <asp:FileUpload ID="flphoto" runat="server" Width="230px" ToolTip="Upload File here" />&nbsp;
                                                <asp:RegularExpressionValidator ID="RegularExpressionValidator13" runat="server" ControlToValidate="flphoto"
                                                    ValidationGroup="e" CssClass="txt-red" Display="Dynamic" ErrorMessage='<img src="../images/error1.gif" alt="" />' ToolTip="File not supported" ValidationExpression="^.+(.png|.PNG|.bmp|.BMP|.jpg|.JPG|.gif|.GIF|.jpeg|.JPEG)$"></asp:RegularExpressionValidator><br />
                                                                        ...
                                                                        <%--<tr id="trmail" runat="server">
                                                                            <td>
                                                                                <asp:Label ID="lblhremail" runat="server"></asp:Label>
                                                                            </td>
                                                                        </tr>--%>
                                ...
                                <div id="wizard">
                                                                ...
                                                                <td width="50%" valign="top">
                                                                    <asp:UpdatePanel ID="UpdatePanel5" runat="server">
                                                                        <ContentTemplate>
                                                                            ...
                                                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                <tr id="bu" style="height: 50px" runat="server" visible="false">
                                                                                ...
                                                                                <tr style="height: 50px">
                                                                                    ...
                                                                                    <td class="frm-rght-clr123">
                                                                                        <asp:DropDownList ID="drpbranch" runat="server" CssClass="span11" Height=""
                                                                                            DataSourceID="sql_data_branch" Width="230px" DataTextField="branch_name" DataValueField="Branch_Id"
                                                                                ...
                                                                                <tr id="grad5" style="height: 50px" runat="server" visible="false">
                                                                                ...
                                                                                <tr id="cost5" style="height: 50px" runat="server" visible="false">
                                                                                ...
                                                                                <tr style="height: 50px">
                                                                                    ...
                                                                                    <td width="52%" class="frm-rght-clr123">
                                                                                        <asp:DropDownList ID="drprole" runat="server" Height="" CssClass="span11" Enabled="false"
                                                                    ...
                                                                    <table width="99%" border="0" align="right" cellpadding="0" cellspacing="0">
                                                                                        ...
                                                                                        <table width="100%" border="0" align="right" cellpadding="0" cellspacing="0" style="height: 50px">
                                                                                            <tr>
                                                                                                ...
                                                                                                <td class="frm-rght-clr123" width="51%">
                                                                                                    <asp:TextBox ID="doj" Width="212px" runat="server" CssClass="span11" AutoPostBack="true" placeholder="Select Date" onkeypress="return enterdate(event);" onkeydown="return enterdate(event);"
                                                                                                        OnTextChanged="doj_TextChanged"></asp:TextBox>&#160;<asp:Image ID="Image4" runat="server"
                                                                                                            ImageUrl="~/img/clndr.gif" placeholder="Select Date" /><asp:RequiredFieldValidator ID="RequiredFieldValidator34" runat="server" ControlToValidate="doj"
                                                                        ...
                                                                        <tr style="height: 50px">
                                                                            ...
                                                                            <td class="frm-rght-clr123" colspan="2" width="51%">
                                                                                <asp:TextBox ID="txtcountrycode" Width="30px" placeholder="Max 4 Chars.." runat="server" MaxLength="4" Enabled="false">+91</asp:TextBox>&nbsp;
                                                                                        <asp:TextBox ID="txtoff_mobileno" Width="173px" placeholder="Max 10 Chars.." runat="server" CssClass="span11" MaxLength="10" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;"></asp:TextBox>
                                                                            </td>
                                                                        </tr>
                                                                        <tr style="height: 50px">
                                                                            ...
                                                                            <td class="frm-rght-clr123">
                                                                                <asp:TextBox ID="txt_officialemail" placeholder="Max 50 Chars.." runat="server" CssClass="span11" onblur="return validateEmail(this);"
                                                                                    MaxLength="50"></asp:TextBox>
                                                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator10" runat="server" ControlToValidate="txt_officialemail"
                                                                                    Display="Dynamic" SetFocusOnError="True" ToolTip="Enter Email" ValidationGroup="e"
                                                                                    Width="6px"><img src="../img/error1.gif" alt="" /></asp:RequiredFieldValidator>
                                                                        ...
                                                                        <tr style="height: 50px">
                                                                            ...
                                                                            <td class="frm-rght-clr123" colspan="2" width="51%">
                                                                                <asp:DropDownList ID="ddl_semp_type" runat="server" CssClass="span11" Height="" Width=""
                                                                                    OnDataBound="ddl_semp_type_DataBound">
                                                                                </asp:DropDownList>
                                                                        ...
                                                                        <tr style="height: 50px">
                                                                            ...
                                                                            <td class="frm-rght-clr123 border-bottom">
                                                                                <asp:TextBox ID="txtextccode" runat="server" Width="30px" placeholder="Max 4 Chars.." MaxLength="4" Enabled="false"></asp:TextBox>
                                                                        ...
                                                                        <tr id="trprobationdate2" runat="server" visible="true" style="height: 50px">
                                                                            <td class="frm-lft-clr123 border-bottom" width="48%">Notice Period <span class="star"></span>
                                                                            </td>
                                                                            <td class="frm-rght-clr123 border-bottom" width="51%">
                                                ...
                                                <tr>
                                                    <td colspan="2">
                                                        <asp:UpdatePanel ID="dd" runat="server" UpdateMode="conditional">
                                                                            ...
                                                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                <tr>
                                                                                    ...
                                                                                    <td id="Td2" class="frm-rght-clr123  " width="52%" runat="server">
                                                                                        <asp:TextBox ID="ward" runat="server" CssClass="span11" MaxLength="20" onkeypress="return IsNumeric(event);" placeholder="Max 20 Chars.."></asp:TextBox>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td class="frm-rght-clr123 border-bottom">
                                                                                        ...
                                                                                        <%--<asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="panno"
                                                                                                    Display="Dynamic" SetFocusOnError="True" ToolTip="Enter PAN Number" ValidationGroup="e"
                                                                                                    Width="6px"><img  src="../img/error1.gif" alt="" /></asp:RequiredFieldValidator>--%>
                                                                                    </td>
                                                                                </tr>
                                                                    ...
                                                                    <tr>
                                                                        <td colspan="2">
                                                                            <div class="form-actions no-margin">
                                                                                <asp:Button ID="btnjob" runat="server" Text="Save" CssClass="btn btn-primary pull-right" ValidationGroup="e" OnClick="btnjob_Click" />
                                                                            </div>
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                            ...
                                                            <Triggers>
                                                                <asp:PostBackTrigger ControlID="btnjob" />
                                                            </Triggers>
                                                        </asp:UpdatePanel>
                                                    </td>
                                                </tr>
                                            ...
                                            &nbsp;<asp:UpdatePanel ID="upapprobver" runat="server">
                                                <ContentTemplate>
                                                    ...
                                                    <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                                                            ...
                                                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                <tr style="height: 50px">
                                                                                    ...
                                                                                    <td class="frm-rght-clr123" width="52%">
                                                                                        ...
                                                                                        <a href="JavaScript:newPopup1('pickapprover.aspx?role=13&empcode=<%=txtempcode.Text.ToString() %>');" title="Pick Employee"><i class="icon-user"></i></a>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr style="height: 50px">
                                                                                    ...
                                                                                    <td class="frm-rght-clr123 border-bottom" width="52%">
                                                                                        <asp:TextBox ID="txtdottedlinemanager" runat="server"></asp:TextBox>
                                                                                        <a href="JavaScript:newPopup1('pickapprover.aspx?role=50&empcode=<%=txtempcode.Text.ToString() %>');"><i class="icon-user"></i></a>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr style="height: 50px">
                                                                                    ...
                                                                                    <td class="frm-rght-clr123" width="52%">
                                                                                        <asp:TextBox ID="txtbusinesshead" runat="server"></asp:TextBox>
                                                                                        <a href="JavaScript:newPopup1('pickapprover.aspx?role=14&empcode=<%=txtempcode.Text.ToString() %>');" title="Pick Employee"><i class="icon-user"></i></a>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr style="height: 50px">
                                                                                    <td class="frm-lft-clr123 border-bottom" width="48%">Account Manager <span class="star"></span>
                                                                                    </td>
                                                                                    <td class="frm-rght-clr123 border-bottom" width="52%">
                                                                                        <asp:TextBox ID="txtfncmang" runat="server"></asp:TextBox>
                                                                                        <a href="JavaScript:newPopup1('pickapprover.aspx?role=11&empcode=<%=txtempcode.Text.ToString() %>');" title="Pick Employee"><i class="icon-user"></i></a>
                                                                                    </td>
                                                                                </tr>

                                                                                <tr style="height: 50px">
                                                                                    <td class="frm-lft-clr123  border-bottom" width="48%">Network Administration Clearance <span class="star"></span>
                                                                                    </td>
                                                                                    <td class="frm-rght-clr123  border-bottom" width="52%">
                                                                                        <asp:TextBox ID="txtnetworkclr" runat="server"></asp:TextBox>
                                                                            ...
                                                                            <table width="99%" border="0" align="right" cellpadding="0" cellspacing="0">
                                                                                <tr style="height: 50px">
                                                                                    ...
                                                                                    <td class="frm-rght-clr123 " width="52%">
                                                                                        ...
                                                                                        <a href="JavaScript:newPopup1('pickapprover.aspx?role=12&empcode=<%=txtempcode.Text.ToString() %>');" title="Pick Employee"><i class="icon-user"></i></a>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr style="height: 50px">
                                                                                    ...
                                                                                    <td class="frm-rght-clr123" width="52%">
                                                                                        ...
                                                                                        <a href="JavaScript:newPopup1('pickapprover.aspx?role=9&empcode=<%=txtempcode.Text.ToString() %>');" title="Pick Employee"><i class="icon-user"></i></a>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr style="height: 50px">
                                                                                    ...
                                                                                    <td class="frm-rght-clr123" width="52%">
                                                                                        <asp:TextBox ID="txthrcb" runat="server"></asp:TextBox>
                                                                                        <a href="JavaScript:newPopup1('pickapprover.aspx?role=51&empcode=<%=txtempcode.Text.ToString() %>');" title="Pick Employee"><i class="icon-user"></i></a>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr style="height: 50px">
                                                                                    ...
                                                                                    <td class="frm-rght-clr123" width="52%">
                                                                                        <asp:TextBox ID="txthrd" runat="server"></asp:TextBox>
                                                                                        <a href="JavaScript:newPopup1('pickapprover.aspx?role=15&empcode=<%=txtempcode.Text.ToString() %>');"><i class="icon-user"></i></a>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr style="height: 50px">
                                                                                    ...
                                                                                    <td class="frm-rght-clr123 border-bottom" width="52%">
                                                                                        <asp:TextBox ID="txtmng" runat="server"></asp:TextBox>
                                                                                        <a href="JavaScript:newPopup1('pickapprover.aspx?role=10&empcode=<%=txtempcode.Text.ToString() %>');"><i class="icon-user"></i></a>
                                                                                    </td>
                                                                                </tr>
                                                                            </table>
                                                                        </td>
                                                                        ...
                                                                        <td width="50%" valign="top">
                                                                            ...
                                                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                <tr style="height: 50px">
                                                                                    ...
                                                                                    <td class="frm-rght-clr123" width="52%">
                                                                                        <asp:TextBox ID="txtdeptclr" runat="server"></asp:TextBox>
                                                                                ...
                                                                                <tr style="height: 50px">
                                                                                    ...
                                                                                    <td class="frm-rght-clr123" width="52%">
                                                                                        <asp:TextBox ID="txtadminclr" runat="server"></asp:TextBox>
                                                                                ...
                                                                                <tr style="height: 50px">
                                                                                    ...
                                                                                    <td class="frm-rght-clr123 border-bottom" width="52%">
                                                                                        <asp:TextBox ID="txtaccdeptclr" runat="server"></asp:TextBox>
                                                                        ...
                                                                        <td valign="top">
                                                                            <table width="99%" border="0" align="right" cellpadding="0" cellspacing="0">
                                                                                ...
                                                                                <tr style="height: 50px">
                                                                                    ...
                                                                                    <td class="frm-rght-clr123" width="52%">
                                                                                        <asp:TextBox ID="txthrdeptclr" runat="server"></asp:TextBox>
                                                                                ...
                                                                                <tr style="height: 50px">
                                                                                    ...
                                                                                    <td class="frm-rght-clr123 border-bottom" width="52%">
                                                                                        <asp:TextBox ID="txtaccdeleclr" runat="server"></asp:TextBox>
                                                        ...
                                                        <tr>
                                                            <td colspan="2">
                                                                <asp:Button ID="btnapprover" runat="server" Text="Save" CssClass="btn btn-primary pull-right" OnClick="btnapprover_Click" />
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </ContentTemplate>
                                                                                        ...
                                                                                        <td width="100%" valign="top">
                                                                                            <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                                                                                ...
                                                                                                <tr>
                                                                                                    ...
                                                                                                    <td class="frm-rght-clr123 border-bottom" width="55%">
                                                                                                        <asp:TextBox ID="txt_emg_ccode" runat="server" Width="38px" placeholder="Max 4 Chars.." Enabled="false" onkeypress="return IsNumeric(event);" MaxLength="4">+91</asp:TextBox>
                                                                                                ...
                                                                                                <tr>
                                                                                                    ...
                                                                                                    <td class="frm-rght-clr123 border-bottom" width="55%">
                                                                                                        <asp:TextBox ID="txt_emg_landcode" runat="server" Width="30px" placeholder="Max 4 Chars.." Enabled="false" onkeypress="return IsNumeric(event);" MaxLength="4">+91</asp:TextBox>
                                                                                    ...
                                                                                    <asp:GridView ID="gvemgcontact" runat="Server" Width="100%" CellPadding="4" CssClass="table table-hover table-striped table-bordered table-highlight-head"
                                                                                        ...
                                                                                        <Columns>
                                                                                            ...
                                                                                            <asp:TemplateField>
                                                                                                <ItemTemplate>
                                                                                                    <asp:LinkButton
                                                                                                        ID="LinkButton1" runat="server" CommandName="Delete" CssClass="link04" CausesValidation="false" Text="&lt;img src='../images/download_delete.png'/&gt;" Width="40px"></asp:LinkButton>
                                                                                                </ItemTemplate>
                                                                                                <HeaderStyle HorizontalAlign="Left"></HeaderStyle>
                                                        ...
                                                        <asp:UpdatePanel ID="updatepannel2d" runat="server">
                                                            <ContentTemplate>
                                                                ...
                                                                <table style="border-collapse: collapse" bordercolor="#d9d9d9" cellspacing="0" cellpadding="4"
                                                                    ...
                                                                    <tr>
                                                                        <td class="td-head" width="21%">Education
                                                                        </td>
                                                                        <td class="td-head" width="17%">Specialization
                                                                        </td>
                                                                        <td class="td-head" width="30%">School / Institute / University Name
                                                                        </td>
                                                            ...
                                                            <ContentTemplate>
                                                                ...
                                                                <table style="border-collapse: collapse" bordercolor="#d9d9d9" cellspacing="0" cellpadding="4"
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class="td-head" width="30%">Institute / University Name
                                                                        </td>
                                                                        <td class="td-head" width="10%">Grade / %
                                                                        </td>
                                                                        <td class="td-head" width="22%">Year 
                                                                                ...
                                                                                <asp:GridView ID="grid_Pro_education" runat="Server" Width="100%" OnRowDeleting="grid_Pro_education_RowDeleting" CssClass="table table-hover table-striped table-bordered table-highlight-head"
                                                                                    ...
                                                                                    <asp:Label ID="Label2" runat="Server" Text='<%# Eval("to_year") %>'></asp:Label>
                                                                                        ...
                                                                                        <asp:TemplateField HeaderStyle-Width="10%">
                                                                                            <ItemTemplate>
                                                                                                <asp:LinkButton
                                                                                                    CssClass="link04" ID="LinkButton1" runat="server" CommandName="Delete" CausesValidation="false" Text="&lt;img src='../images/download_delete.png'/&gt;" Width="40px"></asp:LinkButton>
                                                                                            </ItemTemplate>
                                                                                        </asp:TemplateField>
                                                                                    </Columns>
                                                                                    <HeaderStyle HorizontalAlign="Left" VerticalAlign="Top"></HeaderStyle>
                                                        ...
                                                        <asp:UpdatePanel ID="UpdatePanel4" runat="server">
                                                            <ContentTemplate>
                                                                ...
                                                                <table style="border-collapse: collapse" bordercolor="#d9d9d9" cellspacing="0" cellpadding="4"
                                                                    width="100%" border="1">
                                                                    <tr>
                                                                        <td class="td-head" width="18%">Company Name
                                                                        </td>
                                                                        <td class="td-head" width="28%">Address / Location
                                                                        </td>
                                                                        <td class="td-head" width="20%">Designation
                                                                        </td>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <asp:TextBox ID="txt_total_exp" runat="server" CssClass="span11" Width="100px" MaxLength="5" placeholder="Max. 5 Char.."></asp:TextBox>
                                                                                ...
                                                                                <asp:GridView ID="grid_exp" runat="Server" Width="100%" OnRowDeleting="grid_exp_RowDeleting" CssClass="table table-hover table-striped table-bordered table-highlight-head"
                                                                                    ...
                                                                                    <asp:Label ID="Labecxdl2" runat="Server" Text='<%# Eval("to_year") %>'></asp:Label>
                                                                                        ...
                                                                                        <asp:TemplateField HeaderStyle-Width="10%">
                                                                                            <ItemTemplate>
                                                                                                <asp:LinkButton
                                                                                                    CssClass="link04" ID="LinkButwton1" runat="server" CommandName="Delete" CausesValidation="false" Text="&lt;img src='../images/download_delete.png'/&gt;" Width="40px"></asp:LinkButton>
                                                                                            </ItemTemplate>
                                                                                        </asp:TemplateField>
                                                                                    </Columns>
                                                                                    <HeaderStyle HorizontalAlign="Left" VerticalAlign="Top"></HeaderStyle>
                                                        ...
                                                        <asp:UpdatePanel ID="UpdatePanel7" runat="server">
                                                            <ContentTemplate>
                                                                ...
                                                                <table style="border-collapse: collapse" bordercolor="#d9d9d9" cellspacing="0" cellpadding="4"
                                                                    width="100%" border="1">
                                                                    <tr>
                                                                        <td class="td-head" width="22%">Training Name
                                                                        </td>
                                                                        <td class="td-head" width="22%">Conducted By
                                                                        </td>
                                            ...
                                            <asp:UpdatePanel ID="updatepanel8" runat="server">
                                                <ContentTemplate>
                                                    ...
                                                    <table cellspacing="0" cellpadding="0" width="100%" border="0" id="li_tabs4" runat="server">
                                                        ...
                                                        <tr>
                                                            <td class="txt02" style="width: 100%;" colspan="2">Personal Information
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td colspan="2" height="5"></td>
                                                                        ...
                                                                        <td valign="top" width="50%">
                                                                            <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                                                                <tr>
                                                                                    ...
                                                                                    <td class="frm-rght-clr123" width="55%">
                                                                                        <asp:TextBox ID="txtccode" runat="server" CssClass="span1" Width="50px" onkeypress="return IsNumeric(event);" MaxLength="4">+91</asp:TextBox>
                                                                                                                ...
                                                                                                                <asp:TemplateField HeaderStyle-Width="9%">
                                                                                                                    <ItemTemplate>
                                                                                                                        <asp:LinkButton ID="LinkButton2" runat="server" CommandName="Delete" CssClass="link04"
                                                                                                                            CausesValidation="false" Text="&lt;img src='../images/download_delete.png'/&gt;" Width="40px"></asp:LinkButton>
                                                                                                                    </ItemTemplate>
                                                                                                                </asp:TemplateField>
                                                                                                            </Columns>
                                                                                                            <HeaderStyle HorizontalAlign="Left" VerticalAlign="Top"></HeaderStyle>
                                    ...
                                    <div>
                                        <p>
                                                    ...
                                                    <table id="li_tabs5" width="100%" border="0" cellpadding="0" cellspacing="0" runat="server">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="frm-rght-clr123 border-bottom" width="25%" runat="server" visible="false" id="textother">
                                                             ...
                                                             <td id="Td5" class="frm-rght-clr123 " runat="server" visible="false">
                                                                <label class="radio inline">
                                            ...
                                            <table width="100%" border="0" cellpadding="0" cellspacing="0" runat="server" visible="false">
                                                ...
                                                <tr runat="server" visible="false">
                                                    ...
                                                    <td class="frm-rght-clr123">
                                                        ...
                                                        <br />
                                                        <asp:FileUpload ID="flphoto1" runat="server" CssClass="input2" Width="287px" ToolTip="Upload File here" />&nbsp;
                                                <asp:RegularExpressionValidator ID="RegularExpressionValidator131" runat="server" ControlToValidate="fu_dft1"
                                                ...
                                                <tr>
                                                    <td class="frm-lft-clr123">
                                                        <asp:Label ID="lbl_adhar" runat="server"></asp:Label>
                                                    </td>
                                                    <td class="frm-rght-clr123">
                                                        <asp:Label ID="lbl_adhar_file" runat="server" Text=""></asp:Label><br />
                                                        <asp:FileUpload ID="FileUpload1" runat="server" CssClass="input2" Width="287px" ToolTip="Upload File here" />&nbsp;
                                                <asp:RegularExpressionValidator ID="RegularExpressionValidator16" runat="server" ControlToValidate="FileUpload1"
                                                    ValidationGroup="v" CssClass="txt-red" ErrorMessage="file not supported..." ValidationExpression="^.+(.pdf|.PDF|.png|.PNG|.bmp|.BMP|.jpg|.JPG|.gif|.GIF)$"></asp:RegularExpressionValidator><br />
                                                        (Replace Existing File)
                                                    </td>
                                                </tr>
                                            ...
                                            <%--  <asp:UpdatePanel ID="incom" runat="server">
                                                <ContentTemplate>--%>
                                            <script type="text/javascript">
                                                function checkAddress(checkbox) {
                                                    if (checkbox.checked) {
                                                        ...
                                                        $('#<%=comm.ClientID %>').show();
                                                        $('#<%=btngeneralsubmit.ClientID %>').hide();
                                                        ...
                                                        $('#<%=btnreject.ClientID %>').hide();
                                                        $('#<%=comm.ClientID %>').hide();
                                                        $('#<%=btngeneralsubmit.ClientID %>').show();
                                                    }
                                                }
                                            </script>
                                            <div class="widget-body">
                                                <fieldset>
                                                    <div class="control-group">
                                                        <div class="controls span10">
                                                            <table style="width: 15%" cellspacing="0" cellpadding="0">
                                                                <tr>
                                                                    <td>
                                                                        <label>InComplete</label>
                                                                    </td>
                                                                    <td>
                                                                        <asp:CheckBox ID="cknotcomplete" runat="server" Checked="false" onclick="checkAddress(this)" />
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                            <%--<label class="control-label" style="width: 100px">InComplete</label>
                                                            &nbsp; &nbsp;&nbsp;<asp:CheckBox ID="cknotcomplete" runat="server" Checked="false" onclick="checkAddress(this)" />--%>
                                                        </div>
                                                    </div>
                                                    <div class="control-group" id="precomm" runat="server" visible="false">
                                                        <label id="prvv" runat="server" class="control-label span3">Previous Comment</label>
                                                        <div class="controls span9">
                                                            <asp:Label ID="lblpreviouscomm" runat="server"></asp:Label>
                                                        </div>
                                                    </div>
                                                    <div class="control-group" id="comm" runat="server">
                                                        ...
                                                        <table style="width: 100%" cellspacing="0" cellpadding="0">
                                                            <tr>
                                                                <td>
                                                                    <label class="control">Comments</label>
                                                                </td>
                                                                <td>
                                                                    <asp:TextBox ID="txtcomments" runat="server" TextMode="MultiLine" Rows="5" Width="500px"></asp:TextBox>
                                                                </td>
                                            ...
                                            <div class="form-actions no-margin" style="text-align: right">
                                                <asp:Button ID="btngeneralsubmit" runat="server" align="right" CssClass="btn btn-info" OnClick="btngeneralsubmit_Click"
                                                    Text="Approve" OnClientClick="return ValidateData();" ValidationGroup="e" />
                                                <asp:Button ID="btnreject" runat="server" align="right" CssClass="btn btn-info" OnClick="btnreject_Click"
                                                    Text="Back to User" ValidationGroup="r" />
                                            </div>
                                        </p>
                                    </div>
                                </div>
