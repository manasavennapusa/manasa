...
public partial class ResetPassword : System.Web.UI.Page
{
    ...
    {
        query q = new query();
        string str = (Request.QueryString["q"].ToString()!=null?Request.QueryString["q"].ToString():"0");
        ...
        {
            Response.Redirect("createtemplogin.aspx?password=true");
        }
    }
    ...
    protected void btnsv_Click(object sender, EventArgs e)
    {
        ...
        if (i > 0)
        {
            ...
            Response.Redirect("createtemplogin.aspx?passwordreset=true");
        }
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        //txt_password.Text = "";
        //txt_cpassword.Text = "";
        Response.Redirect("createtemplogin.aspx");
    }
}
