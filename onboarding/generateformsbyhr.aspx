<%@ Page Language="C#" AutoEventWireup="true" CodeFile="generateformsbyhr.aspx.cs" Inherits="onboarding_generateformsbyhr" %>
        ...
        <div class="form-horizontal no-margin">
            <div class="dashboard-wrapper" style="margin-left: 0px;">
                        ...
                        <div class="span12">
                            <div class="widget">
                                <div class="widget-header">
                                    <div class="title">
                                        <span class="fs1" aria-hidden="true" data-icon="&#xe023;"></span>Generate
                                    </div>
                                </div>
                                            ...
                                            <div class="control-group">
                                                <div class="controls controls-row">
                                                    ...
                                                    <div class="controls span3">
                                                        <asp:TextBox ID="txt_employee" runat="server" Width="220px" CssClass="span4" onkeypress="return isKey(event);" ondrop="return false;" onpaste="return false;" style="background-color:#ebebeb;"></asp:TextBox>
                                                    </div>
                                                    <div class="controls span3">
                                                        <a href="JavaScript:newPopup1('PickEmployee.aspx');"><i class="icon-user"></i></a>
                                                    </div>
                                                    <div class="controls span1">
                                                        <asp:Button ID="btnSubmit" runat="server" CssClass="btn btn-info pull-right " Text="Generate Report" OnClick="btnSubmit_Click1" OnClientClick="return ValidateEmpcode();" />
                                                    </div>
                                                </div>
                                            </div>
                                        </fieldset>
              ...
              <p align="center" style="font: bold 16px 'Century Gothic'; text-decoration: underline; line-height: 19px;">PERSONAL INFORMATION FORM</p>
                <table cellpadding="0" cellspacing="0" style="width: 100%" class="ft1">
                    ...
                    <tr>
                        ...
                        <td colspan="1" style="border-bottom: 1px solid  #808080">
                            ...
                            <asp:TextBox ID="TextBox1" runat="server" Style="border: none; height: 30px;"></asp:TextBox>
                        </td>
                        <td>
                        ...
                        <td colspan="1" style="border-bottom: 1px solid  #808080">
                            <%--<p><asp:Label Style="border: none" ID="Label7" runat="server" Text="" Font-Bold="true" Width="100px"></asp:Label>( Country) &nbsp;&nbsp;<asp:Label Style="border: none" ID="Label8" runat="server" Text="" Font-Bold="true" Width="100px"></asp:Label>(State)</p>--%>
                            <asp:TextBox ID="TextBox2" runat="server" Style="border: none; height: 30px;"></asp:TextBox>
                        </td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td style="border-bottom: 1px solid  #808080">
                            <asp:TextBox ID="TextBox39" runat="server" Style="border: none; height: 30px;"></asp:TextBox>
                        </td>--%>
                    </tr>
                    <tr>
                        <td>
                       ...
                       <%-- <td>
                        ...
                        <td style="border-bottom: 1px solid  #808080">
                            <asp:TextBox ID="TextBox40" runat="server" Style="border: none; height: 30px;"></asp:TextBox>
                        </td>--%>
                    </tr>
                    <tr>
                        <td>
                    ...
                    <tr>
                        ...
                        <td style="border-bottom: 1px solid  #808080">City                    
                             <asp:TextBox ID="TextBox41" runat="server" Style="border: none; height: 30px; width: 130px;"></asp:TextBox>
                        </td>

                        <td style="border-bottom: 1px solid  #808080">Pin Code              
                             <asp:TextBox ID="TextBox42" runat="server" Style="border: none; height: 30px; width: 130px;"></asp:TextBox>
                        </td>
                        <td style="border-bottom: 1px solid  #808080">Telephone No            
                             <asp:TextBox ID="TextBox43" runat="server" Style="border: none; height: 30px; width: 100px;"></asp:TextBox>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td></td>
                        <td style="border-bottom: 1px solid  #808080">City                    
                             <asp:TextBox ID="TextBox44" runat="server" Style="border: none; height: 30px; width: 130px;"></asp:TextBox>
                        </td>
                        <td style="border-bottom: 1px solid  #808080">Pin Code              
                             <asp:TextBox ID="TextBox45" runat="server" Style="border: none; height: 30px; width: 130px;"></asp:TextBox>
                        </td>
                        <td style="border-bottom: 1px solid  #808080">Telephone No            
                             <asp:TextBox ID="TextBox46" runat="server" Style="border: none; height: 30px; width: 100px;"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td>
                ...
                <p class="p12 ft1">
                    Are you related to any employee at Escalon  : Yes/No
                    <asp:TextBox ID="tt" runat="server" Style="border: none"></asp:TextBox>
                </p>
                <p class="p39 ft1">
                    If Yes, Name:
                    <asp:TextBox ID="TextBox47" runat="server" Style="border: none"></asp:TextBox>
                    Relationship:<asp:TextBox ID="TextBox48" runat="server" Style="border: none"></asp:TextBox>
                </p>
                                            ...
                                            <p>
                                                ...
                                                <asp:Panel ID="pnlbank" runat="server">
                                                    <div id="page_11">
                                                        ...
                                                        <p class="p2 ft111">Escalon Business Services Pvt. Ltd.,</p>
                                            ...
                                            <p>
                                                ...
                                                <asp:Panel ID="pnlnomone" runat="server">
                                                    <div id="page_14444">
                                                        ...
                                                        <p class="p24444 ft14444">Escalon Business Services</p>
                                        ...
                                        <div VISIBLE="false" runat="server">
                                            ...
                                            <asp:Panel ID="pnlsudox" runat="server">
                                                <div id="page_1555">
                                                    ...
                                                    <p class="p1555 ft0555">Escalon Business Services Pvt. Ltd.,</p>
                                        ...
                                        <div>
                                            ...
                                            <asp:Panel ID="pnlpf" runat="server">
                                                <div id="page_16666">
                                                    ...
                                                    <p class="p06666 ft06666">Escalon Business Services Private Limited </p>
                                                    <p class="p06666 ft16666">Plot No A 40 A, 2nd Floor, SVEPL Building,</p>
                                                    <p class="p06666 ft06666">Co-Developer Quarkcity SEZ, Industrial Area,</p>
                                                    <p class="p26666 ft06666">Phase 8-B, SAS Nagar,</p>
                                                    <p class="p26666 ft06666">Mohali Punjab – 160059.</p>
                                                    ...
                                                    <p class="p56666 ft46666">
                                                        ...
                                                        member of the Escalon Business Services Pvt. Ltd., Employees’ Provident Fund intend to make voluntary contribution @ (12) % or Rupees
                                                    </p>
