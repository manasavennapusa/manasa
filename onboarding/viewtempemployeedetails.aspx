        ...
        <div class="dashboard-wrapper" style="margin-left: 0px;">
            <div class="main-container">
                ...
                <div class="page-header">
                    <div class="pull-left">
                        <h2>Validate Employee Details</h2>
                    </div>
                        ...
                        <div class="widget">
                            ...
                            <table class="table table-condensed table-striped table-hover table-bordered pull-left">
                                <tr>
                                    ...
                                    <td id="dvsearch" runat="server" class="frm-rght-clr123 border-bottom" style="border-left: none;" width="12%" visible="false">
                            ...
                            <div class="widget-body">
                                ...
                                <div id="dt_example" class="example_alt_pagination">
                                    ...
                                    <asp:GridView ID="empgrid" runat="server" DataKeyNames="empcode" AutoGenerateColumns="False" 
                                        EmptyDataText="No such employee exists !" class="table table-condensed table-striped table-hover table-bordered pull-left"
                                         OnPreRender="empgrid_PreRender2" OnRowDeleting="empgrid_RowDeleting">
                                        <Columns>
                                           ...
                                           <%-- <asp:TemplateField HeaderText="Department">
                                             ...
                                             <asp:TemplateField HeaderText="Email">
                                                ...
                                                <ItemStyle Width="25%" HorizontalAlign="Left" VerticalAlign="Top" CssClass="" />
                                                <ItemTemplate>
                                                    <asp:Label ID="l3" runat="server" Text='<%# Bind ("email_id") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            ...
                                            <asp:HyperLinkField DataNavigateUrlFields="empcode" DataNavigateUrlFormatString="edittemploginbyhr.aspx?empcode={0}"
                                                ...
                                                <ControlStyle CssClass="btn btn-small btn-primary hidden-tablet hidden-phone" Width="25%" />
                                                <HeaderStyle CssClass="" />
