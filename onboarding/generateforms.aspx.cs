...
public partial class admin_generateforms : System.Web.UI.Page
{
    public int i;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string emp_code = Request.QueryString["empcode"].ToString();//"3090";
    ...
    protected void bind_job_detail(string emp_code)
    {
        try
        {
            ...
            txtfirstname.Text = ds.Tables[0].Rows[0]["emp_fname"].ToString() + " " + ds.Tables[0].Rows[0]["emp_m_name"].ToString() + "" + ds.Tables[0].Rows[0]["emp_l_name"].ToString();
